...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'LinhaControleEquipamento'
        db.create_table(u'almoxarifado_linhacontroleequipamento', (
            ...
            ('unidade', self.gf('django.db.models.fields.CharField')(max_length=10, blank=True)),
            ('quantidade', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2)),
            ('data_entregue', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 11, 13, 0, 0))),
            ('data_devolvido', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 11, 13, 0, 0), null=True, blank=True)),
            ('funcionario_receptor', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='recepcao_linha_controle_equipamento_set', null=True, to=orm['rh.Funcionario'])),
        ...
        db.send_create_signal(u'almoxarifado', ['LinhaControleEquipamento'])

        # Adding field 'ControleDeEquipamento.tipo'
        db.add_column(u'almoxarifado_controledeequipamento', 'tipo',
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'almoxarifado_linhacontroledeequipamento', (
            ...
            ('devolutor', self.gf('django.db.models.fields.related.ForeignKey')(related_name='devolutor_controle_equipamento_set', null=True, to=orm['rh.Funcionario'], blank=True)),
            ('data_devolucao_efetiva', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('controle', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['almoxarifado.ControleDeEquipamento'])),
            ('receptor', self.gf('django.db.models.fields.related.ForeignKey')(related_name='receptor_controle_equipamento_set', null=True, to=orm['rh.Funcionario'], blank=True)),
        ))
        ...
        # Deleting model 'LinhaControleEquipamento'
        db.delete_table(u'almoxarifado_linhacontroleequipamento')

        # Deleting field 'ControleDeEquipamento.tipo'
        db.delete_column(u'almoxarifado_controledeequipamento', 'tipo')
