...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LinhaControleEquipamento.codigo_ca'
        db.add_column(u'almoxarifado_linhacontroleequipamento', 'codigo_ca',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LinhaControleEquipamento.codigo_ca'
        db.delete_column(u'almoxarifado_linhacontroleequipamento', 'codigo_ca')
    ...
    models = {
        u'almoxarifado.controledeequipamento': {
            ...
            'data_arquivo_impresso_assinado_recebido': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 14, 0, 0)'}),
        ...
        u'almoxarifado.linhacontroleequipamento': {
            ...
            'atualizado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
            'codigo_ca': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
        ...
        u'rh.funcionario': {
            ...
            'escolaridade_conclusao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 14, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        u'rh.periodotrabalhado': {
            ...
            'funcionario': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['rh.Funcionario']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 14, 0, 0)'})
        },
