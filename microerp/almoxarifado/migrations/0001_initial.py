...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('almoxarifado', ['ControleDeEquipamento'])
        ...
        db.send_create_signal('almoxarifado', ['Equipamento'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('almoxarifado_linhacontroledeequipamento')
