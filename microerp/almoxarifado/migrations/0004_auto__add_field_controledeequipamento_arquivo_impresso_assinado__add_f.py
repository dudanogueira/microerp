...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ControleDeEquipamento.arquivo_impresso_assinado'
        db.add_column(u'almoxarifado_controledeequipamento', 'arquivo_impresso_assinado',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ControleDeEquipamento.data_arquivo_impresso_assinado_recebido'
        db.add_column(u'almoxarifado_controledeequipamento', 'data_arquivo_impresso_assinado_recebido',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 11, 13, 0, 0)),
                      keep_default=False)

        # Adding field 'ControleDeEquipamento.criado_por'
        db.add_column(u'almoxarifado_controledeequipamento', 'criado_por',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ControleDeEquipamento.arquivo_impresso_assinado'
        db.delete_column(u'almoxarifado_controledeequipamento', 'arquivo_impresso_assinado')

        # Deleting field 'ControleDeEquipamento.data_arquivo_impresso_assinado_recebido'
        db.delete_column(u'almoxarifado_controledeequipamento', 'data_arquivo_impresso_assinado_recebido')

        # Deleting field 'ControleDeEquipamento.criado_por'
        db.delete_column(u'almoxarifado_controledeequipamento', 'criado_por_id')
