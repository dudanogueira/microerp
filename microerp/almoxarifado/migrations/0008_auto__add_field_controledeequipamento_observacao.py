...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ControleDeEquipamento.observacao'
        db.add_column('almoxarifado_controledeequipamento', 'observacao',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ControleDeEquipamento.observacao'
        db.delete_column('almoxarifado_controledeequipamento', 'observacao')
