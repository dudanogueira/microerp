...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'TipoDeEquipamento.consumivel'
        db.delete_column('almoxarifado_tipodeequipamento', 'consumivel')

        # Adding field 'ControleDeEquipamento.status'
        db.add_column('almoxarifado_controledeequipamento', 'status',
                      self.gf('django.db.models.fields.CharField')(default='pendente', max_length=100),
                      keep_default=False)

        # Deleting field 'Equipamento.nome'
        db.delete_column('almoxarifado_equipamento', 'nome')

        # Adding field 'Equipamento.produto'
        db.add_column('almoxarifado_equipamento', 'produto',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['almoxarifado.Produto']),
                      keep_default=False)

        # Adding field 'Equipamento.data_de_compra'
        db.add_column('almoxarifado_equipamento', 'data_de_compra',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 11, 14, 0, 0)),
                      keep_default=False)

        # Adding field 'Equipamento.data_expiracao'
        db.add_column('almoxarifado_equipamento', 'data_expiracao',
    ...
    def backwards(self, orm):
        ...
        # Adding field 'TipoDeEquipamento.consumivel'
        db.add_column('almoxarifado_tipodeequipamento', 'consumivel',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'ControleDeEquipamento.status'
        db.delete_column('almoxarifado_controledeequipamento', 'status')

        # Adding field 'Equipamento.nome'
        db.add_column('almoxarifado_equipamento', 'nome',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=100),
                      keep_default=False)

        # Deleting field 'Equipamento.produto'
        db.delete_column('almoxarifado_equipamento', 'produto_id')

        # Deleting field 'Equipamento.data_de_compra'
        db.delete_column('almoxarifado_equipamento', 'data_de_compra')

        # Deleting field 'Equipamento.data_expiracao'
        db.delete_column('almoxarifado_equipamento', 'data_expiracao')
    ...
    models = {
        ...
        'almoxarifado.equipamento': {
            ...
            'atualizado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'data_de_compra': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 11, 14, 0, 0)'}),
