...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LinhaControleDeEquipamento.devolutor'
        db.add_column('almoxarifado_linhacontroledeequipamento', 'devolutor',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='devolutor_controle_equipamento_set', null=True, to=orm['rh.Funcionario']),
                      keep_default=False)

        # Adding field 'Equipamento.perdido'
        db.add_column('almoxarifado_equipamento', 'perdido',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Equipamento.data_perdido'
        db.add_column('almoxarifado_equipamento', 'data_perdido',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LinhaControleDeEquipamento.devolutor'
        db.delete_column('almoxarifado_linhacontroledeequipamento', 'devolutor_id')

        # Deleting field 'Equipamento.perdido'
        db.delete_column('almoxarifado_equipamento', 'perdido')

        # Deleting field 'Equipamento.data_perdido'
        db.delete_column('almoxarifado_equipamento', 'data_perdido')
