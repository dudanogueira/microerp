...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LinhaControleDeEquipamento.criado'
        db.add_column('almoxarifado_linhacontroledeequipamento', 'criado',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'LinhaControleDeEquipamento.atualizado'
        db.add_column('almoxarifado_linhacontroledeequipamento', 'atualizado',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LinhaControleDeEquipamento.criado'
        db.delete_column('almoxarifado_linhacontroledeequipamento', 'criado')

        # Deleting field 'LinhaControleDeEquipamento.atualizado'
        db.delete_column('almoxarifado_linhacontroledeequipamento', 'atualizado')
