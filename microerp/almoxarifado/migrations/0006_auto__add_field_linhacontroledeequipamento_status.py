...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LinhaControleDeEquipamento.status'
        db.add_column('almoxarifado_linhacontroledeequipamento', 'status',
                      self.gf('django.db.models.fields.CharField')(default='pendente', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LinhaControleDeEquipamento.status'
        db.delete_column('almoxarifado_linhacontroledeequipamento', 'status')
