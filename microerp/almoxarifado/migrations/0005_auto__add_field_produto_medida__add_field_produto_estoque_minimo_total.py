...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Produto.medida'
        db.add_column('almoxarifado_produto', 'medida',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=100),
                      keep_default=False)

        # Adding field 'Produto.estoque_minimo_total'
        db.add_column('almoxarifado_produto', 'estoque_minimo_total',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Equipamento.medida'
        db.delete_column('almoxarifado_equipamento', 'medida')


    def backwards(self, orm):
        # Deleting field 'Produto.medida'
        db.delete_column('almoxarifado_produto', 'medida')

        # Deleting field 'Produto.estoque_minimo_total'
        db.delete_column('almoxarifado_produto', 'estoque_minimo_total')

        # Adding field 'Equipamento.medida'
        db.add_column('almoxarifado_equipamento', 'medida',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=100),
                      keep_default=False)
