...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LinhaControleEquipamento.data_entregue'
        db.alter_column(u'almoxarifado_linhacontroleequipamento', 'data_entregue', self.gf('django.db.models.fields.DateField')(null=True))
        # Deleting field 'ControleDeEquipamento.autorizador'
        db.delete_column(u'almoxarifado_controledeequipamento', 'autorizador_id')

        # Adding field 'ControleDeEquipamento.receptor_arquivo_impresso'
        db.add_column(u'almoxarifado_controledeequipamento', 'receptor_arquivo_impresso',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='autorizacao_controle_equipamento_set', null=True, to=orm['rh.Funcionario']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'LinhaControleEquipamento.data_entregue'
        db.alter_column(u'almoxarifado_linhacontroleequipamento', 'data_entregue', self.gf('django.db.models.fields.DateField')())
        # Adding field 'ControleDeEquipamento.autorizador'
        db.add_column(u'almoxarifado_controledeequipamento', 'autorizador',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='autorizacao_controle_equipamento_set', null=True, to=orm['rh.Funcionario'], blank=True),
                      keep_default=False)

        # Deleting field 'ControleDeEquipamento.receptor_arquivo_impresso'
        db.delete_column(u'almoxarifado_controledeequipamento', 'receptor_arquivo_impresso_id')


    models = {
        u'almoxarifado.controledeequipamento': {
            'Meta': {'object_name': 'ControleDeEquipamento'},
            'arquivo_impresso_assinado': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            ...
            'data_arquivo_impresso_assinado_recebido': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 13, 0, 0)'}),
            ...
            'receptor_arquivo_impresso': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'autorizacao_controle_equipamento_set'", 'null': 'True', 'to': u"orm['rh.Funcionario']"}),
        ...
        u'almoxarifado.linhacontroleequipamento': {
            ...
            'data_entregue': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
