...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'LinhaControleDeEquipamento.data_devolucao'
        db.delete_column('almoxarifado_linhacontroledeequipamento', 'data_devolucao')

        # Adding field 'LinhaControleDeEquipamento.data_devolucao_programada'
        db.add_column('almoxarifado_linhacontroledeequipamento', 'data_devolucao_programada',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 11, 14, 0, 0)),
                      keep_default=False)

        # Adding field 'LinhaControleDeEquipamento.data_devolucao_efetiva'
        db.add_column('almoxarifado_linhacontroledeequipamento', 'data_devolucao_efetiva',
    ...
    def backwards(self, orm):
        ...
        # Adding field 'LinhaControleDeEquipamento.data_devolucao'
        db.add_column('almoxarifado_linhacontroledeequipamento', 'data_devolucao',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'LinhaControleDeEquipamento.data_devolucao_programada'
        db.delete_column('almoxarifado_linhacontroledeequipamento', 'data_devolucao_programada')

        # Deleting field 'LinhaControleDeEquipamento.data_devolucao_efetiva'
        db.delete_column('almoxarifado_linhacontroledeequipamento', 'data_devolucao_efetiva')
