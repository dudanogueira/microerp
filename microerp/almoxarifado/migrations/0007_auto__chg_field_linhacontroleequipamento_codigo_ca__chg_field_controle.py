...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LinhaControleEquipamento.codigo_ca'
        db.alter_column(u'almoxarifado_linhacontroleequipamento', 'codigo_ca', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'ControleDeEquipamento.criado_por'
        db.alter_column(u'almoxarifado_controledeequipamento', 'criado_por_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rh.Funcionario']))

    def backwards(self, orm):

        # Changing field 'LinhaControleEquipamento.codigo_ca'
        db.alter_column(u'almoxarifado_linhacontroleequipamento', 'codigo_ca', self.gf('django.db.models.fields.CharField')(default=1, max_length=100))

        # Changing field 'ControleDeEquipamento.criado_por'
        db.alter_column(u'almoxarifado_controledeequipamento', 'criado_por_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))
    ...
    models = {
        u'almoxarifado.controledeequipamento': {
            ...
            'criado_por': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'controledeequipamento_criado_set'", 'null': 'True', 'to': u"orm['rh.Funcionario']"}),
            'data_arquivo_impresso_assinado_recebido': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 18, 0, 0)'}),
        ...
        u'almoxarifado.linhacontroleequipamento': {
            ...
            'atualizado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
            'codigo_ca': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'controle': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['almoxarifado.ControleDeEquipamento']"}),
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'data_devolvido': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'data_entregue': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'data_previsao_devolucao': ('django.db.models.fields.DateField', [], {}),
