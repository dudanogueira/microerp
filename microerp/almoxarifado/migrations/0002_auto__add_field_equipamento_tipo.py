...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Equipamento.tipo'
        db.add_column('almoxarifado_equipamento', 'tipo',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['almoxarifado.TipoDeEquipamento']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Equipamento.tipo'
        db.delete_column('almoxarifado_equipamento', 'tipo_id')
