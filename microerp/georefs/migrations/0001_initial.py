...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ReferenciaGeograficaCliente'
        db.create_table('georefs_referenciageograficacliente', (
            ...
            ('ponto', self.gf('django.contrib.gis.db.models.fields.PointField')()),
        ))
        db.send_create_signal('georefs', ['ReferenciaGeograficaCliente'])


    def backwards(self, orm):
        # Deleting model 'ReferenciaGeograficaCliente'
        db.delete_table('georefs_referenciageograficacliente')
    ...
    models = {
        ...
        'georefs.referenciageograficacliente': {
            'Meta': {'object_name': 'ReferenciaGeograficaCliente'},
            ...
            'ponto': ('django.contrib.gis.db.models.fields.PointField', [], {})
        },
        'rh.cargo': {
