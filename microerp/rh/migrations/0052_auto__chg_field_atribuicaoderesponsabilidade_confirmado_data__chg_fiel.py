...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AtribuicaoDeResponsabilidade.confirmado_data'
        db.alter_column(u'rh_atribuicaoderesponsabilidade', 'confirmado_data', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'AtribuicaoDeResponsabilidade.confirmado_data'
        db.alter_column(u'rh_atribuicaoderesponsabilidade', 'confirmado_data', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'AtribuicaoDeResponsabilidade.confirmado_por'
        db.alter_column(u'rh_atribuicaoderesponsabilidade', 'confirmado_por_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']))
