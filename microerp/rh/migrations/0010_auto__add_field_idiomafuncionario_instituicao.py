...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IdiomaFuncionario.instituicao'
        db.add_column('rh_idiomafuncionario', 'instituicao',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IdiomaFuncionario.instituicao'
        db.delete_column('rh_idiomafuncionario', 'instituicao')
