...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RotinaExameMedico.funcionario'
        db.delete_column(u'rh_rotinaexamemedico', 'funcionario_id')


    def backwards(self, orm):
        # Adding field 'RotinaExameMedico.funcionario'
        db.add_column(u'rh_rotinaexamemedico', 'funcionario',
