...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FolhaDePonto.arquivo'
        db.alter_column(u'rh_folhadeponto', 'arquivo', self.gf('django.db.models.fields.files.FileField')(max_length=300, null=True))

    def backwards(self, orm):

        # Changing field 'FolhaDePonto.arquivo'
        db.alter_column(u'rh_folhadeponto', 'arquivo', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))
