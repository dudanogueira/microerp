...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Demissao'
        db.create_table(u'rh_demissao', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('funcionario', self.gf('django.db.models.fields.related.ForeignKey')(related_name='demissao_set', to=orm['rh.Funcionario'])),
            ('data', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 3, 19, 0, 0))),
            ('periodo_trabalhado_finalizado', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rh.PeriodoTrabalhado'])),
            ('demissor', self.gf('django.db.models.fields.related.ForeignKey')(related_name='demissor_set', to=orm['rh.Funcionario'])),
        ...
        db.send_create_signal(u'rh', ['Demissao'])

        # Adding field 'TipoDeExameMedico.criado'
        db.add_column(u'rh_tipodeexamemedico', 'criado',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'TipoDeExameMedico.atualizado'
        db.add_column(u'rh_tipodeexamemedico', 'atualizado',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True),
                      keep_default=False)

        # Adding field 'RotinaExameMedico.criado'
        db.add_column(u'rh_rotinaexamemedico', 'criado',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'RotinaExameMedico.atualizado'
        db.add_column(u'rh_rotinaexamemedico', 'atualizado',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True),
                      keep_default=False)

        # Adding field 'PerfilAcessoRH.criado'
        db.add_column(u'rh_perfilacessorh', 'criado',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'PerfilAcessoRH.atualizado'
        db.add_column(u'rh_perfilacessorh', 'atualizado',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True),
                      keep_default=False)

        # Adding field 'DependenteDeFuncionario.criado'
        db.add_column(u'rh_dependentedefuncionario', 'criado',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'DependenteDeFuncionario.atualizado'
        db.add_column(u'rh_dependentedefuncionario', 'atualizado',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Demissao'
        db.delete_table(u'rh_demissao')

        # Deleting field 'TipoDeExameMedico.criado'
        db.delete_column(u'rh_tipodeexamemedico', 'criado')

        # Deleting field 'TipoDeExameMedico.atualizado'
        db.delete_column(u'rh_tipodeexamemedico', 'atualizado')

        # Deleting field 'RotinaExameMedico.criado'
        db.delete_column(u'rh_rotinaexamemedico', 'criado')

        # Deleting field 'RotinaExameMedico.atualizado'
        db.delete_column(u'rh_rotinaexamemedico', 'atualizado')

        # Deleting field 'PerfilAcessoRH.criado'
        db.delete_column(u'rh_perfilacessorh', 'criado')

        # Deleting field 'PerfilAcessoRH.atualizado'
        db.delete_column(u'rh_perfilacessorh', 'atualizado')

        # Deleting field 'DependenteDeFuncionario.criado'
        db.delete_column(u'rh_dependentedefuncionario', 'criado')

        # Deleting field 'DependenteDeFuncionario.atualizado'
        db.delete_column(u'rh_dependentedefuncionario', 'atualizado')
