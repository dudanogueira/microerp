...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AutorizacaoHoraExtra.valor_total'
        db.add_column(u'rh_autorizacaohoraextra', 'valor_total',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AutorizacaoHoraExtra.valor_total'
        db.delete_column(u'rh_autorizacaohoraextra', 'valor_total')
