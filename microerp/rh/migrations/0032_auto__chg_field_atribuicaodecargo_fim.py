...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AtribuicaoDeCargo.fim'
        db.alter_column(u'rh_atribuicaodecargo', 'fim', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'AtribuicaoDeCargo.fim'
        db.alter_column(u'rh_atribuicaodecargo', 'fim', self.gf('django.db.models.fields.DateField')())
