...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ExperienciasProfissionaisFuncionario.data_demissao'
        db.alter_column('rh_experienciasprofissionaisfuncionario', 'data_demissao', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'ExperienciasProfissionaisFuncionario.data_demissao'
        db.alter_column('rh_experienciasprofissionaisfuncionario', 'data_demissao', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 11, 12, 0, 0)))
