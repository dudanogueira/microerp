...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Procedimento.departamento'
        db.add_column(u'rh_procedimento', 'departamento',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['rh.Departamento']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Procedimento.departamento'
        db.delete_column(u'rh_procedimento', 'departamento_id')
