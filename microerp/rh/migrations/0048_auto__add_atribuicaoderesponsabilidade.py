...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AtribuicaoDeResponsabilidade'
        db.create_table(u'rh_atribuicaoderesponsabilidade', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('periodo_trabalhado', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rh.PeriodoTrabalhado'])),
            ('treinamento_realizado', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('horas_treinadas', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('data_treinado', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
        ...
        db.send_create_signal(u'rh', ['AtribuicaoDeResponsabilidade'])

        # Adding M2M table for field subprocedimentos on 'AtribuicaoDeResponsabilidade'
        db.create_table(u'rh_atribuicaoderesponsabilidade_subprocedimentos', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('atribuicaoderesponsabilidade', models.ForeignKey(orm[u'rh.atribuicaoderesponsabilidade'], null=False)),
            ('subprocedimento', models.ForeignKey(orm[u'rh.subprocedimento'], null=False))
        ))
        db.create_unique(u'rh_atribuicaoderesponsabilidade_subprocedimentos', ['atribuicaoderesponsabilidade_id', 'subprocedimento_id'])


    def backwards(self, orm):
        # Deleting model 'AtribuicaoDeResponsabilidade'
        db.delete_table(u'rh_atribuicaoderesponsabilidade')

        # Removing M2M table for field subprocedimentos on 'AtribuicaoDeResponsabilidade'
        db.delete_table('rh_atribuicaoderesponsabilidade_subprocedimentos')
    ...
    models = {
        ...
        u'rh.atribuicaodecargo': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 23, 0, 0)'}),
        ...
        u'rh.autorizacaohoraextra': {
            ...
            'atualizado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'data_execucao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 23, 0, 0)'}),
        ...
        u'rh.capacitacaodesubprocedimento': {
            ...
            'ultima_atualizacao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 23, 0, 0)'}),
            'versao_treinada': ('django.db.models.fields.IntegerField', [], {})
        },
        u'rh.cargo': {
        ...
        u'rh.cursofuncionario': {
            ...
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'data': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 23, 0, 0)'}),
            'funcionario': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['rh.Funcionario']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nome': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'})
        },
        ...
        u'rh.dependentedefuncionario': {
            ...
            'funcionario': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['rh.Funcionario']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nascimento': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 23, 0, 0)'}),
            'nome': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
        ...
        u'rh.entradafolhadeponto': {
            ...
            'atualizado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'fim': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 30, 0, 0)'}),
        ...
        u'rh.folhadeponto': {
            ...
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'data_referencia': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 23, 0, 0)'}),
        ...
        u'rh.funcionario': {
            ...
            'escolaridade_conclusao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 23, 0, 0)', 'null': 'True', 'blank': 'True'}),
            ...
            'ultima_checagem_endereco': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 23, 0, 0)'}),
        ...
        u'rh.promocaocargo': {
            ...
            'data_promocao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 23, 0, 0)'}),
            'data_resolucao': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'data_solicitacao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 23, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'rh.solicitacaodelicenca': {
            ...
            'data_criado': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 23, 0, 0)'}),
            'fim': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 27, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 23, 0, 0)'}),
