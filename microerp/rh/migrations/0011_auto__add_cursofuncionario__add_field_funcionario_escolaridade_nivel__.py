...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('rh_cursofuncionario', (
            ...
            ('data', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 11, 12, 0, 0))),
            ('carga_horaria', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('rh', ['CursoFuncionario'])

        # Adding field 'Funcionario.escolaridade_nivel'
        db.add_column('rh_funcionario', 'escolaridade_nivel',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Funcionario.escolaridade_cursos'
        db.add_column('rh_funcionario', 'escolaridade_cursos',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Funcionario.escolaridade_serie_inconclusa'
        db.add_column('rh_funcionario', 'escolaridade_serie_inconclusa',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Funcionario.escolaridade_conclusao'
        db.add_column('rh_funcionario', 'escolaridade_conclusao',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 11, 12, 0, 0)),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Funcionario.escolaridade_nivel'
        db.delete_column('rh_funcionario', 'escolaridade_nivel')

        # Deleting field 'Funcionario.escolaridade_cursos'
        db.delete_column('rh_funcionario', 'escolaridade_cursos')

        # Deleting field 'Funcionario.escolaridade_serie_inconclusa'
        db.delete_column('rh_funcionario', 'escolaridade_serie_inconclusa')

        # Deleting field 'Funcionario.escolaridade_conclusao'
        db.delete_column('rh_funcionario', 'escolaridade_conclusao')
    ...
    models = {
        ...
        'rh.cursofuncionario': {
            ...
            'data': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 11, 12, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'rh.funcionario': {
            ...
            'escolaridade_conclusao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 11, 12, 0, 0)'}),
