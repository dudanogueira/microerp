...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PromocaoSalario.criado_por'
        db.add_column(u'rh_promocaosalario', 'criado_por',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'PromocaoCargo.criado_por'
        db.add_column(u'rh_promocaocargo', 'criado_por',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PromocaoSalario.criado_por'
        db.delete_column(u'rh_promocaosalario', 'criado_por_id')

        # Deleting field 'PromocaoCargo.criado_por'
        db.delete_column(u'rh_promocaocargo', 'criado_por_id')
