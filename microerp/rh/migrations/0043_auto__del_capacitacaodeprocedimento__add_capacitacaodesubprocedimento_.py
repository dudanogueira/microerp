...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CapacitacaoDeSubProcedimento'
        db.create_table(u'rh_capacitacaodesubprocedimento', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('periodo_trabalhado', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rh.PeriodoTrabalhado'])),
            ('subprocedimento', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rh.SubProcedimento'])),
            ('versao_treinada', self.gf('django.db.models.fields.IntegerField')()),
            ('ultima_atualizacao', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 11, 21, 0, 0))),
        ...
        db.send_create_signal(u'rh', ['CapacitacaoDeSubProcedimento'])

        # Adding model 'SubProcedimento'
        db.create_table(u'rh_subprocedimento', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('procedimento', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rh.Procedimento'])),
            ('versao', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('nome', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('descricao', self.gf('django.db.models.fields.TextField')()),
            ('criado', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True)),
            ('atualizado', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'rh', ['SubProcedimento'])

        # Adding model 'Procedimento'
        db.create_table(u'rh_procedimento', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'rh', ['Procedimento'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'CapacitacaoDeSubProcedimento'
        db.delete_table(u'rh_capacitacaodesubprocedimento')

        # Deleting model 'SubProcedimento'
        db.delete_table(u'rh_subprocedimento')

        # Deleting model 'Procedimento'
        db.delete_table(u'rh_procedimento')
    ...
    models = {
        ...
        u'rh.capacitacaodesubprocedimento': {
            ...
            'ultima_atualizacao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 21, 0, 0)'}),
        ...
        u'rh.cargo': {
            ...
            'procedimentos': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['rh.Procedimento']", 'symmetrical': 'False'}),
        ...
        u'rh.funcionario': {
            ...
            'procedimentos': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['rh.Procedimento']", 'null': 'True', 'blank': 'True'}),
