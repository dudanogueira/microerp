...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cargo.tipo'
        db.add_column(u'rh_cargo', 'tipo',
                      self.gf('django.db.models.fields.CharField')(default='escritorio', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cargo.tipo'
        db.delete_column(u'rh_cargo', 'tipo')
