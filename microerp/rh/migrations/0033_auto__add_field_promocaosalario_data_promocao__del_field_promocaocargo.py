...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PromocaoSalario.data_promocao'
        db.add_column(u'rh_promocaosalario', 'data_promocao',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 11, 18, 0, 0)),
                      keep_default=False)

        # Deleting field 'PromocaoCargo.descricao'
        db.delete_column(u'rh_promocaocargo', 'descricao')

        # Adding field 'PromocaoCargo.observacao'
        db.add_column(u'rh_promocaocargo', 'observacao',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=100),
                      keep_default=False)

        # Adding field 'PromocaoCargo.data_promocao'
        db.add_column(u'rh_promocaocargo', 'data_promocao',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 11, 18, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PromocaoSalario.data_promocao'
        db.delete_column(u'rh_promocaosalario', 'data_promocao')

        # Adding field 'PromocaoCargo.descricao'
        db.add_column(u'rh_promocaocargo', 'descricao',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=100),
                      keep_default=False)

        # Deleting field 'PromocaoCargo.observacao'
        db.delete_column(u'rh_promocaocargo', 'observacao')

        # Deleting field 'PromocaoCargo.data_promocao'
        db.delete_column(u'rh_promocaocargo', 'data_promocao')
    ...
    models = {
        ...
        u'rh.promocaocargo': {
            ...
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'data_promocao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 18, 0, 0)'}),
