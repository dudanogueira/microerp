...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Funcionario.cargo_atual'
        db.alter_column('rh_funcionario', 'cargo_atual_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rh.Cargo']))

    def backwards(self, orm):

        # Changing field 'Funcionario.cargo_atual'
        db.alter_column('rh_funcionario', 'cargo_atual_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['rh.Cargo']))
    ...
    models = {
        ...
        'rh.funcionario': {
            ...
            'cargo_atual': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'cargo_atual'", 'null': 'True', 'to': "orm['rh.Cargo']"}),
        ...
        'rh.promocaocargo': {
            ...
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'data': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 11, 5, 0, 0)'}),
            'funcionario': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['rh.Funcionario']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
