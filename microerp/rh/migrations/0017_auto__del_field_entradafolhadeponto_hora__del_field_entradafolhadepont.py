...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EntradaFolhaDePonto.hora'
        db.delete_column(u'rh_entradafolhadeponto', 'hora')

        # Deleting field 'EntradaFolhaDePonto.tipo'
        db.delete_column(u'rh_entradafolhadeponto', 'tipo')

        # Adding field 'EntradaFolhaDePonto.inicio'
        db.add_column(u'rh_entradafolhadeponto', 'inicio',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 4, 15, 0, 0)),
                      keep_default=False)

        # Adding field 'EntradaFolhaDePonto.fim'
        db.add_column(u'rh_entradafolhadeponto', 'fim',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 4, 15, 0, 0)),
                      keep_default=False)

        # Adding field 'EntradaFolhaDePonto.total'
        db.add_column(u'rh_entradafolhadeponto', 'total',
                      self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=5, decimal_places=1),
                      keep_default=False)

        # Adding field 'EntradaFolhaDePonto.adicionado_por'
        db.add_column(u'rh_entradafolhadeponto', 'adicionado_por',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, related_name='entradas_folha_lancada_set', unique=True, to=orm['account.User']),
                      keep_default=False)


        # Changing field 'FolhaDePonto.horas_trabalhadas'
        db.alter_column(u'rh_folhadeponto', 'horas_trabalhadas', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=1))

    def backwards(self, orm):
        # Adding field 'EntradaFolhaDePonto.hora'
        db.add_column(u'rh_entradafolhadeponto', 'hora',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'EntradaFolhaDePonto.tipo'
        db.add_column(u'rh_entradafolhadeponto', 'tipo',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'EntradaFolhaDePonto.inicio'
        db.delete_column(u'rh_entradafolhadeponto', 'inicio')

        # Deleting field 'EntradaFolhaDePonto.fim'
        db.delete_column(u'rh_entradafolhadeponto', 'fim')

        # Deleting field 'EntradaFolhaDePonto.total'
        db.delete_column(u'rh_entradafolhadeponto', 'total')

        # Deleting field 'EntradaFolhaDePonto.adicionado_por'
        db.delete_column(u'rh_entradafolhadeponto', 'adicionado_por_id')


        # Changing field 'FolhaDePonto.horas_trabalhadas'
        db.alter_column(u'rh_folhadeponto', 'horas_trabalhadas', self.gf('django.db.models.fields.FloatField')())
    ...
    models = {
        ...
        u'rh.cursofuncionario': {
            ...
            'data': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 4, 15, 0, 0)'}),
        ...
        u'rh.dependentedefuncionario': {
            ...
            'funcionario': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['rh.Funcionario']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nascimento': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 4, 15, 0, 0)'}),
            'nome': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
        ...
        u'rh.entradafolhadeponto': {
            ...
            'adicionado_por': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'entradas_folha_lancada_set'", 'unique': 'True', 'to': u"orm['account.User']"}),
            'atualizado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'fim': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 4, 15, 0, 0)'}),
            'folha': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['rh.FolhaDePonto']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 4, 15, 0, 0)'}),
        ...
        u'rh.folhadeponto': {
            ...
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'data_referencia': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 4, 15, 0, 0)'}),
            ...
            'horas_trabalhadas': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '1'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'rh.funcionario': {
            ...
            'escolaridade_conclusao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 4, 15, 0, 0)'}),
        ...
        u'rh.promocaocargo': {
            ...
            'data_solicitacao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 4, 15, 0, 0)'}),
        ...
        u'rh.solicitacaodelicenca': {
            ...
            'data_criado': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 4, 15, 0, 0)'}),
            'fim': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 4, 19, 0, 0)'}),
            'funcionario': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['rh.Funcionario']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 4, 15, 0, 0)'}),
