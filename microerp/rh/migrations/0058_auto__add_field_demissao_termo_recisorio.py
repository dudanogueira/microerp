...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Demissao.termo_recisorio'
        db.add_column(u'rh_demissao', 'termo_recisorio',
                      self.gf('django.db.models.fields.files.FileField')(default=1, max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Demissao.termo_recisorio'
        db.delete_column(u'rh_demissao', 'termo_recisorio')
    ...
    models = {
        ...
        u'rh.demissao': {
            ...
            'termo_recisorio': ('django.db.models.fields.files.FileField', [], {'max_length': '100'})
        },
        u'rh.departamento': {
