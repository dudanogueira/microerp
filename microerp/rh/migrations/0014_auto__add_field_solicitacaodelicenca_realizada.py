...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SolicitacaoDeLicenca.realizada'
        db.add_column(u'rh_solicitacaodelicenca', 'realizada',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SolicitacaoDeLicenca.realizada'
        db.delete_column(u'rh_solicitacaodelicenca', 'realizada')
