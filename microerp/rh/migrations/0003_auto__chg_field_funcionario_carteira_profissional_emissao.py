...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Funcionario.carteira_profissional_emissao'
        db.alter_column(u'rh_funcionario', 'carteira_profissional_emissao', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Funcionario.carteira_profissional_emissao'
        db.alter_column(u'rh_funcionario', 'carteira_profissional_emissao', self.gf('django.db.models.fields.DateField')(default=1))
