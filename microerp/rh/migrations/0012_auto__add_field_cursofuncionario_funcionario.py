...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CursoFuncionario.funcionario'
        db.add_column('rh_cursofuncionario', 'funcionario',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['rh.Funcionario']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CursoFuncionario.funcionario'
        db.delete_column('rh_cursofuncionario', 'funcionario_id')
