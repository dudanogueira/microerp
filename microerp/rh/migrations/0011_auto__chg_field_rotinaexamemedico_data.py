...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RotinaExameMedico.data'
        db.alter_column(u'rh_rotinaexamemedico', 'data', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'RotinaExameMedico.data'
        db.alter_column(u'rh_rotinaexamemedico', 'data', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        u'rh.solicitacaodelicenca': {
            ...
            'fim': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 3, 20, 0, 0)'}),
            'funcionario': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['rh.Funcionario']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 3, 20, 0, 0)'}),
