...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'rh_feriado', (
            ...
            ('importado_por_sync', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ...
        db.send_create_signal(u'rh', ['Feriado'])


    def backwards(self, orm):
        # Deleting model 'Feriado'
        db.delete_table(u'rh_feriado')
