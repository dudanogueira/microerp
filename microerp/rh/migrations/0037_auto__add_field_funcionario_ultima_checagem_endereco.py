...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Funcionario.ultima_checagem_endereco'
        db.add_column(u'rh_funcionario', 'ultima_checagem_endereco',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 11, 20, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Funcionario.ultima_checagem_endereco'
        db.delete_column(u'rh_funcionario', 'ultima_checagem_endereco')
