...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CapacitacaoDeSubProcedimento.versao_treinada'
        db.alter_column(u'rh_capacitacaodesubprocedimento', 'versao_treinada', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'CapacitacaoDeSubProcedimento.versao_treinada'
        db.alter_column(u'rh_capacitacaodesubprocedimento', 'versao_treinada', self.gf('django.db.models.fields.IntegerField')(default=1))
