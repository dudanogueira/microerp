...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FolhaDePonto.periodo_trabalhado'
        db.add_column(u'rh_folhadeponto', 'periodo_trabalhado',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['rh.PeriodoTrabalhado']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FolhaDePonto.periodo_trabalhado'
        db.delete_column(u'rh_folhadeponto', 'periodo_trabalhado_id')
