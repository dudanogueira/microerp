...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Demissao.funcionario'
        db.delete_column(u'rh_demissao', 'funcionario_id')

        # Adding field 'Demissao.demitido'
        db.add_column(u'rh_demissao', 'demitido',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='demissao_set', to=orm['account.User']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Adding field 'Demissao.funcionario'
        db.add_column(u'rh_demissao', 'funcionario',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='demissao_set', to=orm['rh.Funcionario']),
                      keep_default=False)

        # Deleting field 'Demissao.demitido'
        db.delete_column(u'rh_demissao', 'demitido_id')
    ...
    models = {
        ...
        u'rh.cursofuncionario': {
            ...
            'data': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 4, 22, 0, 0)'}),
        ...
        u'rh.demissao': {
            ...
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'data': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 4, 22, 0, 0)'}),
            'demissor': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'demissor_set'", 'to': u"orm['account.User']"}),
            'demitido': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'demissao_set'", 'to': u"orm['account.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'rh.dependentedefuncionario': {
            ...
            'funcionario': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['rh.Funcionario']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nascimento': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 4, 22, 0, 0)'}),
            'nome': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
        ...
        u'rh.entradafolhadeponto': {
            ...
            'adicionado_por': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'entradas_folha_lancada_set'", 'to': u"orm['account.User']"}),
            'arquivo': ('django.db.models.fields.files.FileField', [], {'max_length': '300', 'null': 'True', 'blank': 'True'}),
            'atualizado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'fim': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 4, 29, 0, 0)'}),
            'folha': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['rh.FolhaDePonto']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 4, 22, 0, 0)'}),
        ...
        u'rh.folhadeponto': {
            ...
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'data_referencia': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 4, 22, 0, 0)'}),
        ...
        u'rh.funcionario': {
            ...
            'escolaridade_conclusao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 4, 22, 0, 0)'}),
        ...
        u'rh.promocaocargo': {
            ...
            'data_solicitacao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 4, 22, 0, 0)'}),
        ...
        u'rh.solicitacaodelicenca': {
            ...
            'data_criado': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 4, 22, 0, 0)'}),
            'fim': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 4, 26, 0, 0)'}),
            'funcionario': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['rh.Funcionario']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 4, 22, 0, 0)'}),
