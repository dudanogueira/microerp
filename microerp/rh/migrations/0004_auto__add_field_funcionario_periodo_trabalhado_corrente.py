...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Funcionario.periodo_trabalhado_corrente'
        db.add_column(u'rh_funcionario', 'periodo_trabalhado_corrente',
                      self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='periodo_trabalhado_corrente', unique=True, null=True, to=orm['rh.PeriodoTrabalhado']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Funcionario.periodo_trabalhado_corrente'
        db.delete_column(u'rh_funcionario', 'periodo_trabalhado_corrente_id')
