...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RotinaExameMedico.realizado'
        db.add_column(u'rh_rotinaexamemedico', 'realizado',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RotinaExameMedico.realizado'
        db.delete_column(u'rh_rotinaexamemedico', 'realizado')
