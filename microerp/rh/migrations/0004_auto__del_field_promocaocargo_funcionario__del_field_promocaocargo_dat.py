...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PromocaoCargo.funcionario'
        db.delete_column('rh_promocaocargo', 'funcionario_id')

        # Deleting field 'PromocaoCargo.data'
        db.delete_column('rh_promocaocargo', 'data')

        # Adding field 'PromocaoCargo.aprovado'
        db.add_column('rh_promocaocargo', 'aprovado',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PromocaoCargo.avaliado'
        db.add_column('rh_promocaocargo', 'avaliado',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PromocaoCargo.descricao'
        db.add_column('rh_promocaocargo', 'descricao',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=100),
                      keep_default=False)

        # Adding field 'PromocaoCargo.data_solicitacao'
        db.add_column('rh_promocaocargo', 'data_solicitacao',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 11, 5, 0, 0)),
                      keep_default=False)

        # Adding field 'PromocaoCargo.data_resolucao'
        db.add_column('rh_promocaocargo', 'data_resolucao',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PromocaoCargo.beneficiario'
        db.add_column('rh_promocaocargo', 'beneficiario',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='promocao_cargo_set', to=orm['rh.Funcionario']),
                      keep_default=False)

        # Adding field 'PromocaoCargo.solicitante'
        db.add_column('rh_promocaocargo', 'solicitante',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='solicitacao_promocao_cargo_set', to=orm['rh.Funcionario']),
                      keep_default=False)

        # Adding field 'PromocaoCargo.autorizador'
        db.add_column('rh_promocaocargo', 'autorizador',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='autorizacao_promocao_cargo_set', null=True, to=orm['rh.Funcionario']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PromocaoCargo.funcionario'
        db.add_column('rh_promocaocargo', 'funcionario',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['rh.Funcionario']),
                      keep_default=False)

        # Adding field 'PromocaoCargo.data'
        db.add_column('rh_promocaocargo', 'data',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 11, 5, 0, 0)),
                      keep_default=False)

        # Deleting field 'PromocaoCargo.aprovado'
        db.delete_column('rh_promocaocargo', 'aprovado')

        # Deleting field 'PromocaoCargo.avaliado'
        db.delete_column('rh_promocaocargo', 'avaliado')

        # Deleting field 'PromocaoCargo.descricao'
        db.delete_column('rh_promocaocargo', 'descricao')

        # Deleting field 'PromocaoCargo.data_solicitacao'
        db.delete_column('rh_promocaocargo', 'data_solicitacao')

        # Deleting field 'PromocaoCargo.data_resolucao'
        db.delete_column('rh_promocaocargo', 'data_resolucao')

        # Deleting field 'PromocaoCargo.beneficiario'
        db.delete_column('rh_promocaocargo', 'beneficiario_id')

        # Deleting field 'PromocaoCargo.solicitante'
        db.delete_column('rh_promocaocargo', 'solicitante_id')

        # Deleting field 'PromocaoCargo.autorizador'
        db.delete_column('rh_promocaocargo', 'autorizador_id')
    ...
    models = {
        ...
        'rh.funcionario': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nascimento': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 11, 5, 0, 0)'}),
        ...
        'rh.periodotrabalhado': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 11, 5, 0, 0)'})
        },
        'rh.promocaocargo': {
            ...
            'data_solicitacao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 11, 5, 0, 0)'}),
        ...
        'rh.solicitacaodelicenca': {
            ...
            'data_criado': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 11, 5, 0, 0)'}),
            'fim': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 11, 5, 0, 0)'}),
            'funcionario': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['rh.Funcionario']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 11, 5, 0, 0)'}),
