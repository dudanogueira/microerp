...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AtribuicaoDeResponsabilidade.criado_por'
        db.add_column(u'rh_atribuicaoderesponsabilidade', 'criado_por',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AtribuicaoDeResponsabilidade.criado_por'
        db.delete_column(u'rh_atribuicaoderesponsabilidade', 'criado_por_id')
