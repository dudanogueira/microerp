...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ExperienciasProfissionaisFuncionario.complemento'
        db.delete_column('rh_experienciasprofissionaisfuncionario', 'complemento')

        # Deleting field 'ExperienciasProfissionaisFuncionario.bairro'
        db.delete_column('rh_experienciasprofissionaisfuncionario', 'bairro_id')

        # Deleting field 'ExperienciasProfissionaisFuncionario.cidade'
        db.delete_column('rh_experienciasprofissionaisfuncionario', 'cidade_id')

        # Deleting field 'ExperienciasProfissionaisFuncionario.rua'
        db.delete_column('rh_experienciasprofissionaisfuncionario', 'rua')

        # Deleting field 'ExperienciasProfissionaisFuncionario.numero'
        db.delete_column('rh_experienciasprofissionaisfuncionario', 'numero')

        # Deleting field 'ExperienciasProfissionaisFuncionario.cep'
        db.delete_column('rh_experienciasprofissionaisfuncionario', 'cep')

        # Adding field 'ExperienciasProfissionaisFuncionario.endereco_completo'
        db.add_column('rh_experienciasprofissionaisfuncionario', 'endereco_completo',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ExperienciasProfissionaisFuncionario.complemento'
        db.add_column('rh_experienciasprofissionaisfuncionario', 'complemento',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'ExperienciasProfissionaisFuncionario.bairro'
        db.add_column('rh_experienciasprofissionaisfuncionario', 'bairro',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['cadastro.Bairro']),
                      keep_default=False)

        # Adding field 'ExperienciasProfissionaisFuncionario.cidade'
        db.add_column('rh_experienciasprofissionaisfuncionario', 'cidade',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['cadastro.Cidade']),
                      keep_default=False)

        # Adding field 'ExperienciasProfissionaisFuncionario.rua'
        db.add_column('rh_experienciasprofissionaisfuncionario', 'rua',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)

        # Adding field 'ExperienciasProfissionaisFuncionario.numero'
        db.add_column('rh_experienciasprofissionaisfuncionario', 'numero',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'ExperienciasProfissionaisFuncionario.cep'
        db.add_column('rh_experienciasprofissionaisfuncionario', 'cep',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Deleting field 'ExperienciasProfissionaisFuncionario.endereco_completo'
        db.delete_column('rh_experienciasprofissionaisfuncionario', 'endereco_completo')
