...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SolicitacaoDeLicenca.funcionario'
        db.delete_column(u'rh_solicitacaodelicenca', 'funcionario_id')

        # Adding field 'SolicitacaoDeLicenca.periodo_trabalhado'
        db.add_column(u'rh_solicitacaodelicenca', 'periodo_trabalhado',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['rh.PeriodoTrabalhado']),
                      keep_default=False)

        # Deleting field 'FolhaDePonto.funcionario'
        db.delete_column(u'rh_folhadeponto', 'funcionario_id')


    def backwards(self, orm):
        # Adding field 'SolicitacaoDeLicenca.funcionario'
        db.add_column(u'rh_solicitacaodelicenca', 'funcionario',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['rh.Funcionario']),
                      keep_default=False)

        # Deleting field 'SolicitacaoDeLicenca.periodo_trabalhado'
        db.delete_column(u'rh_solicitacaodelicenca', 'periodo_trabalhado_id')

        # Adding field 'FolhaDePonto.funcionario'
        db.add_column(u'rh_folhadeponto', 'funcionario',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['rh.Funcionario']),
                      keep_default=False)
