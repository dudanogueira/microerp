...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Funcionario.escolaridade_conclusao'
        db.alter_column(u'rh_funcionario', 'escolaridade_conclusao', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Funcionario.escolaridade_conclusao'
        db.alter_column(u'rh_funcionario', 'escolaridade_conclusao', self.gf('django.db.models.fields.DateField')())
