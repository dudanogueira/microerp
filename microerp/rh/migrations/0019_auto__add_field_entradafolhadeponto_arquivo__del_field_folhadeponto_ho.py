...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EntradaFolhaDePonto.arquivo'
        db.add_column(u'rh_entradafolhadeponto', 'arquivo',
                      self.gf('django.db.models.fields.files.FileField')(max_length=300, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'FolhaDePonto.horas_trabalhadas'
        db.delete_column(u'rh_folhadeponto', 'horas_trabalhadas')

        # Deleting field 'FolhaDePonto.arquivo'
        db.delete_column(u'rh_folhadeponto', 'arquivo')


    def backwards(self, orm):
        # Deleting field 'EntradaFolhaDePonto.arquivo'
        db.delete_column(u'rh_entradafolhadeponto', 'arquivo')

        # Adding field 'FolhaDePonto.horas_trabalhadas'
        db.add_column(u'rh_folhadeponto', 'horas_trabalhadas',
                      self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=10, decimal_places=1),
                      keep_default=False)

        # Adding field 'FolhaDePonto.arquivo'
        db.add_column(u'rh_folhadeponto', 'arquivo',
                      self.gf('django.db.models.fields.files.FileField')(max_length=300, null=True, blank=True),
                      keep_default=False)
