...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Demissao.status'
        db.add_column(u'rh_demissao', 'status',
                      self.gf('django.db.models.fields.CharField')(default='andamento', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Demissao.status'
        db.delete_column(u'rh_demissao', 'status')
