...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AtribuicaoDeResponsabilidade.confirmado_por'
        db.add_column(u'rh_atribuicaoderesponsabilidade', 'confirmado_por',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='atribuicaoderesponsabilidade_confirmado_set', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'AtribuicaoDeResponsabilidade.confirmado_data'
        db.add_column(u'rh_atribuicaoderesponsabilidade', 'confirmado_data',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AtribuicaoDeResponsabilidade.confirmado_por'
        db.delete_column(u'rh_atribuicaoderesponsabilidade', 'confirmado_por_id')

        # Deleting field 'AtribuicaoDeResponsabilidade.confirmado_data'
        db.delete_column(u'rh_atribuicaoderesponsabilidade', 'confirmado_data')
    ...
    models = {
        ...
        u'rh.atribuicaoderesponsabilidade': {
            ...
            'atualizado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
            'confirmado_data': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'confirmado_por': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'atribuicaoderesponsabilidade_confirmado_set'", 'to': u"orm['auth.User']"}),
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
