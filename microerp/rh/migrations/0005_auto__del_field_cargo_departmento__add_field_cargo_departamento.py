...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'rh_cargo', 'departmento_id')

        # Adding field 'Cargo.departamento'
        db.add_column(u'rh_cargo', 'departamento',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'rh_cargo', 'departmento',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['rh.Departamento']),
                      keep_default=False)

        # Deleting field 'Cargo.departamento'
        db.delete_column(u'rh_cargo', 'departamento_id')
