...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Funcionario.salario_atual'
        db.add_column('rh_funcionario', 'salario_atual',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Funcionario.salario_atual'
        db.delete_column('rh_funcionario', 'salario_atual')
