...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AtribuicaoDeResponsabilidade.tipo_de_treinamento'
        db.add_column(u'rh_atribuicaoderesponsabilidade', 'tipo_de_treinamento',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AtribuicaoDeResponsabilidade.tipo_de_treinamento'
        db.delete_column(u'rh_atribuicaoderesponsabilidade', 'tipo_de_treinamento')
