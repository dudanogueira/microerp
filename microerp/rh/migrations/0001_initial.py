...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('rh_funcionario', (
            ...
            ('escolaridade_conclusao', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 12, 31, 0, 0))),
        ...
        db.create_table('rh_cursofuncionario', (
            ...
            ('data', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 12, 31, 0, 0))),
        ...
        db.create_table('rh_periodotrabalhado', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('funcionario', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rh.Funcionario'])),
            ('inicio', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 12, 31, 0, 0))),
        ...
        db.create_table('rh_promocaosalario', (
            ...
            ('data_solicitacao', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 12, 31, 0, 0))),
        ...
        db.create_table('rh_solicitacaodelicenca', (
            ...
            ('funcionario', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rh.Funcionario'])),
            ('inicio', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 12, 31, 0, 0))),
            ('fim', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 12, 31, 0, 0))),
            ...
            ('data_criado', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 12, 31, 0, 0))),
        ...
        db.create_table('rh_folhadeponto', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('funcionario', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rh.Funcionario'])),
            ('data_referencia', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 12, 31, 0, 0))),
    ...
    models = {
        ...
        'rh.cursofuncionario': {
            ...
            'data': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 12, 31, 0, 0)'}),
        ...
        'rh.folhadeponto': {
            ...
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'data_referencia': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 12, 31, 0, 0)'}),
        ...
        'rh.funcionario': {
            ...
            'escolaridade_conclusao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 12, 31, 0, 0)'}),
        ...
        'rh.periodotrabalhado': {
            ...
            'funcionario': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['rh.Funcionario']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 12, 31, 0, 0)'})
        },
        'rh.promocaocargo': {
            ...
            'data_solicitacao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 12, 31, 0, 0)'}),
        ...
        'rh.solicitacaodelicenca': {
            ...
            'data_criado': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 12, 31, 0, 0)'}),
            'fim': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 12, 31, 0, 0)'}),
            'funcionario': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['rh.Funcionario']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 12, 31, 0, 0)'}),
