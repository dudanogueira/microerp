...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field subprocedimentos on 'Cargo'
        db.create_table(u'rh_cargo_subprocedimentos', (
        ...
        db.create_unique(u'rh_cargo_subprocedimentos', ['cargo_id', 'subprocedimento_id'])
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'rh_cargo_procedimentos', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('cargo', models.ForeignKey(orm[u'rh.cargo'], null=False)),
            ('procedimento', models.ForeignKey(orm[u'rh.procedimento'], null=False))
        ))
        db.create_unique(u'rh_cargo_procedimentos', ['cargo_id', 'procedimento_id'])

        # Removing M2M table for field subprocedimentos on 'Cargo'
        db.delete_table('rh_cargo_subprocedimentos')
