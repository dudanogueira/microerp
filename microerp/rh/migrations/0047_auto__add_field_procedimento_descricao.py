...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing M2M table for field subprocedimentos on 'Funcionario'
        db.delete_table('rh_funcionario_subprocedimentos')

        # Adding field 'Procedimento.descricao'
        db.add_column(u'rh_procedimento', 'descricao',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding M2M table for field subprocedimentos on 'Funcionario'
        db.create_table(u'rh_funcionario_subprocedimentos', (
        ...
        db.create_unique(u'rh_funcionario_subprocedimentos', ['funcionario_id', 'subprocedimento_id'])

        # Deleting field 'Procedimento.descricao'
        db.delete_column(u'rh_procedimento', 'descricao')
