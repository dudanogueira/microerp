...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Demissao.demitido'
        db.alter_column(u'rh_demissao', 'demitido_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rh.Funcionario']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Demissao.demitido'
        db.alter_column(u'rh_demissao', 'demitido_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['account.User']))
