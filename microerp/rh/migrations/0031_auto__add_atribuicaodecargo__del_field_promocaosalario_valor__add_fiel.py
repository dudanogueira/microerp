...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AtribuicaoDeCargo'
        db.create_table(u'rh_atribuicaodecargo', (
            ...
            ('inicio', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 11, 18, 0, 0))),
            ('fim', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 11, 18, 0, 0))),
            ('criado_por', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
        ...
        db.send_create_signal(u'rh', ['AtribuicaoDeCargo'])

        # Deleting field 'PromocaoSalario.valor'
        db.delete_column(u'rh_promocaosalario', 'valor')

        # Adding field 'PromocaoSalario.valor_origem'
        db.add_column(u'rh_promocaosalario', 'valor_origem',
                      self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=10, decimal_places=2),
                      keep_default=False)

        # Adding field 'PromocaoSalario.valor_destino'
        db.add_column(u'rh_promocaosalario', 'valor_destino',
                      self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=10, decimal_places=2),
                      keep_default=False)

        # Adding field 'PromocaoSalario.atribuicao_de_cargo'
        db.add_column(u'rh_promocaosalario', 'atribuicao_de_cargo',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['rh.AtribuicaoDeCargo']),
                      keep_default=False)

        # Deleting field 'PromocaoCargo.cargo_antigo'
        db.delete_column(u'rh_promocaocargo', 'cargo_antigo_id')

        # Deleting field 'PromocaoCargo.cargo_novo'
        db.delete_column(u'rh_promocaocargo', 'cargo_novo_id')

        # Adding field 'PromocaoCargo.atribuicao_de_origem'
        db.add_column(u'rh_promocaocargo', 'atribuicao_de_origem',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, related_name='promocao_de_origem', unique=True, to=orm['rh.AtribuicaoDeCargo']),
                      keep_default=False)

        # Adding field 'PromocaoCargo.atribuicao_de_destino'
        db.add_column(u'rh_promocaocargo', 'atribuicao_de_destino',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, related_name='promocao_de_destino', unique=True, to=orm['rh.AtribuicaoDeCargo']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'AtribuicaoDeCargo'
        db.delete_table(u'rh_atribuicaodecargo')

        # Adding field 'PromocaoSalario.valor'
        db.add_column(u'rh_promocaosalario', 'valor',
                      self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=10, decimal_places=2),
                      keep_default=False)

        # Deleting field 'PromocaoSalario.valor_origem'
        db.delete_column(u'rh_promocaosalario', 'valor_origem')

        # Deleting field 'PromocaoSalario.valor_destino'
        db.delete_column(u'rh_promocaosalario', 'valor_destino')

        # Deleting field 'PromocaoSalario.atribuicao_de_cargo'
        db.delete_column(u'rh_promocaosalario', 'atribuicao_de_cargo_id')

        # Adding field 'PromocaoCargo.cargo_antigo'
        db.add_column(u'rh_promocaocargo', 'cargo_antigo',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='cargo_antigo_set', to=orm['rh.Cargo']),
                      keep_default=False)

        # Adding field 'PromocaoCargo.cargo_novo'
        db.add_column(u'rh_promocaocargo', 'cargo_novo',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='cargo_novo_set', to=orm['rh.Cargo']),
                      keep_default=False)

        # Deleting field 'PromocaoCargo.atribuicao_de_origem'
        db.delete_column(u'rh_promocaocargo', 'atribuicao_de_origem_id')

        # Deleting field 'PromocaoCargo.atribuicao_de_destino'
        db.delete_column(u'rh_promocaocargo', 'atribuicao_de_destino_id')
    ...
    models = {
        ...
        u'rh.atribuicaodecargo': {
            ...
            'fim': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 18, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 18, 0, 0)'}),
        ...
        u'rh.cursofuncionario': {
            ...
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'data': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 18, 0, 0)'}),
        ...
        u'rh.dependentedefuncionario': {
            ...
            'funcionario': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['rh.Funcionario']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nascimento': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 18, 0, 0)'}),
            'nome': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
        ...
        u'rh.folhadeponto': {
            ...
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'data_referencia': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 18, 0, 0)'}),
        ...
        u'rh.funcionario': {
            ...
            'escolaridade_conclusao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 18, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        u'rh.promocaocargo': {
            ...
            'data_solicitacao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 18, 0, 0)'}),
        ...
        u'rh.solicitacaodelicenca': {
            ...
            'data_criado': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 18, 0, 0)'}),
            'fim': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 22, 0, 0)'}),
            'funcionario': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['rh.Funcionario']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 18, 0, 0)'}),
