...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AutorizacaoHoraExtra.quantidade_hora_extra'
        db.delete_column(u'rh_autorizacaohoraextra', 'quantidade_hora_extra')

        # Deleting field 'AutorizacaoHoraExtra.funcionario'
        db.delete_column(u'rh_autorizacaohoraextra', 'funcionario_id')

        # Adding field 'AutorizacaoHoraExtra.periodo_trabalhado'
        db.add_column(u'rh_autorizacaohoraextra', 'periodo_trabalhado',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['rh.PeriodoTrabalhado']),
                      keep_default=False)

        # Adding field 'AutorizacaoHoraExtra.quantidade'
        db.add_column(u'rh_autorizacaohoraextra', 'quantidade',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'AutorizacaoHoraExtra.quantidade_hora_extra'
        db.add_column(u'rh_autorizacaohoraextra', 'quantidade_hora_extra',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'AutorizacaoHoraExtra.funcionario'
        db.add_column(u'rh_autorizacaohoraextra', 'funcionario',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['rh.Funcionario']),
                      keep_default=False)

        # Deleting field 'AutorizacaoHoraExtra.periodo_trabalhado'
        db.delete_column(u'rh_autorizacaohoraextra', 'periodo_trabalhado_id')

        # Deleting field 'AutorizacaoHoraExtra.quantidade'
        db.delete_column(u'rh_autorizacaohoraextra', 'quantidade')
    ...
    models = {
        ...
        u'rh.atribuicaodecargo': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 24, 0, 0)'}),
        ...
        u'rh.atribuicaoderesponsabilidade': {
            ...
            'confirmado_por': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'atribuicaoderesponsabilidade_confirmado_set'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'rh.autorizacaohoraextra': {
            ...
            'atualizado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'data_execucao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 24, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'periodo_trabalhado': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['rh.PeriodoTrabalhado']"}),
        ...
        u'rh.capacitacaodesubprocedimento': {
            ...
            'ultima_atualizacao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 24, 0, 0)'}),
        ...
        u'rh.cursofuncionario': {
            ...
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'data': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 24, 0, 0)'}),
        ...
        u'rh.dependentedefuncionario': {
            ...
            'funcionario': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['rh.Funcionario']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nascimento': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 24, 0, 0)'}),
            'nome': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
        ...
        u'rh.entradafolhadeponto': {
            ...
            'atualizado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'fim': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 1, 0, 0)'}),
        ...
        u'rh.folhadeponto': {
            ...
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'data_referencia': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 24, 0, 0)'}),
        ...
        u'rh.funcionario': {
            ...
            'escolaridade_conclusao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 24, 0, 0)', 'null': 'True', 'blank': 'True'}),
            ...
            'ultima_checagem_endereco': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 24, 0, 0)'}),
        ...
        u'rh.promocaocargo': {
            ...
            'data_promocao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 24, 0, 0)'}),
            'data_resolucao': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'data_solicitacao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 24, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'rh.solicitacaodelicenca': {
            ...
            'data_criado': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 24, 0, 0)'}),
