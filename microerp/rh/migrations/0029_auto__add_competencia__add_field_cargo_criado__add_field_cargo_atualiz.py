...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'rh_competencia', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nome', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
        ))
        db.send_create_signal(u'rh', ['Competencia'])

        # Adding field 'Cargo.criado'
        db.add_column(u'rh_cargo', 'criado',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'Cargo.atualizado'
        db.add_column(u'rh_cargo', 'atualizado',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True),
                      keep_default=False)

        # Adding M2M table for field competencias on 'Cargo'
        db.create_table(u'rh_cargo_competencias', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('cargo', models.ForeignKey(orm[u'rh.cargo'], null=False)),
            ('competencia', models.ForeignKey(orm[u'rh.competencia'], null=False))
        ))
        db.create_unique(u'rh_cargo_competencias', ['cargo_id', 'competencia_id'])

        # Adding M2M table for field competencias on 'Funcionario'
        db.create_table(u'rh_funcionario_competencias', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('funcionario', models.ForeignKey(orm[u'rh.funcionario'], null=False)),
            ('competencia', models.ForeignKey(orm[u'rh.competencia'], null=False))
        ))
        db.create_unique(u'rh_funcionario_competencias', ['funcionario_id', 'competencia_id'])


    def backwards(self, orm):
        # Deleting model 'Competencia'
        db.delete_table(u'rh_competencia')

        # Deleting field 'Cargo.criado'
        db.delete_column(u'rh_cargo', 'criado')

        # Deleting field 'Cargo.atualizado'
        db.delete_column(u'rh_cargo', 'atualizado')

        # Removing M2M table for field competencias on 'Cargo'
        db.delete_table('rh_cargo_competencias')

        # Removing M2M table for field competencias on 'Funcionario'
        db.delete_table('rh_funcionario_competencias')
    ...
    models = {
        ...
        u'rh.cursofuncionario': {
            ...
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'data': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 5, 20, 0, 0)'}),
        ...
        u'rh.dependentedefuncionario': {
            ...
            'funcionario': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['rh.Funcionario']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nascimento': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 5, 20, 0, 0)'}),
            'nome': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
        ...
        u'rh.entradafolhadeponto': {
            ...
            'atualizado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'fim': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 5, 27, 0, 0)'}),
        ...
        u'rh.folhadeponto': {
            ...
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'data_referencia': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 5, 20, 0, 0)'}),
        ...
        u'rh.promocaocargo': {
            ...
            'data_solicitacao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 5, 20, 0, 0)'}),
        ...
        u'rh.solicitacaodelicenca': {
            ...
            'data_criado': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 5, 20, 0, 0)'}),
            'fim': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 5, 24, 0, 0)'}),
            'funcionario': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['rh.Funcionario']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 5, 20, 0, 0)'}),
