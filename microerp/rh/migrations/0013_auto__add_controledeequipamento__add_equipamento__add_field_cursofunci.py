...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('rh_controledeequipamento', (
        ...
        db.send_create_signal('rh', ['ControleDeEquipamento'])

        # Adding model 'Equipamento'
        db.create_table('rh_equipamento', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('controle', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rh.ControleDeEquipamento'])),
            ...
            ('quantidade', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('data_entrega', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 11, 13, 0, 0))),
            ('data_evolucao', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 11, 13, 0, 0))),
            ('entregue', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('criado', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True)),
            ('atualizado', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True)),
        ))
        db.send_create_signal('rh', ['Equipamento'])

        # Adding field 'CursoFuncionario.criado'
        db.add_column('rh_cursofuncionario', 'criado',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'CursoFuncionario.atualizado'
        db.add_column('rh_cursofuncionario', 'atualizado',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True),
                      keep_default=False)

        # Adding field 'ExperienciasProfissionaisFuncionario.criado'
        db.add_column('rh_experienciasprofissionaisfuncionario', 'criado',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'ExperienciasProfissionaisFuncionario.atualizado'
        db.add_column('rh_experienciasprofissionaisfuncionario', 'atualizado',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True),
                      keep_default=False)

        # Adding field 'IdiomaFuncionario.criado'
        db.add_column('rh_idiomafuncionario', 'criado',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'IdiomaFuncionario.atualizado'
        db.add_column('rh_idiomafuncionario', 'atualizado',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_table('rh_controledeequipamento')

        # Deleting model 'Equipamento'
        db.delete_table('rh_equipamento')

        # Deleting field 'CursoFuncionario.criado'
        db.delete_column('rh_cursofuncionario', 'criado')

        # Deleting field 'CursoFuncionario.atualizado'
        db.delete_column('rh_cursofuncionario', 'atualizado')

        # Deleting field 'ExperienciasProfissionaisFuncionario.criado'
        db.delete_column('rh_experienciasprofissionaisfuncionario', 'criado')

        # Deleting field 'ExperienciasProfissionaisFuncionario.atualizado'
        db.delete_column('rh_experienciasprofissionaisfuncionario', 'atualizado')

        # Deleting field 'IdiomaFuncionario.criado'
        db.delete_column('rh_idiomafuncionario', 'criado')

        # Deleting field 'IdiomaFuncionario.atualizado'
        db.delete_column('rh_idiomafuncionario', 'atualizado')
    ...
    models = {
        ...
        'rh.equipamento': {
            ...
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'data_entrega': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 11, 13, 0, 0)'}),
            'data_evolucao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 11, 13, 0, 0)'}),
