...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PerfilAcessoSolicitacao.user'
        db.alter_column(u'solicitacao_perfilacessosolicitacao', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))

        # Changing field 'Solicitacao.despachado_por'
        db.alter_column(u'solicitacao_solicitacao', 'despachado_por_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Solicitacao.adicionado_por'
        db.alter_column(u'solicitacao_solicitacao', 'adicionado_por_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'PerfilAcessoSolicitacao.user'
        db.alter_column(u'solicitacao_perfilacessosolicitacao', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['account.User'], unique=True))

        # Changing field 'Solicitacao.despachado_por'
        db.alter_column(u'solicitacao_solicitacao', 'despachado_por_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['account.User']))

        # Changing field 'Solicitacao.adicionado_por'
        db.alter_column(u'solicitacao_solicitacao', 'adicionado_por_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['account.User']))
    ...
    models = {
        ...
        u'solicitacao.solicitacao': {
            ...
            'adicionado_por': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'solicitacao_adicionada_set'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'atualizado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
            ...
            'despachado_por': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'solicitacao_despachado_set'", 'null': 'True', 'to': u"orm['auth.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nao_procede_porque': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'prazo': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 7, 22, 0, 0)'}),
