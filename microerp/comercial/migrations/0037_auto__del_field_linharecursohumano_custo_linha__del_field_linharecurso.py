...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'LinhaRecursoHumano.custo_linha'
        db.delete_column(u'comercial_linharecursohumano', 'custo_linha')

        # Deleting field 'LinhaRecursoHumano.preco_hora_cargo'
        db.delete_column(u'comercial_linharecursohumano', 'preco_hora_cargo')

        # Adding field 'LinhaRecursoHumano.preco_unitario'
        db.add_column(u'comercial_linharecursohumano', 'preco_unitario',
                      self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=10, decimal_places=2),
                      keep_default=False)

        # Adding field 'LinhaRecursoHumano.custo_total'
        db.add_column(u'comercial_linharecursohumano', 'custo_total',
                      self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=10, decimal_places=2),
                      keep_default=False)

        # Deleting field 'LinhaRecursoMaterial.custo_linha'
        db.delete_column(u'comercial_linharecursomaterial', 'custo_linha')

        # Deleting field 'LinhaRecursoMaterial.preco_produto'
        db.delete_column(u'comercial_linharecursomaterial', 'preco_produto')

        # Adding field 'LinhaRecursoMaterial.custo_unitario'
        db.add_column(u'comercial_linharecursomaterial', 'custo_unitario',
                      self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=10, decimal_places=2),
                      keep_default=False)

        # Adding field 'LinhaRecursoMaterial.custo_total'
        db.add_column(u'comercial_linharecursomaterial', 'custo_total',
                      self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=10, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'LinhaRecursoHumano.custo_linha'
        db.add_column(u'comercial_linharecursohumano', 'custo_linha',
                      self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=10, decimal_places=2),
                      keep_default=False)

        # Adding field 'LinhaRecursoHumano.preco_hora_cargo'
        db.add_column(u'comercial_linharecursohumano', 'preco_hora_cargo',
                      self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=10, decimal_places=2),
                      keep_default=False)

        # Deleting field 'LinhaRecursoHumano.preco_unitario'
        db.delete_column(u'comercial_linharecursohumano', 'preco_unitario')

        # Deleting field 'LinhaRecursoHumano.custo_total'
        db.delete_column(u'comercial_linharecursohumano', 'custo_total')

        # Adding field 'LinhaRecursoMaterial.custo_linha'
        db.add_column(u'comercial_linharecursomaterial', 'custo_linha',
                      self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=10, decimal_places=2),
                      keep_default=False)

        # Adding field 'LinhaRecursoMaterial.preco_produto'
        db.add_column(u'comercial_linharecursomaterial', 'preco_produto',
                      self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=10, decimal_places=2),
                      keep_default=False)

        # Deleting field 'LinhaRecursoMaterial.custo_unitario'
        db.delete_column(u'comercial_linharecursomaterial', 'custo_unitario')

        # Deleting field 'LinhaRecursoMaterial.custo_total'
        db.delete_column(u'comercial_linharecursomaterial', 'custo_total')
    ...
    models = {
        ...
        u'comercial.contratofechado': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio_cobranca': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 23, 0, 0)'}),
        ...
        u'comercial.followupdepropostacomercial': {
            'Meta': {'object_name': 'FollowUpDePropostaComercial'},
            'atualizado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'criado_por': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'followup_adicionado_set'", 'to': u"orm['auth.User']"}),
            'data_expiracao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 30, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'comercial.linharecursohumano': {
            ...
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'custo_total': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '2'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'orcamento': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['comercial.Orcamento']"}),
            'preco_unitario': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '2'}),
        ...
        u'comercial.linharecursomaterial': {
            ...
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'custo_total': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '2'}),
            'custo_unitario': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '2'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'orcamento': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['comercial.Orcamento']"}),
        ...
        u'comercial.orcamento': {
            ...
            'atualizado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'custo_mao_de_obra': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '2'}),
            'custo_material': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '2'}),
            'custo_total': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '2'}),
            ...
            'proposta': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['comercial.PropostaComercial']", 'blank': 'True'}),
        ...
        u'rh.funcionario': {
            ...
            'escolaridade_conclusao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 23, 0, 0)', 'null': 'True', 'blank': 'True'}),
            ...
            'ultima_checagem_endereco': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 23, 0, 0)'}),
        ...
        u'rh.periodotrabalhado': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 23, 0, 0)'})
        },
        u'rh.procedimento': {
