...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PropostaComercial.definido_perdido_por'
        db.add_column(u'comercial_propostacomercial', 'definido_perdido_por',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='proposta_definida_perdido_set', to=orm['rh.Funcionario']),
                      keep_default=False)

        # Adding field 'PropostaComercial.definido_perdido_em'
        db.add_column(u'comercial_propostacomercial', 'definido_perdido_em',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PropostaComercial.definido_perdido_por'
        db.delete_column(u'comercial_propostacomercial', 'definido_perdido_por_id')

        # Deleting field 'PropostaComercial.definido_perdido_em'
        db.delete_column(u'comercial_propostacomercial', 'definido_perdido_em')
    ...
    models = {
        ...
        u'comercial.contratofechado': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio_cobranca': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 26, 0, 0)'}),
        ...
        u'comercial.followupdepropostacomercial': {
            ...
            'data_expiracao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 2, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'comercial.propostacomercial': {
            ...
            'definido_perdido_por': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'proposta_definida_perdido_set'", 'to': u"orm['rh.Funcionario']"}),
        ...
        u'rh.funcionario': {
            ...
            'escolaridade_conclusao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 26, 0, 0)', 'null': 'True', 'blank': 'True'}),
            ...
            'ultima_checagem_endereco': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 26, 0, 0)'}),
        ...
        u'rh.periodotrabalhado': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 26, 0, 0)'})
        },
        u'rh.procedimento': {
