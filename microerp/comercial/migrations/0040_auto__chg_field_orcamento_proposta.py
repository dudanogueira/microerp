...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Orcamento.proposta'
        db.alter_column(u'comercial_orcamento', 'proposta_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['comercial.PropostaComercial'], null=True))

    def backwards(self, orm):

        # Changing field 'Orcamento.proposta'
        db.alter_column(u'comercial_orcamento', 'proposta_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['comercial.PropostaComercial']))
