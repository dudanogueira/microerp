...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContratoFechado.data_validacao'
        db.add_column(u'comercial_contratofechado', 'data_validacao',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ContratoFechado.funcionario_validador'
        db.add_column(u'comercial_contratofechado', 'funcionario_validador',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='contrato_validado_set', null=True, to=orm['rh.Funcionario']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContratoFechado.data_validacao'
        db.delete_column(u'comercial_contratofechado', 'data_validacao')

        # Deleting field 'ContratoFechado.funcionario_validador'
        db.delete_column(u'comercial_contratofechado', 'funcionario_validador_id')
