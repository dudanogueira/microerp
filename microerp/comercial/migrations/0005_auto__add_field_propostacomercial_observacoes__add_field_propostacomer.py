...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PropostaComercial.observacoes'
        db.add_column(u'comercial_propostacomercial', 'observacoes',
        ...
        db.add_column(u'comercial_propostacomercial', 'adicionado_por',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='proposta_adicionada_set', null=True, to=orm['account.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PropostaComercial.observacoes'
        db.delete_column(u'comercial_propostacomercial', 'observacoes')
    ...
    models = {
        ...
        u'comercial.propostacomercial': {
            ...
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'data_expiracao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 6, 11, 0, 0)'}),
