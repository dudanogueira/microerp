...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RequisicaoDeProposta'
        db.create_table(u'comercial_requisicaodeproposta', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cliente', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cadastro.Cliente'])),
            ('criado_por', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='proposta_requisitada_set', null=True, to=orm['auth.User'])),
        ...
        db.send_create_signal(u'comercial', ['RequisicaoDeProposta'])


    def backwards(self, orm):
        # Deleting model 'RequisicaoDeProposta'
        db.delete_table(u'comercial_requisicaodeproposta')
    ...
    models = {
        ...
        u'comercial.contratofechado': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio_cobranca': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 13, 0, 0)'}),
        ...
        u'comercial.followupdepropostacomercial': {
            ...
            'data_expiracao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 20, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
