...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LancamentoDeFechamentoComissao'
        db.create_table(u'comercial_lancamentodefechamentocomissao', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fechamento', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['comercial.FechamentoDeComissao'])),
        ...
        db.send_create_signal(u'comercial', ['LancamentoDeFechamentoComissao'])

        # Adding field 'FechamentoDeComissao.porcentagem_comissao'
        db.add_column(u'comercial_fechamentodecomissao', 'porcentagem_comissao',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2),
                      keep_default=False)

        # Adding M2M table for field contratos on 'FechamentoDeComissao'
        db.create_table(u'comercial_fechamentodecomissao_contratos', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('fechamentodecomissao', models.ForeignKey(orm[u'comercial.fechamentodecomissao'], null=False)),
            ('contratofechado', models.ForeignKey(orm[u'comercial.contratofechado'], null=False))
        ))
        db.create_unique(u'comercial_fechamentodecomissao_contratos', ['fechamentodecomissao_id', 'contratofechado_id'])


    def backwards(self, orm):
        # Deleting model 'LancamentoDeFechamentoComissao'
        db.delete_table(u'comercial_lancamentodefechamentocomissao')

        # Deleting field 'FechamentoDeComissao.porcentagem_comissao'
        db.delete_column(u'comercial_fechamentodecomissao', 'porcentagem_comissao')

        # Removing M2M table for field contratos on 'FechamentoDeComissao'
        db.delete_table('comercial_fechamentodecomissao_contratos')
    ...
    models = {
        ...
        u'comercial.contratofechado': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio_cobranca': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 16, 0, 0)'}),
        ...
        u'comercial.fechamentodecomissao': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'porcentagem_comissao': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '2'})
        },
        u'comercial.followupdepropostacomercial': {
            ...
            'data_expiracao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 23, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'rh.funcionario': {
            ...
            'escolaridade_conclusao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 16, 0, 0)', 'null': 'True', 'blank': 'True'}),
            ...
            'ultima_checagem_endereco': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 16, 0, 0)'}),
        ...
        u'rh.periodotrabalhado': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 16, 0, 0)'})
        },
        u'rh.procedimento': {
