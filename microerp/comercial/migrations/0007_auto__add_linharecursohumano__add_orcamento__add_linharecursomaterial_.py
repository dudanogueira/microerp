...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LinhaRecursoHumano'
        db.create_table(u'comercial_linharecursohumano', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('orcamento', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['comercial.Orcamento'])),
            ('cargo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rh.Cargo'])),
            ('quantidade', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'comercial', ['LinhaRecursoHumano'])

        # Adding model 'Orcamento'
        db.create_table(u'comercial_orcamento', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('modelo', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ...
        db.send_create_signal(u'comercial', ['Orcamento'])

        # Adding model 'LinhaRecursoMaterial'
        db.create_table(u'comercial_linharecursomaterial', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('orcamento', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['comercial.Orcamento'])),
            ('produto', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['estoque.Produto'])),
            ('quantidade', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'comercial', ['LinhaRecursoMaterial'])

        # Adding field 'PropostaComercial.orcamento_vinculado'
        db.add_column(u'comercial_propostacomercial', 'orcamento_vinculado',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['comercial.Orcamento']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'LinhaRecursoHumano'
        db.delete_table(u'comercial_linharecursohumano')

        # Deleting model 'Orcamento'
        db.delete_table(u'comercial_orcamento')

        # Deleting model 'LinhaRecursoMaterial'
        db.delete_table(u'comercial_linharecursomaterial')

        # Deleting field 'PropostaComercial.orcamento_vinculado'
        db.delete_column(u'comercial_propostacomercial', 'orcamento_vinculado_id')
    ...
    models = {
        ...
        u'comercial.propostacomercial': {
            ...
            'adicionado_por': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'proposta_adicionada_set'", 'null': 'True', 'to': u"orm['account.User']"}),
            'atualizado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
            'cliente': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cadastro.Cliente']", 'null': 'True', 'blank': 'True'}),
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'data_expiracao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 6, 12, 0, 0)'}),
            'follow_up': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'observacoes': ('django.db.models.fields.TextField', [], {}),
            'orcamento_vinculado': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['comercial.Orcamento']"}),
            'precliente': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cadastro.PreCliente']", 'null': 'True', 'blank': 'True'}),
        ...
        u'rh.funcionario': {
            ...
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
            'escolaridade_conclusao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 5, 28, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        u'rh.periodotrabalhado': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 5, 28, 0, 0)'})
        },
