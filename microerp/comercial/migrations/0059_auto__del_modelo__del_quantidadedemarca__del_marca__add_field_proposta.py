...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'comercial_modelo')

        # Deleting model 'QuantidadeDeMarca'
        db.delete_table(u'comercial_quantidadedemarca')

        # Deleting model 'Marca'
        db.delete_table(u'comercial_marca')

        # Adding field 'PropostaComercial.garantia_proposto'
        db.add_column(u'comercial_propostacomercial', 'garantia_proposto',
    ...
    def backwards(self, orm):
        # Adding model 'Modelo'
        db.create_table(u'comercial_modelo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nome', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
        ))
        db.send_create_signal(u'comercial', ['Modelo'])

        # Adding model 'QuantidadeDeMarca'
        db.create_table(u'comercial_quantidadedemarca', (
            ('quantidade', self.gf('django.db.models.fields.IntegerField')()),
            ('marca', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['comercial.Marca'], null=True, blank=True)),
            ('modelo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['comercial.Modelo'])),
            ('contratofechado', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['comercial.ContratoFechado'])),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'comercial', ['QuantidadeDeMarca'])

        # Adding model 'Marca'
        db.create_table(u'comercial_marca', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nome', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
        ))
        db.send_create_signal(u'comercial', ['Marca'])

        # Deleting field 'PropostaComercial.garantia_proposto'
        db.delete_column(u'comercial_propostacomercial', 'garantia_proposto')
    ...
    models = {
        ...
        u'comercial.contratofechado': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio_cobranca': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 23, 0, 0)'}),
        ...
        u'comercial.followupdepropostacomercial': {
            ...
            'data_expiracao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 30, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'rh.funcionario': {
            ...
            'escolaridade_conclusao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 23, 0, 0)', 'null': 'True', 'blank': 'True'}),
            ...
            'ultima_checagem_endereco': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 23, 0, 0)'}),
        ...
        u'rh.periodotrabalhado': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 23, 0, 0)'})
        },
        u'rh.procedimento': {
