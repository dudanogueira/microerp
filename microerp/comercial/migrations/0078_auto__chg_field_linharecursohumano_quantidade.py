...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LinhaRecursoHumano.quantidade'
        db.alter_column(u'comercial_linharecursohumano', 'quantidade', self.gf('django.db.models.fields.IntegerField')(default=1))

    def backwards(self, orm):

        # Changing field 'LinhaRecursoHumano.quantidade'
        db.alter_column(u'comercial_linharecursohumano', 'quantidade', self.gf('django.db.models.fields.IntegerField')(null=True))
