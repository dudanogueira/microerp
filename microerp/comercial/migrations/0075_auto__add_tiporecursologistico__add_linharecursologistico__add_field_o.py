...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TipoRecursoLogistico'
        db.create_table(u'comercial_tiporecursologistico', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nome', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
        ))
        db.send_create_signal(u'comercial', ['TipoRecursoLogistico'])

        # Adding model 'LinhaRecursoLogistico'
        db.create_table(u'comercial_linharecursologistico', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('proposta', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['comercial.PropostaComercial'])),
            ('tipo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['comercial.TipoRecursoLogistico'])),
            ('custo_total', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2, blank=True)),
        ...
        db.send_create_signal(u'comercial', ['LinhaRecursoLogistico'])

        # Adding field 'Orcamento.promocao'
        db.add_column(u'comercial_orcamento', 'promocao',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Orcamento.inicio_promocao'
        db.add_column(u'comercial_orcamento', 'inicio_promocao',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 5, 23, 0, 0)),
                      keep_default=False)

        # Adding field 'Orcamento.fim_promocao'
        db.add_column(u'comercial_orcamento', 'fim_promocao',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 5, 23, 0, 0)),
                      keep_default=False)

        # Adding field 'Orcamento.promocao_originaria'
        db.add_column(u'comercial_orcamento', 'promocao_originaria',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['comercial.Orcamento'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'TipoRecursoLogistico'
        db.delete_table(u'comercial_tiporecursologistico')

        # Deleting model 'LinhaRecursoLogistico'
        db.delete_table(u'comercial_linharecursologistico')

        # Deleting field 'Orcamento.promocao'
        db.delete_column(u'comercial_orcamento', 'promocao')

        # Deleting field 'Orcamento.inicio_promocao'
        db.delete_column(u'comercial_orcamento', 'inicio_promocao')

        # Deleting field 'Orcamento.fim_promocao'
        db.delete_column(u'comercial_orcamento', 'fim_promocao')

        # Deleting field 'Orcamento.promocao_originaria'
        db.delete_column(u'comercial_orcamento', 'promocao_originaria_id')
    ...
    models = {
        ...
        u'comercial.contratofechado': {
            ...
            'efetivo_inicio_execucao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 23, 0, 0)'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio_cobranca': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 23, 0, 0)'}),
            ...
            'previsao_inicio_execucao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 23, 0, 0)'}),
        ...
        u'comercial.followupdepropostacomercial': {
            ...
            'data_expiracao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 30, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'comercial.orcamento': {
            ...
            'fim_promocao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 23, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio_promocao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 23, 0, 0)'}),
            'modelo': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'promocao': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'promocao_originaria': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['comercial.Orcamento']", 'null': 'True', 'blank': 'True'}),
        ...
        u'rh.funcionario': {
            ...
            'escolaridade_conclusao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 23, 0, 0)', 'null': 'True', 'blank': 'True'}),
            ...
            'ultima_checagem_endereco': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 23, 0, 0)'}),
        ...
        u'rh.periodotrabalhado': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 23, 0, 0)'})
        },
        u'rh.procedimento': {
