...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'TabelaDeParcelamento', fields ['parcelas']
        db.delete_unique(u'comercial_tabeladeparcelamento', ['parcelas'])


    def backwards(self, orm):
        # Adding unique constraint on 'TabelaDeParcelamento', fields ['parcelas']
        db.create_unique(u'comercial_tabeladeparcelamento', ['parcelas'])
    ...
    models = {
        ...
        u'comercial.contratofechado': {
            ...
            'efetivo_inicio_execucao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 8, 5, 0, 0)'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio_cobranca': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 8, 5, 0, 0)'}),
            ...
            'previsao_inicio_execucao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 8, 5, 0, 0)'}),
        ...
        u'comercial.followupdepropostacomercial': {
            ...
            'data_expiracao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 8, 12, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'comercial.propostacomercial': {
            ...
            'parcelamentos_possiveis': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['comercial.TabelaDeParcelamento']", 'null': 'True', 'blank': 'True'}),
        ...
        u'comercial.tabeladeparcelamento': {
            'Meta': {'ordering': "['parcelas']", 'object_name': 'TabelaDeParcelamento'},
            ...
            'parcelas': ('django.db.models.fields.IntegerField', [], {})
        },
        ...
        u'rh.funcionario': {
            ...
            'escolaridade_conclusao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 8, 5, 0, 0)', 'null': 'True', 'blank': 'True'}),
            ...
            'ultima_checagem_endereco': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 8, 5, 0, 0)'}),
        ...
        u'rh.periodotrabalhado': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 8, 5, 0, 0)'})
        },
        u'rh.procedimento': {
