...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PropostaComercial.definido_convertido_por'
        db.add_column(u'comercial_propostacomercial', 'definido_convertido_por',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='proposta_definida_convertida_set', null=True, to=orm['rh.Funcionario']),
                      keep_default=False)

        # Adding field 'PropostaComercial.definido_convertido_em'
        db.add_column(u'comercial_propostacomercial', 'definido_convertido_em',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PropostaComercial.definido_convertido_por'
        db.delete_column(u'comercial_propostacomercial', 'definido_convertido_por_id')

        # Deleting field 'PropostaComercial.definido_convertido_em'
        db.delete_column(u'comercial_propostacomercial', 'definido_convertido_em')
    ...
    models = {
        ...
        u'comercial.contratofechado': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio_cobranca': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 10, 0, 0)'}),
        ...
        u'comercial.followupdepropostacomercial': {
            ...
            'data_expiracao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 17, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'rh.funcionario': {
            ...
            'escolaridade_conclusao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 10, 0, 0)', 'null': 'True', 'blank': 'True'}),
            ...
            'ultima_checagem_endereco': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 10, 0, 0)'}),
        ...
        u'rh.periodotrabalhado': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 10, 0, 0)'})
        },
        u'rh.procedimento': {
