...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'comercial_quantidadedemarca', (
            ...
            ('marca', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['comercial.Marca'])),
        ))
    ...
    models = {
        ...
        u'comercial.quantidadedemarca': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'marca': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['comercial.Marca']"}),
            'quantidade': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
