...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Orcamento.custo_humano'
        db.add_column(u'comercial_orcamento', 'custo_humano',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Orcamento.custo_humano'
        db.delete_column(u'comercial_orcamento', 'custo_humano')
