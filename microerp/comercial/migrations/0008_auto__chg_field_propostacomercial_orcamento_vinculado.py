...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PropostaComercial.orcamento_vinculado'
        db.alter_column(u'comercial_propostacomercial', 'orcamento_vinculado_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['comercial.Orcamento'], null=True))

    def backwards(self, orm):

        # Changing field 'PropostaComercial.orcamento_vinculado'
        db.alter_column(u'comercial_propostacomercial', 'orcamento_vinculado_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['comercial.Orcamento']))
