...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContratoFechado.valor_entrada'
        db.add_column(u'comercial_contratofechado', 'valor_entrada',
                      self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=10, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContratoFechado.valor_entrada'
        db.delete_column(u'comercial_contratofechado', 'valor_entrada')
    ...
    models = {
        ...
        u'comercial.contratofechado': {
            ...
            'valor_entrada': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '2'})
        },
        ...
        u'comercial.propostacomercial': {
            ...
            'cliente': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cadastro.Cliente']", 'null': 'True', 'blank': 'True'}),
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'data_expiracao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 10, 0, 0)'}),
