...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PropostaComercial.adicionado_por'
        db.alter_column(u'comercial_propostacomercial', 'adicionado_por_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'PerfilAcessoComercial.user'
        db.alter_column(u'comercial_perfilacessocomercial', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))

    def backwards(self, orm):

        # Changing field 'PropostaComercial.adicionado_por'
        db.alter_column(u'comercial_propostacomercial', 'adicionado_por_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['account.User']))

        # Changing field 'PerfilAcessoComercial.user'
        db.alter_column(u'comercial_perfilacessocomercial', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['account.User'], unique=True))
