...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RequisicaoDeProposta.descricao'
        db.add_column(u'comercial_requisicaodeproposta', 'descricao',
                      self.gf('django.db.models.fields.TextField')(default='ra'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RequisicaoDeProposta.descricao'
        db.delete_column(u'comercial_requisicaodeproposta', 'descricao')
