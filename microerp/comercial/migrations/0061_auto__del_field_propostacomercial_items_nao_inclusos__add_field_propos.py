...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PropostaComercial.items_nao_inclusos'
        db.delete_column(u'comercial_propostacomercial', 'items_nao_inclusos')

        # Adding field 'PropostaComercial.items_nao_incluso'
        db.add_column(u'comercial_propostacomercial', 'items_nao_incluso',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PropostaComercial.items_nao_inclusos'
        db.add_column(u'comercial_propostacomercial', 'items_nao_inclusos',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Deleting field 'PropostaComercial.items_nao_incluso'
        db.delete_column(u'comercial_propostacomercial', 'items_nao_incluso')
    ...
    models = {
        ...
        u'comercial.contratofechado': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio_cobranca': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 5, 0, 0)'}),
        ...
        u'comercial.followupdepropostacomercial': {
            ...
            'data_expiracao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 12, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'rh.funcionario': {
            ...
            'escolaridade_conclusao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 5, 0, 0)', 'null': 'True', 'blank': 'True'}),
            ...
            'ultima_checagem_endereco': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 5, 0, 0)'}),
        ...
        u'rh.periodotrabalhado': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 5, 0, 0)'})
        },
        u'rh.procedimento': {
