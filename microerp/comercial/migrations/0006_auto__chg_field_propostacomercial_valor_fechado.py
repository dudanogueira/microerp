...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PropostaComercial.valor_fechado'
        db.alter_column(u'comercial_propostacomercial', 'valor_fechado', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'PropostaComercial.valor_fechado'
        db.alter_column(u'comercial_propostacomercial', 'valor_fechado', self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=10, decimal_places=2))
