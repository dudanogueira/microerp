...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContratoFechado.texto_contratante'
        db.add_column(u'comercial_contratofechado', 'texto_contratante',
                      self.gf('django.db.models.fields.TextField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContratoFechado.texto_contratante'
        db.delete_column(u'comercial_contratofechado', 'texto_contratante')
    ...
    models = {
        ...
        u'comercial.contratofechado': {
            ...
            'texto_contratante': ('django.db.models.fields.TextField', [], {}),
