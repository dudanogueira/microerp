...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RequisicaoDeProposta.proposta_vinculada'
        db.add_column(u'comercial_requisicaodeproposta', 'proposta_vinculada',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['comercial.PropostaComercial'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RequisicaoDeProposta.proposta_vinculada'
        db.delete_column(u'comercial_requisicaodeproposta', 'proposta_vinculada_id')
