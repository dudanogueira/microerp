...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Orcamento.custo_maximo_promocao'
        db.add_column(u'comercial_orcamento', 'custo_maximo_promocao',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2),
                      keep_default=False)

        # Adding field 'Orcamento.custo_minimo_promocao'
        db.add_column(u'comercial_orcamento', 'custo_minimo_promocao',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Orcamento.custo_maximo_promocao'
        db.delete_column(u'comercial_orcamento', 'custo_maximo_promocao')

        # Deleting field 'Orcamento.custo_minimo_promocao'
        db.delete_column(u'comercial_orcamento', 'custo_minimo_promocao')
    ...
    models = {
        ...
        u'comercial.contratofechado': {
            ...
            'efetivo_inicio_execucao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 26, 0, 0)'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio_cobranca': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 26, 0, 0)'}),
            ...
            'previsao_inicio_execucao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 26, 0, 0)'}),
        ...
        u'comercial.followupdepropostacomercial': {
            ...
            'data_expiracao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 6, 2, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'comercial.orcamento': {
            ...
            'fim_promocao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 26, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio_promocao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 26, 0, 0)', 'null': 'True', 'blank': 'True'}),
