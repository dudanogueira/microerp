...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContratoFechado.nome_proposto_legal'
        db.add_column(u'comercial_contratofechado', 'nome_proposto_legal',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'ContratoFechado.documento_proposto_legal'
        db.add_column(u'comercial_contratofechado', 'documento_proposto_legal',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContratoFechado.nome_proposto_legal'
        db.delete_column(u'comercial_contratofechado', 'nome_proposto_legal')

        # Deleting field 'ContratoFechado.documento_proposto_legal'
        db.delete_column(u'comercial_contratofechado', 'documento_proposto_legal')
    ...
    models = {
        ...
        u'comercial.contratofechado': {
            ...
            'efetivo_inicio_execucao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 21, 0, 0)'}),
            ...
            'funcionarios_participantes': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'projetos_participado'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['rh.Funcionario']"}),
            'garantia': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio_cobranca': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 21, 0, 0)'}),
            ...
            'previsao_inicio_execucao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 21, 0, 0)'}),
        ...
        u'comercial.followupdepropostacomercial': {
            ...
            'data_expiracao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 28, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'rh.funcionario': {
            ...
            'escolaridade_conclusao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 21, 0, 0)', 'null': 'True', 'blank': 'True'}),
            ...
            'ultima_checagem_endereco': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 21, 0, 0)'}),
        ...
        u'rh.periodotrabalhado': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 21, 0, 0)'})
        },
        u'rh.procedimento': {
