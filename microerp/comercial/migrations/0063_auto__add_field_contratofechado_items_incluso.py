...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContratoFechado.items_incluso'
        db.add_column(u'comercial_contratofechado', 'items_incluso',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContratoFechado.items_incluso'
        db.delete_column(u'comercial_contratofechado', 'items_incluso')
