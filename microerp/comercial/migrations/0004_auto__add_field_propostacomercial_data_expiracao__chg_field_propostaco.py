...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PropostaComercial.data_expiracao'
        db.add_column(u'comercial_propostacomercial', 'data_expiracao',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 6, 11, 0, 0)),
                      keep_default=False)


        # Changing field 'PropostaComercial.follow_up'
        db.alter_column(u'comercial_propostacomercial', 'follow_up', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):
        # Deleting field 'PropostaComercial.data_expiracao'
        db.delete_column(u'comercial_propostacomercial', 'data_expiracao')


        # Changing field 'PropostaComercial.follow_up'
        db.alter_column(u'comercial_propostacomercial', 'follow_up', self.gf('django.db.models.fields.DateTimeField')())
