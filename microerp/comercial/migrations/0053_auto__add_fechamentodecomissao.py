...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FechamentoDeComissao'
        db.create_table(u'comercial_fechamentodecomissao', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('comissionado', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='fechamento_comissao__set', null=True, to=orm['rh.Funcionario'])),
            ...
            ('criado_por', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='fechamento_comissao_criado_set', null=True, to=orm['rh.Funcionario'])),
        ))
        db.send_create_signal(u'comercial', ['FechamentoDeComissao'])


    def backwards(self, orm):
        # Deleting model 'FechamentoDeComissao'
        db.delete_table(u'comercial_fechamentodecomissao')
