...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SolicitacaoComercial.data_finalizado'
        db.add_column('comercial_solicitacaocomercial', 'data_finalizado',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'SolicitacaoComercial.data_convertido'
        db.alter_column('comercial_solicitacaocomercial', 'data_convertido', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):
        # Deleting field 'SolicitacaoComercial.data_finalizado'
        db.delete_column('comercial_solicitacaocomercial', 'data_finalizado')


        # Changing field 'SolicitacaoComercial.data_convertido'
        db.alter_column('comercial_solicitacaocomercial', 'data_convertido', self.gf('django.db.models.fields.DateField')())
