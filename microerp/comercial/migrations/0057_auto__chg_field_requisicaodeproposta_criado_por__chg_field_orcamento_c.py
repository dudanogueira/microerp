...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RequisicaoDeProposta.criado_por'
        db.alter_column(u'comercial_requisicaodeproposta', 'criado_por_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rh.Funcionario']))

        # Changing field 'Orcamento.criado_por'
        db.alter_column(u'comercial_orcamento', 'criado_por_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rh.Funcionario']))

        # Changing field 'FollowUpDePropostaComercial.criado_por'
        db.alter_column(u'comercial_followupdepropostacomercial', 'criado_por_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rh.Funcionario']))

        # Changing field 'PropostaComercial.criado_por'
        db.alter_column(u'comercial_propostacomercial', 'criado_por_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rh.Funcionario']))

    def backwards(self, orm):

        # Changing field 'RequisicaoDeProposta.criado_por'
        db.alter_column(u'comercial_requisicaodeproposta', 'criado_por_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Orcamento.criado_por'
        db.alter_column(u'comercial_orcamento', 'criado_por_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'FollowUpDePropostaComercial.criado_por'
        db.alter_column(u'comercial_followupdepropostacomercial', 'criado_por_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'PropostaComercial.criado_por'
        db.alter_column(u'comercial_propostacomercial', 'criado_por_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))
    ...
    models = {
        ...
        u'comercial.followupdepropostacomercial': {
            ...
            'data_expiracao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 25, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
