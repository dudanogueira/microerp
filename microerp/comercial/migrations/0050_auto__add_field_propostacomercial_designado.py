...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PropostaComercial.designado'
        db.add_column(u'comercial_propostacomercial', 'designado',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rh.Funcionario'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PropostaComercial.designado'
        db.delete_column(u'comercial_propostacomercial', 'designado_id')
