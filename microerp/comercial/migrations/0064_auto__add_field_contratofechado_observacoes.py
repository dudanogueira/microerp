...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContratoFechado.observacoes'
        db.add_column(u'comercial_contratofechado', 'observacoes',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContratoFechado.observacoes'
        db.delete_column(u'comercial_contratofechado', 'observacoes')
