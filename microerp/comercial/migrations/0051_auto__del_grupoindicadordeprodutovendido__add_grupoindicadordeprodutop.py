...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'GrupoIndicadorDeProdutoVendido'
        db.delete_table(u'comercial_grupoindicadordeprodutovendido')

        # Adding model 'GrupoIndicadorDeProdutoProposto'
        db.create_table(u'comercial_grupoindicadordeprodutoproposto', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nome', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
        ))
        db.send_create_signal(u'comercial', ['GrupoIndicadorDeProdutoProposto'])


    def backwards(self, orm):
        # Adding model 'GrupoIndicadorDeProdutoVendido'
        db.create_table(u'comercial_grupoindicadordeprodutovendido', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nome', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
        ))
        db.send_create_signal(u'comercial', ['GrupoIndicadorDeProdutoVendido'])

        # Deleting model 'GrupoIndicadorDeProdutoProposto'
        db.delete_table(u'comercial_grupoindicadordeprodutoproposto')
    ...
    models = {
        ...
        u'comercial.contratofechado': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio_cobranca': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 15, 0, 0)'}),
        ...
        u'comercial.followupdepropostacomercial': {
            ...
            'data_expiracao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 22, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'rh.funcionario': {
            ...
            'escolaridade_conclusao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 15, 0, 0)', 'null': 'True', 'blank': 'True'}),
            ...
            'ultima_checagem_endereco': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 15, 0, 0)'}),
        ...
        u'rh.periodotrabalhado': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 15, 0, 0)'})
        },
        u'rh.procedimento': {
