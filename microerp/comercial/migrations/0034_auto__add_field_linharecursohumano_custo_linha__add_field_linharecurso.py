...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Orcamento.custo_total'
        db.add_column(u'comercial_orcamento', 'custo_total',
                      self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=10, decimal_places=2),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Orcamento.custo_total'
        db.delete_column(u'comercial_orcamento', 'custo_total')
