...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TipodeContratoFechado'
        db.create_table(u'comercial_tipodecontratofechado', (
        ...
        db.send_create_signal(u'comercial', ['TipodeContratoFechado'])


    def backwards(self, orm):
        # Deleting model 'TipodeContratoFechado'
        db.delete_table(u'comercial_tipodecontratofechado')
