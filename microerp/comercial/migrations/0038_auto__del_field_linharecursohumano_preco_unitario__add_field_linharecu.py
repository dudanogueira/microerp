...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LinhaRecursoHumano.custo_unitario'
        db.add_column(u'comercial_linharecursohumano', 'custo_unitario',
                      self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=10, decimal_places=2, blank=True),
                      keep_default=False)


        # Changing field 'LinhaRecursoMaterial.custo_unitario'
        db.alter_column(u'comercial_linharecursomaterial', 'custo_unitario', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

        # Changing field 'LinhaRecursoMaterial.custo_total'
        db.alter_column(u'comercial_linharecursomaterial', 'custo_total', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'LinhaRecursoHumano.custo_unitario'
        db.delete_column(u'comercial_linharecursohumano', 'custo_unitario')


        # Changing field 'LinhaRecursoMaterial.custo_unitario'
        db.alter_column(u'comercial_linharecursomaterial', 'custo_unitario', self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=10, decimal_places=2))

        # Changing field 'LinhaRecursoMaterial.custo_total'
        db.alter_column(u'comercial_linharecursomaterial', 'custo_total', self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=10, decimal_places=2))
