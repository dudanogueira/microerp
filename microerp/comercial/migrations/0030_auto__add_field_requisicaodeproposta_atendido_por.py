...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RequisicaoDeProposta.atendido_por'
        db.add_column(u'comercial_requisicaodeproposta', 'atendido_por',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='requisicao_proposta_atendida', null=True, to=orm['rh.Funcionario']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RequisicaoDeProposta.atendido_por'
        db.delete_column(u'comercial_requisicaodeproposta', 'atendido_por_id')
