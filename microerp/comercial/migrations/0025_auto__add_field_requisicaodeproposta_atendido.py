...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RequisicaoDeProposta.atendido'
        db.add_column(u'comercial_requisicaodeproposta', 'atendido',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RequisicaoDeProposta.atendido'
        db.delete_column(u'comercial_requisicaodeproposta', 'atendido')
