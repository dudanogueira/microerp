...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FonteDeAgendaComercial.funcionario'
        db.add_column('comercial_fontedeagendacomercial', 'funcionario',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rh.Funcionario'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FonteDeAgendaComercial.funcionario'
        db.delete_column('comercial_fontedeagendacomercial', 'funcionario_id')
