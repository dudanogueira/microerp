...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TipoDeProposta'
        db.create_table(u'comercial_tipodeproposta', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nome', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
        ))
        db.send_create_signal(u'comercial', ['TipoDeProposta'])

        # Adding field 'PropostaComercial.tipo'
        db.add_column(u'comercial_propostacomercial', 'tipo',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['comercial.TipoDeProposta'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'TipoDeProposta'
        db.delete_table(u'comercial_tipodeproposta')

        # Deleting field 'PropostaComercial.tipo'
        db.delete_column(u'comercial_propostacomercial', 'tipo_id')
    ...
    models = {
        ...
        u'comercial.contratofechado': {
            ...
            'efetivo_inicio_execucao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 16, 0, 0)'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio_cobranca': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 16, 0, 0)'}),
            ...
            'previsao_inicio_execucao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 16, 0, 0)'}),
        ...
        u'comercial.followupdepropostacomercial': {
            ...
            'data_expiracao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 23, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'rh.funcionario': {
            ...
            'escolaridade_conclusao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 16, 0, 0)', 'null': 'True', 'blank': 'True'}),
            ...
            'ultima_checagem_endereco': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 16, 0, 0)'}),
        ...
        u'rh.periodotrabalhado': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 16, 0, 0)'})
        },
        u'rh.procedimento': {
