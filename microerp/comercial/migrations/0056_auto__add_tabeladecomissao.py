...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TabelaDeComissao'
        db.create_table(u'comercial_tabeladecomissao', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('valor_inicio', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2)),
            ('valor_fim', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2)),
            ('porcentagem', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2)),
        ))
        db.send_create_signal(u'comercial', ['TabelaDeComissao'])


    def backwards(self, orm):
        # Deleting model 'TabelaDeComissao'
        db.delete_table(u'comercial_tabeladecomissao')
