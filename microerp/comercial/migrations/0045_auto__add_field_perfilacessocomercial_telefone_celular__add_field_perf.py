...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PerfilAcessoComercial.telefone_celular'
        db.add_column(u'comercial_perfilacessocomercial', 'telefone_celular',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'PerfilAcessoComercial.telefone_fixo'
        db.add_column(u'comercial_perfilacessocomercial', 'telefone_fixo',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PerfilAcessoComercial.telefone_celular'
        db.delete_column(u'comercial_perfilacessocomercial', 'telefone_celular')

        # Deleting field 'PerfilAcessoComercial.telefone_fixo'
        db.delete_column(u'comercial_perfilacessocomercial', 'telefone_fixo')
