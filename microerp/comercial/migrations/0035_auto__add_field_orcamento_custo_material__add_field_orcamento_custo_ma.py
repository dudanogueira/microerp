...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Orcamento.custo_material'
        db.add_column(u'comercial_orcamento', 'custo_material',
                      self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=10, decimal_places=2),
                      keep_default=False)

        # Adding field 'Orcamento.custo_mao_de_obra'
        db.add_column(u'comercial_orcamento', 'custo_mao_de_obra',
                      self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=10, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Orcamento.custo_material'
        db.delete_column(u'comercial_orcamento', 'custo_material')

        # Deleting field 'Orcamento.custo_mao_de_obra'
        db.delete_column(u'comercial_orcamento', 'custo_mao_de_obra')
