...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContatoComercial.o_dia_todo'
        db.add_column('comercial_contatocomercial', 'o_dia_todo',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContatoComercial.o_dia_todo'
        db.delete_column('comercial_contatocomercial', 'o_dia_todo')
    ...
    models = {
        ...
        'rh.funcionario': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nascimento': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 11, 9, 0, 0)'}),
