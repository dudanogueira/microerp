...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContratoFechado.status_execucao'
        db.add_column(u'comercial_contratofechado', 'status_execucao',
                      self.gf('django.db.models.fields.CharField')(default='naoiniciado', max_length=100),
                      keep_default=False)

        # Adding field 'ContratoFechado.porcentagem_execucao'
        db.add_column(u'comercial_contratofechado', 'porcentagem_execucao',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=3, decimal_places=0),
                      keep_default=False)

        # Adding field 'ContratoFechado.termo_de_entrega_recebido'
        db.add_column(u'comercial_contratofechado', 'termo_de_entrega_recebido',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ContratoFechado.numero_termo_de_entrega'
        db.add_column(u'comercial_contratofechado', 'numero_termo_de_entrega',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'ContratoFechado.aguardando_cliente'
        db.add_column(u'comercial_contratofechado', 'aguardando_cliente',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'ContratoFechado.data_aguardando_cliente'
        db.add_column(u'comercial_contratofechado', 'data_aguardando_cliente',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ContratoFechado.data_marcado_emandamento'
        db.add_column(u'comercial_contratofechado', 'data_marcado_emandamento',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ContratoFechado.data_marcado_pendente'
        db.add_column(u'comercial_contratofechado', 'data_marcado_pendente',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ContratoFechado.data_marcado_finalizado'
        db.add_column(u'comercial_contratofechado', 'data_marcado_finalizado',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ContratoFechado.previsao_inicio_execucao'
        db.add_column(u'comercial_contratofechado', 'previsao_inicio_execucao',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 2, 11, 0, 0)),
                      keep_default=False)

        # Adding field 'ContratoFechado.previsao_termino_execucao'
        db.add_column(u'comercial_contratofechado', 'previsao_termino_execucao',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ContratoFechado.efetivo_inicio_execucao'
        db.add_column(u'comercial_contratofechado', 'efetivo_inicio_execucao',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 2, 11, 0, 0)),
                      keep_default=False)

        # Adding field 'ContratoFechado.efetivo_termino_execucao'
        db.add_column(u'comercial_contratofechado', 'efetivo_termino_execucao',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding M2M table for field funcionarios_participantes on 'ContratoFechado'
        db.create_table(u'comercial_contratofechado_funcionarios_participantes', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('contratofechado', models.ForeignKey(orm[u'comercial.contratofechado'], null=False)),
            ('funcionario', models.ForeignKey(orm[u'rh.funcionario'], null=False))
        ))
        db.create_unique(u'comercial_contratofechado_funcionarios_participantes', ['contratofechado_id', 'funcionario_id'])


    def backwards(self, orm):
        # Deleting field 'ContratoFechado.status_execucao'
        db.delete_column(u'comercial_contratofechado', 'status_execucao')

        # Deleting field 'ContratoFechado.porcentagem_execucao'
        db.delete_column(u'comercial_contratofechado', 'porcentagem_execucao')

        # Deleting field 'ContratoFechado.termo_de_entrega_recebido'
        db.delete_column(u'comercial_contratofechado', 'termo_de_entrega_recebido')

        # Deleting field 'ContratoFechado.numero_termo_de_entrega'
        db.delete_column(u'comercial_contratofechado', 'numero_termo_de_entrega')

        # Deleting field 'ContratoFechado.aguardando_cliente'
        db.delete_column(u'comercial_contratofechado', 'aguardando_cliente')

        # Deleting field 'ContratoFechado.data_aguardando_cliente'
        db.delete_column(u'comercial_contratofechado', 'data_aguardando_cliente')

        # Deleting field 'ContratoFechado.data_marcado_emandamento'
        db.delete_column(u'comercial_contratofechado', 'data_marcado_emandamento')

        # Deleting field 'ContratoFechado.data_marcado_pendente'
        db.delete_column(u'comercial_contratofechado', 'data_marcado_pendente')

        # Deleting field 'ContratoFechado.data_marcado_finalizado'
        db.delete_column(u'comercial_contratofechado', 'data_marcado_finalizado')

        # Deleting field 'ContratoFechado.previsao_inicio_execucao'
        db.delete_column(u'comercial_contratofechado', 'previsao_inicio_execucao')

        # Deleting field 'ContratoFechado.previsao_termino_execucao'
        db.delete_column(u'comercial_contratofechado', 'previsao_termino_execucao')

        # Deleting field 'ContratoFechado.efetivo_inicio_execucao'
        db.delete_column(u'comercial_contratofechado', 'efetivo_inicio_execucao')

        # Deleting field 'ContratoFechado.efetivo_termino_execucao'
        db.delete_column(u'comercial_contratofechado', 'efetivo_termino_execucao')

        # Removing M2M table for field funcionarios_participantes on 'ContratoFechado'
        db.delete_table('comercial_contratofechado_funcionarios_participantes')
    ...
    models = {
        ...
        u'comercial.contratofechado': {
            ...
            'aguardando_cliente': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'atualizado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
            ...
            'efetivo_inicio_execucao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 11, 0, 0)'}),
            ...
            'funcionarios_participantes': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'projetos_participado'", 'symmetrical': 'False', 'to': u"orm['rh.Funcionario']"}),
            'garantia': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio_cobranca': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 11, 0, 0)'}),
            ...
            'previsao_inicio_execucao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 11, 0, 0)'}),
        ...
        u'comercial.followupdepropostacomercial': {
            ...
            'data_expiracao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 18, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'rh.funcionario': {
            ...
            'escolaridade_conclusao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 11, 0, 0)', 'null': 'True', 'blank': 'True'}),
            ...
            'ultima_checagem_endereco': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 11, 0, 0)'}),
        ...
        u'rh.periodotrabalhado': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 11, 0, 0)'})
        },
        u'rh.procedimento': {
