...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CategoriaContratoFechado'
        db.create_table(u'comercial_categoriacontratofechado', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nome', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
        ))
        db.send_create_signal(u'comercial', ['CategoriaContratoFechado'])

        # Adding field 'ContratoFechado.categoria'
        db.add_column(u'comercial_contratofechado', 'categoria',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['comercial.CategoriaContratoFechado']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'CategoriaContratoFechado'
        db.delete_table(u'comercial_categoriacontratofechado')

        # Deleting field 'ContratoFechado.categoria'
        db.delete_column(u'comercial_contratofechado', 'categoria_id')
    ...
    models = {
        ...
        u'comercial.propostacomercial': {
            ...
            'cliente': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cadastro.Cliente']", 'null': 'True', 'blank': 'True'}),
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'data_expiracao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 1, 0, 0)'}),
