...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Orcamento.tabelado'
        db.add_column(u'comercial_orcamento', 'tabelado',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Orcamento.tabelado'
        db.delete_column(u'comercial_orcamento', 'tabelado')
