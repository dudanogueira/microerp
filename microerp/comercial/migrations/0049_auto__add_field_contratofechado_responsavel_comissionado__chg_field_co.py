...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContratoFechado.responsavel_comissionado'
        db.add_column(u'comercial_contratofechado', 'responsavel_comissionado',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='contrato_comissionado_set', null=True, to=orm['rh.Funcionario']),
                      keep_default=False)


        # Changing field 'ContratoFechado.categoria'
        db.alter_column(u'comercial_contratofechado', 'categoria_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['comercial.CategoriaContratoFechado'], null=True))

    def backwards(self, orm):
        # Deleting field 'ContratoFechado.responsavel_comissionado'
        db.delete_column(u'comercial_contratofechado', 'responsavel_comissionado_id')


        # Changing field 'ContratoFechado.categoria'
        db.alter_column(u'comercial_contratofechado', 'categoria_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['comercial.CategoriaContratoFechado']))
