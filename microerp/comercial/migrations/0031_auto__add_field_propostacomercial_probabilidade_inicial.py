...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PropostaComercial.probabilidade_inicial'
        db.add_column(u'comercial_propostacomercial', 'probabilidade_inicial',
                      self.gf('django.db.models.fields.IntegerField')(default=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PropostaComercial.probabilidade_inicial'
        db.delete_column(u'comercial_propostacomercial', 'probabilidade_inicial')
