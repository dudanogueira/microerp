...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('comercial_fontedeagendacomercial', (
        ...
        db.send_create_signal('comercial', ['FonteDeAgendaComercial'])

        # Deleting field 'ContatoComercial.tipo'
        db.delete_column('comercial_contatocomercial', 'tipo_id')

        # Adding field 'ContatoComercial.id_referencia'
        db.add_column('comercial_contatocomercial', 'id_referencia',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'ContatoComercial.agenda_fonte'
        db.add_column('comercial_contatocomercial', 'agenda_fonte',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['comercial.FonteDeAgendaComercial'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'ContatoComercial.cliente'
        db.alter_column('comercial_contatocomercial', 'cliente_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cadastro.Cliente'], null=True))

    def backwards(self, orm):
        # Deleting model 'FonteDeAgendaComercial'
        db.delete_table('comercial_fontedeagendacomercial')

        # Adding field 'ContatoComercial.tipo'
        db.add_column('comercial_contatocomercial', 'tipo',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['comercial.TipoContatoComercial']),
                      keep_default=False)

        # Deleting field 'ContatoComercial.id_referencia'
        db.delete_column('comercial_contatocomercial', 'id_referencia')

        # Deleting field 'ContatoComercial.agenda_fonte'
        db.delete_column('comercial_contatocomercial', 'agenda_fonte_id')


        # Changing field 'ContatoComercial.cliente'
        db.alter_column('comercial_contatocomercial', 'cliente_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['cadastro.Cliente']))
