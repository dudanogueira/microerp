...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ContratoFechado'
        db.create_table(u'comercial_contratofechado', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cliente', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cadastro.Cliente'])),
            ('forma_pagamento', self.gf('django.db.models.fields.CharField')(default='dinheiro', max_length=100)),
            ('parcelas', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('inicio_cobranca', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 7, 12, 0, 0))),
            ('valor', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2)),
            ('receber_apos_conclusao', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('tipo', self.gf('django.db.models.fields.CharField')(default='fechado', max_length=100)),
            ('status', self.gf('django.db.models.fields.CharField')(default='emaberto', max_length=100)),
            ('concluido', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'comercial', ['ContratoFechado'])


    def backwards(self, orm):
        # Deleting model 'ContratoFechado'
        db.delete_table(u'comercial_contratofechado')
