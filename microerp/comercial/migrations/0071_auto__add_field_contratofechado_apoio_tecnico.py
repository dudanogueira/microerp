...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContratoFechado.apoio_tecnico'
        db.add_column(u'comercial_contratofechado', 'apoio_tecnico',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='contratos_apoio_tecnico', null=True, to=orm['rh.Funcionario']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContratoFechado.apoio_tecnico'
        db.delete_column(u'comercial_contratofechado', 'apoio_tecnico_id')
