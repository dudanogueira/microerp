...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LinhaRecursoHumano.criado'
        db.add_column(u'comercial_linharecursohumano', 'criado',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'LinhaRecursoHumano.atualizado'
        db.add_column(u'comercial_linharecursohumano', 'atualizado',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True),
                      keep_default=False)

        # Adding field 'ContratoFechado.responsavel'
        db.add_column(u'comercial_contratofechado', 'responsavel',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['rh.Funcionario']),
                      keep_default=False)

        # Adding field 'ContratoFechado.criado'
        db.add_column(u'comercial_contratofechado', 'criado',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'ContratoFechado.atualizado'
        db.add_column(u'comercial_contratofechado', 'atualizado',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True),
                      keep_default=False)

        # Adding field 'LinhaRecursoMaterial.criado'
        db.add_column(u'comercial_linharecursomaterial', 'criado',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'LinhaRecursoMaterial.atualizado'
        db.add_column(u'comercial_linharecursomaterial', 'atualizado',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LinhaRecursoHumano.criado'
        db.delete_column(u'comercial_linharecursohumano', 'criado')

        # Deleting field 'LinhaRecursoHumano.atualizado'
        db.delete_column(u'comercial_linharecursohumano', 'atualizado')

        # Deleting field 'ContratoFechado.responsavel'
        db.delete_column(u'comercial_contratofechado', 'responsavel_id')

        # Deleting field 'ContratoFechado.criado'
        db.delete_column(u'comercial_contratofechado', 'criado')

        # Deleting field 'ContratoFechado.atualizado'
        db.delete_column(u'comercial_contratofechado', 'atualizado')

        # Deleting field 'LinhaRecursoMaterial.criado'
        db.delete_column(u'comercial_linharecursomaterial', 'criado')

        # Deleting field 'LinhaRecursoMaterial.atualizado'
        db.delete_column(u'comercial_linharecursomaterial', 'atualizado')
    ...
    models = {
        ...
        u'comercial.contratofechado': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio_cobranca': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 7, 12, 0, 0)'}),
        ...
        u'comercial.propostacomercial': {
            ...
            'cliente': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cadastro.Cliente']", 'null': 'True', 'blank': 'True'}),
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'data_expiracao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 7, 27, 0, 0)'}),
