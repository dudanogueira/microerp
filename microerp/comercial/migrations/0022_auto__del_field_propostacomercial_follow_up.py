...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PropostaComercial.follow_up'
        db.delete_column(u'comercial_propostacomercial', 'follow_up')


    def backwards(self, orm):
        # Adding field 'PropostaComercial.follow_up'
        db.add_column(u'comercial_propostacomercial', 'follow_up',
