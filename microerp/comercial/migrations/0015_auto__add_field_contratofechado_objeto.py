...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContratoFechado.objeto'
        db.add_column(u'comercial_contratofechado', 'objeto',
                      self.gf('django.db.models.fields.TextField')(default='objeto'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContratoFechado.objeto'
        db.delete_column(u'comercial_contratofechado', 'objeto')
    ...
    models = {
        ...
        u'comercial.propostacomercial': {
            ...
            'cliente': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cadastro.Cliente']", 'null': 'True', 'blank': 'True'}),
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'data_expiracao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 28, 0, 0)'}),
