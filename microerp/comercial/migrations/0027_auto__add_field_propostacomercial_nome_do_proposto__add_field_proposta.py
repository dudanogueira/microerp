...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PropostaComercial.nome_do_proposto'
        db.add_column(u'comercial_propostacomercial', 'nome_do_proposto',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'PropostaComercial.documento_do_proposto'
        db.add_column(u'comercial_propostacomercial', 'documento_do_proposto',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'PropostaComercial.rua_do_proposto'
        db.add_column(u'comercial_propostacomercial', 'rua_do_proposto',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'PropostaComercial.bairro_do_proposto'
        db.add_column(u'comercial_propostacomercial', 'bairro_do_proposto',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'PropostaComercial.cep_do_proposto'
        db.add_column(u'comercial_propostacomercial', 'cep_do_proposto',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'PropostaComercial.cidade_do_proposto'
        db.add_column(u'comercial_propostacomercial', 'cidade_do_proposto',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'PropostaComercial.endereco_obra_proposto'
        db.add_column(u'comercial_propostacomercial', 'endereco_obra_proposto',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'PropostaComercial.representante_legal_proposto'
        db.add_column(u'comercial_propostacomercial', 'representante_legal_proposto',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'PropostaComercial.telefone_contato_proposto'
        db.add_column(u'comercial_propostacomercial', 'telefone_contato_proposto',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'PropostaComercial.email_proposto'
        db.add_column(u'comercial_propostacomercial', 'email_proposto',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'PropostaComercial.objeto_proposto'
        db.add_column(u'comercial_propostacomercial', 'objeto_proposto',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'PropostaComercial.descricao_items_proposto'
        db.add_column(u'comercial_propostacomercial', 'descricao_items_proposto',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'PropostaComercial.forma_pagamento_proposto'
        db.add_column(u'comercial_propostacomercial', 'forma_pagamento_proposto',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PropostaComercial.nome_do_proposto'
        db.delete_column(u'comercial_propostacomercial', 'nome_do_proposto')

        # Deleting field 'PropostaComercial.documento_do_proposto'
        db.delete_column(u'comercial_propostacomercial', 'documento_do_proposto')

        # Deleting field 'PropostaComercial.rua_do_proposto'
        db.delete_column(u'comercial_propostacomercial', 'rua_do_proposto')

        # Deleting field 'PropostaComercial.bairro_do_proposto'
        db.delete_column(u'comercial_propostacomercial', 'bairro_do_proposto')

        # Deleting field 'PropostaComercial.cep_do_proposto'
        db.delete_column(u'comercial_propostacomercial', 'cep_do_proposto')

        # Deleting field 'PropostaComercial.cidade_do_proposto'
        db.delete_column(u'comercial_propostacomercial', 'cidade_do_proposto')

        # Deleting field 'PropostaComercial.endereco_obra_proposto'
        db.delete_column(u'comercial_propostacomercial', 'endereco_obra_proposto')

        # Deleting field 'PropostaComercial.representante_legal_proposto'
        db.delete_column(u'comercial_propostacomercial', 'representante_legal_proposto')

        # Deleting field 'PropostaComercial.telefone_contato_proposto'
        db.delete_column(u'comercial_propostacomercial', 'telefone_contato_proposto')

        # Deleting field 'PropostaComercial.email_proposto'
        db.delete_column(u'comercial_propostacomercial', 'email_proposto')

        # Deleting field 'PropostaComercial.objeto_proposto'
        db.delete_column(u'comercial_propostacomercial', 'objeto_proposto')

        # Deleting field 'PropostaComercial.descricao_items_proposto'
        db.delete_column(u'comercial_propostacomercial', 'descricao_items_proposto')

        # Deleting field 'PropostaComercial.forma_pagamento_proposto'
        db.delete_column(u'comercial_propostacomercial', 'forma_pagamento_proposto')
    ...
    models = {
        ...
        u'comercial.contratofechado': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio_cobranca': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 16, 0, 0)'}),
        ...
        u'comercial.followupdepropostacomercial': {
            'Meta': {'ordering': "('-data',)", 'object_name': 'FollowUpDePropostaComercial'},
            'atualizado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'data_expiracao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 23, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'rh.funcionario': {
            ...
            'escolaridade_conclusao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 16, 0, 0)', 'null': 'True', 'blank': 'True'}),
            ...
            'ultima_checagem_endereco': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 16, 0, 0)'}),
        ...
        u'rh.periodotrabalhado': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 16, 0, 0)'})
        },
        u'rh.procedimento': {
