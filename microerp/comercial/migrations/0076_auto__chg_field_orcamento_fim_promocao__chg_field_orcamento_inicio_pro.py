...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Orcamento.fim_promocao'
        db.alter_column(u'comercial_orcamento', 'fim_promocao', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Orcamento.inicio_promocao'
        db.alter_column(u'comercial_orcamento', 'inicio_promocao', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Orcamento.fim_promocao'
        db.alter_column(u'comercial_orcamento', 'fim_promocao', self.gf('django.db.models.fields.DateField')())

        # Changing field 'Orcamento.inicio_promocao'
        db.alter_column(u'comercial_orcamento', 'inicio_promocao', self.gf('django.db.models.fields.DateField')())
    ...
    models = {
        ...
        u'comercial.orcamento': {
            ...
            'fim_promocao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 23, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio_promocao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 23, 0, 0)', 'null': 'True', 'blank': 'True'}),
