...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'QuantidadeDeMarca.quantidade'
        db.alter_column(u'comercial_quantidadedemarca', 'quantidade', self.gf('django.db.models.fields.IntegerField')(default=1))

    def backwards(self, orm):

        # Changing field 'QuantidadeDeMarca.quantidade'
        db.alter_column(u'comercial_quantidadedemarca', 'quantidade', self.gf('django.db.models.fields.IntegerField')(null=True))
