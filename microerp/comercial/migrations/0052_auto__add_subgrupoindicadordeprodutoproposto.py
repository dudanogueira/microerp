...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SubGrupoIndicadorDeProdutoProposto'
        db.create_table(u'comercial_subgrupoindicadordeprodutoproposto', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nome', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('grupo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['comercial.GrupoIndicadorDeProdutoProposto'])),
        ))
        db.send_create_signal(u'comercial', ['SubGrupoIndicadorDeProdutoProposto'])


    def backwards(self, orm):
        # Deleting model 'SubGrupoIndicadorDeProdutoProposto'
        db.delete_table(u'comercial_subgrupoindicadordeprodutoproposto')
