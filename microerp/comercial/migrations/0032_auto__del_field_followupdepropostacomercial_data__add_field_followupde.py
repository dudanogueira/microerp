...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FollowUpDePropostaComercial.data'
        db.delete_column(u'comercial_followupdepropostacomercial', 'data')

        # Adding field 'FollowUpDePropostaComercial.reagenda_data_expiracao'
        db.add_column(u'comercial_followupdepropostacomercial', 'reagenda_data_expiracao',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'FollowUpDePropostaComercial.probabilidade'
        db.add_column(u'comercial_followupdepropostacomercial', 'probabilidade',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'FollowUpDePropostaComercial.data'
        db.add_column(u'comercial_followupdepropostacomercial', 'data',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        # Deleting field 'FollowUpDePropostaComercial.reagenda_data_expiracao'
        db.delete_column(u'comercial_followupdepropostacomercial', 'reagenda_data_expiracao')

        # Deleting field 'FollowUpDePropostaComercial.probabilidade'
        db.delete_column(u'comercial_followupdepropostacomercial', 'probabilidade')
    ...
    models = {
        ...
        u'comercial.contratofechado': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio_cobranca': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 20, 0, 0)'}),
        ...
        u'comercial.followupdepropostacomercial': {
            ...
            'data_expiracao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 27, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'rh.funcionario': {
            ...
            'escolaridade_conclusao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 20, 0, 0)', 'null': 'True', 'blank': 'True'}),
            ...
            'ultima_checagem_endereco': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 20, 0, 0)'}),
        ...
        u'rh.periodotrabalhado': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 20, 0, 0)'})
        },
        u'rh.procedimento': {
