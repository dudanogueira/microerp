...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PropostaComercial.definido_perdido_motivo'
        db.add_column(u'comercial_propostacomercial', 'definido_perdido_motivo',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PropostaComercial.definido_perdido_motivo'
        db.delete_column(u'comercial_propostacomercial', 'definido_perdido_motivo')
