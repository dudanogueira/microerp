...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Orcamento.tabelado_originario'
        db.add_column(u'comercial_orcamento', 'tabelado_originario',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='tabelados_originados', null=True, to=orm['comercial.Orcamento']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Orcamento.tabelado_originario'
        db.delete_column(u'comercial_orcamento', 'tabelado_originario_id')
    ...
    models = {
        ...
        u'comercial.contratofechado': {
            ...
            'efetivo_inicio_execucao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 29, 0, 0)'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio_cobranca': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 29, 0, 0)'}),
            ...
            'previsao_inicio_execucao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 29, 0, 0)'}),
        ...
        u'comercial.followupdepropostacomercial': {
            ...
            'data_expiracao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 6, 5, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'comercial.orcamento': {
            ...
            'fim_promocao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 29, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio_promocao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 29, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        u'rh.funcionario': {
            ...
            'escolaridade_conclusao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 29, 0, 0)', 'null': 'True', 'blank': 'True'}),
            ...
            'ultima_checagem_endereco': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 29, 0, 0)'}),
        ...
        u'rh.periodotrabalhado': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 29, 0, 0)'})
        },
        u'rh.procedimento': {
