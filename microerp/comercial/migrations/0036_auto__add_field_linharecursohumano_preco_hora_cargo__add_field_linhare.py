...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LinhaRecursoMaterial.quantidade'
        db.alter_column(u'comercial_linharecursomaterial', 'quantidade', self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=10, decimal_places=2))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'LinhaRecursoMaterial.quantidade'
        db.alter_column(u'comercial_linharecursomaterial', 'quantidade', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        u'comercial.linharecursohumano': {
            ...
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'custo_linha': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '2'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'orcamento': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['comercial.Orcamento']"}),
            'preco_hora_cargo': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '2'}),
        ...
        u'comercial.linharecursomaterial': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'orcamento': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['comercial.Orcamento']"}),
            'preco_produto': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '2'}),
