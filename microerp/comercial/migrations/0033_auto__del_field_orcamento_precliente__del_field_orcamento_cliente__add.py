...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Orcamento.precliente'
        db.delete_column(u'comercial_orcamento', 'precliente_id')

        # Deleting field 'Orcamento.cliente'
        db.delete_column(u'comercial_orcamento', 'cliente_id')

        # Adding field 'Orcamento.proposta'
        db.add_column(u'comercial_orcamento', 'proposta',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['comercial.PropostaComercial'], blank=True),
                      keep_default=False)

        # Adding field 'Orcamento.selecionado'
        db.add_column(u'comercial_orcamento', 'selecionado',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Orcamento.ativo'
        db.add_column(u'comercial_orcamento', 'ativo',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Orcamento.precliente'
        db.add_column(u'comercial_orcamento', 'precliente',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cadastro.PreCliente'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Orcamento.cliente'
        db.add_column(u'comercial_orcamento', 'cliente',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cadastro.Cliente'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Orcamento.proposta'
        db.delete_column(u'comercial_orcamento', 'proposta_id')

        # Deleting field 'Orcamento.selecionado'
        db.delete_column(u'comercial_orcamento', 'selecionado')

        # Deleting field 'Orcamento.ativo'
        db.delete_column(u'comercial_orcamento', 'ativo')
