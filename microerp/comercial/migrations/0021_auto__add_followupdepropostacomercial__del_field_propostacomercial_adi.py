...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FollowUpDePropostaComercial'
        db.create_table(u'comercial_followupdepropostacomercial', (
            ...
            ('data_expiracao', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 12, 3, 0, 0))),
            ('criador_por', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='followup_adicionado_set', null=True, to=orm['auth.User'])),
        ...
        db.send_create_signal(u'comercial', ['FollowUpDePropostaComercial'])

        # Deleting field 'PropostaComercial.adicionado_por'
        db.delete_column(u'comercial_propostacomercial', 'adicionado_por_id')

        # Adding field 'PropostaComercial.criado_por'
        db.add_column(u'comercial_propostacomercial', 'criado_por',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='proposta_adicionada_set', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'FollowUpDePropostaComercial'
        db.delete_table(u'comercial_followupdepropostacomercial')

        # Adding field 'PropostaComercial.adicionado_por'
        db.add_column(u'comercial_propostacomercial', 'adicionado_por',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='proposta_adicionada_set', null=True, to=orm['auth.User'], blank=True),
                      keep_default=False)

        # Deleting field 'PropostaComercial.criado_por'
        db.delete_column(u'comercial_propostacomercial', 'criado_por_id')
    ...
    models = {
        ...
        u'comercial.contratofechado': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio_cobranca': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 26, 0, 0)'}),
        ...
        u'comercial.followupdepropostacomercial': {
            ...
            'atualizado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'criador_por': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'followup_adicionado_set'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'data': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'data_expiracao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 3, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'comercial.propostacomercial': {
            ...
            'data_expiracao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 11, 0, 0)'}),
        ...
        u'rh.funcionario': {
            ...
            'escolaridade_conclusao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 26, 0, 0)', 'null': 'True', 'blank': 'True'}),
            ...
            'ultima_checagem_endereco': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 26, 0, 0)'}),
        ...
        u'rh.periodotrabalhado': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 26, 0, 0)'})
        },
        u'rh.procedimento': {
