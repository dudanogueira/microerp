...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FollowUpDePropostaComercial.criador_por'
        db.delete_column(u'comercial_followupdepropostacomercial', 'criador_por_id')

        # Adding field 'FollowUpDePropostaComercial.criado_por'
        db.add_column(u'comercial_followupdepropostacomercial', 'criado_por',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='followup_adicionado_set', to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'FollowUpDePropostaComercial.criador_por'
        db.add_column(u'comercial_followupdepropostacomercial', 'criador_por',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='followup_adicionado_set', null=True, to=orm['auth.User'], blank=True),
                      keep_default=False)

        # Deleting field 'FollowUpDePropostaComercial.criado_por'
        db.delete_column(u'comercial_followupdepropostacomercial', 'criado_por_id')
    ...
    models = {
        ...
        u'comercial.contratofechado': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio_cobranca': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 28, 0, 0)'}),
        ...
        u'comercial.followupdepropostacomercial': {
            ...
            'data_expiracao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 5, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'rh.funcionario': {
            ...
            'escolaridade_conclusao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 28, 0, 0)', 'null': 'True', 'blank': 'True'}),
            ...
            'ultima_checagem_endereco': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 28, 0, 0)'}),
        ...
        u'rh.periodotrabalhado': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 28, 0, 0)'})
        },
        u'rh.procedimento': {
