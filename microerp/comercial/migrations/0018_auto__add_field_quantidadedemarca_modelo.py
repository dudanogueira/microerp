...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuantidadeDeMarca.modelo'
        db.add_column(u'comercial_quantidadedemarca', 'modelo',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['comercial.Modelo']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuantidadeDeMarca.modelo'
        db.delete_column(u'comercial_quantidadedemarca', 'modelo_id')
