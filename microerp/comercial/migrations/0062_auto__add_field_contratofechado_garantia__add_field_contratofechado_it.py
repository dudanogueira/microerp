...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContratoFechado.garantia'
        db.add_column(u'comercial_contratofechado', 'garantia',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'ContratoFechado.items_nao_incluso'
        db.add_column(u'comercial_contratofechado', 'items_nao_incluso',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContratoFechado.garantia'
        db.delete_column(u'comercial_contratofechado', 'garantia')

        # Deleting field 'ContratoFechado.items_nao_incluso'
        db.delete_column(u'comercial_contratofechado', 'items_nao_incluso')
