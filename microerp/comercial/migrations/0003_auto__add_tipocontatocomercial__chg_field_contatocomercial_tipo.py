...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'ContatoComercial.tipo' to match new field type.
        db.rename_column('comercial_contatocomercial', 'tipo', 'tipo_id')
        # Changing field 'ContatoComercial.tipo'
        db.alter_column('comercial_contatocomercial', 'tipo_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['comercial.TipoContatoComercial']))
        # Adding index on 'ContatoComercial', fields ['tipo']
        db.create_index('comercial_contatocomercial', ['tipo_id'])


    def backwards(self, orm):
        # Removing index on 'ContatoComercial', fields ['tipo']
        db.delete_index('comercial_contatocomercial', ['tipo_id'])
        ...
        # Renaming column for 'ContatoComercial.tipo' to match new field type.
        db.rename_column('comercial_contatocomercial', 'tipo_id', 'tipo')
        # Changing field 'ContatoComercial.tipo'
        db.alter_column('comercial_contatocomercial', 'tipo', self.gf('django.db.models.fields.CharField')(max_length=100))
