...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RequisicaoDeProposta.atendido_data'
        db.add_column(u'comercial_requisicaodeproposta', 'atendido_data',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RequisicaoDeProposta.atendido_data'
        db.delete_column(u'comercial_requisicaodeproposta', 'atendido_data')
