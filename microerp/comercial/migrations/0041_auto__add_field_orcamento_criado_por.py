...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Orcamento.criado_por'
        db.add_column(u'comercial_orcamento', 'criado_por',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='orcamento_criado_set', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Orcamento.criado_por'
        db.delete_column(u'comercial_orcamento', 'criado_por_id')
