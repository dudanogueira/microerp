...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'financeiro_contabancaria', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nome', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
        ))
        db.send_create_signal(u'financeiro', ['ContaBancaria'])

        # Adding field 'Lancamento.conta'
        db.add_column(u'financeiro_lancamento', 'conta',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['financeiro.ContaBancaria']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ContaBancaria'
        db.delete_table(u'financeiro_contabancaria')

        # Deleting field 'Lancamento.conta'
        db.delete_column(u'financeiro_lancamento', 'conta_id')
