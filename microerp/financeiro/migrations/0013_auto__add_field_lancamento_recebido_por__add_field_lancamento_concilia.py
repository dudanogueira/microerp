...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lancamento.recebido_por'
        db.add_column(u'financeiro_lancamento', 'recebido_por',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='lancamento_recebido_set', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Lancamento.conciliado_por'
        db.add_column(u'financeiro_lancamento', 'conciliado_por',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='lancamento_conciliado_set', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Lancamento.antecipado_por'
        db.add_column(u'financeiro_lancamento', 'antecipado_por',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='lancamento_antecipado_set', to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Lancamento.recebido_por'
        db.delete_column(u'financeiro_lancamento', 'recebido_por_id')

        # Deleting field 'Lancamento.conciliado_por'
        db.delete_column(u'financeiro_lancamento', 'conciliado_por_id')

        # Deleting field 'Lancamento.antecipado_por'
        db.delete_column(u'financeiro_lancamento', 'antecipado_por_id')
    ...
    models = {
        ...
        u'comercial.contratofechado': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio_cobranca': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 1, 0, 0)'}),
        ...
        u'financeiro.lancamento': {
            'Meta': {'ordering': "('data_cobranca',)", 'unique_together': "(('contrato', 'peso'),)", 'object_name': 'Lancamento'},
            'antecipado': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'antecipado_por': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'lancamento_antecipado_set'", 'to': u"orm['auth.User']"}),
            'atualizado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
            'conciliado_por': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'lancamento_conciliado_set'", 'to': u"orm['auth.User']"}),
            'conta': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['financeiro.ContaBancaria']", 'null': 'True', 'blank': 'True'}),
            'contrato': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['comercial.ContratoFechado']"}),
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'data_cobranca': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 1, 0, 0)'}),
            ...
            'recebido_por': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'lancamento_recebido_set'", 'to': u"orm['auth.User']"}),
        ...
        u'rh.funcionario': {
            ...
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
            'escolaridade_conclusao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 1, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        u'rh.periodotrabalhado': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 1, 0, 0)'})
        },
