...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ObservacaoLancamento'
        db.create_table(u'financeiro_observacaolancamento', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('lancamento', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['financeiro.Lancamento'])),
            ('texto', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('criado_por', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ...
        db.send_create_signal(u'financeiro', ['ObservacaoLancamento'])


    def backwards(self, orm):
        # Deleting model 'ObservacaoLancamento'
        db.delete_table(u'financeiro_observacaolancamento')
    ...
    models = {
        ...
        u'comercial.contratofechado': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio_cobranca': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 12, 0, 0)'}),
        ...
        u'financeiro.lancamento': {
            ...
            'data_cobranca': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 12, 0, 0)'}),
        ...
        u'financeiro.observacaolancamento': {
            'Meta': {'object_name': 'ObservacaoLancamento'},
            'atualizado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'rh.funcionario': {
            ...
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
            'escolaridade_conclusao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 12, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        u'rh.periodotrabalhado': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 12, 0, 0)'})
        },
