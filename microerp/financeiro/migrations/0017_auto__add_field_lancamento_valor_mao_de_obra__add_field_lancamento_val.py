...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lancamento.valor_mao_de_obra'
        db.add_column(u'financeiro_lancamento', 'valor_mao_de_obra',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Lancamento.valor_materiais'
        db.add_column(u'financeiro_lancamento', 'valor_materiais',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Lancamento.notas_fiscais'
        db.add_column(u'financeiro_lancamento', 'notas_fiscais',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Lancamento.valor_mao_de_obra'
        db.delete_column(u'financeiro_lancamento', 'valor_mao_de_obra')

        # Deleting field 'Lancamento.valor_materiais'
        db.delete_column(u'financeiro_lancamento', 'valor_materiais')

        # Deleting field 'Lancamento.notas_fiscais'
        db.delete_column(u'financeiro_lancamento', 'notas_fiscais')
    ...
    models = {
        ...
        u'comercial.contratofechado': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio_cobranca': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 13, 0, 0)'}),
        ...
        u'financeiro.lancamento': {
            ...
            'data_cobranca': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 13, 0, 0)'}),
        ...
        u'rh.funcionario': {
            ...
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
            'escolaridade_conclusao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 13, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        u'rh.periodotrabalhado': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 13, 0, 0)'})
        },
