...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lancamento.data_antecipado'
        db.add_column(u'financeiro_lancamento', 'data_antecipado',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Lancamento.data_antecipado'
        db.delete_column(u'financeiro_lancamento', 'data_antecipado')
