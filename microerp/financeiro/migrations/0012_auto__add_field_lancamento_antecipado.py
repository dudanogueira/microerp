...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lancamento.antecipado'
        db.add_column(u'financeiro_lancamento', 'antecipado',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Lancamento.antecipado'
        db.delete_column(u'financeiro_lancamento', 'antecipado')
