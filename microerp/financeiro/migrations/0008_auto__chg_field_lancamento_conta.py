...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Lancamento.conta'
        db.alter_column(u'financeiro_lancamento', 'conta_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['financeiro.ContaBancaria'], null=True))

    def backwards(self, orm):

        # Changing field 'Lancamento.conta'
        db.alter_column(u'financeiro_lancamento', 'conta_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['financeiro.ContaBancaria']))
