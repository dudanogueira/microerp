...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Lancamento.peso'
        db.alter_column(u'financeiro_lancamento', 'peso', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'Lancamento.peso'
        db.alter_column(u'financeiro_lancamento', 'peso', self.gf('django.db.models.fields.CharField')(max_length=100))
