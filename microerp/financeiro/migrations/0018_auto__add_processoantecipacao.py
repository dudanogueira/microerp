...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProcessoAntecipacao'
        db.create_table(u'financeiro_processoantecipacao', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('valor_inicial', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2)),
            ('percentual_abatido', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2)),
            ('valor_abatido', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2)),
            ('atencipado_por', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ...
        db.send_create_signal(u'financeiro', ['ProcessoAntecipacao'])
        ...
        db.create_table(u'financeiro_processoantecipacao_lancamentos', (
            ...
            ('lancamento', models.ForeignKey(orm[u'financeiro.lancamento'], null=False))
        ))
        db.create_unique(u'financeiro_processoantecipacao_lancamentos', ['processoantecipacao_id', 'lancamento_id'])


    def backwards(self, orm):
        # Deleting model 'ProcessoAntecipacao'
        db.delete_table(u'financeiro_processoantecipacao')
    ...
    models = {
        ...
        u'financeiro.lancamento': {
            ...
            'data_cobranca': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 14, 0, 0)'}),
        ...
        u'financeiro.observacaolancamento': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lancamento': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['financeiro.Lancamento']"}),
        ...
        u'financeiro.processoantecipacao': {
            ...
            'atencipado_por': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            'atualizado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lancamentos': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['financeiro.Lancamento']", 'symmetrical': 'False'}),
