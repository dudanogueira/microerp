...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProcessoAntecipacao.antecipado_por'
        db.alter_column(u'financeiro_processoantecipacao', 'antecipado_por_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rh.Funcionario']))

        # Changing field 'LancamentoFinanceiroReceber.recebido_por'
        db.alter_column(u'financeiro_lancamentofinanceiroreceber', 'recebido_por_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rh.Funcionario']))

        # Changing field 'LancamentoFinanceiroReceber.antecipado_por'
        db.alter_column(u'financeiro_lancamentofinanceiroreceber', 'antecipado_por_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rh.Funcionario']))

        # Changing field 'LancamentoFinanceiroReceber.conciliado_por'
        db.alter_column(u'financeiro_lancamentofinanceiroreceber', 'conciliado_por_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rh.Funcionario']))

        # Changing field 'ObservacaoLancamento.criado_por'
        db.alter_column(u'financeiro_observacaolancamento', 'criado_por_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rh.Funcionario']))

    def backwards(self, orm):

        # Changing field 'ProcessoAntecipacao.antecipado_por'
        db.alter_column(u'financeiro_processoantecipacao', 'antecipado_por_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'LancamentoFinanceiroReceber.recebido_por'
        db.alter_column(u'financeiro_lancamentofinanceiroreceber', 'recebido_por_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'LancamentoFinanceiroReceber.antecipado_por'
        db.alter_column(u'financeiro_lancamentofinanceiroreceber', 'antecipado_por_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'LancamentoFinanceiroReceber.conciliado_por'
        db.alter_column(u'financeiro_lancamentofinanceiroreceber', 'conciliado_por_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'ObservacaoLancamento.criado_por'
        db.alter_column(u'financeiro_observacaolancamento', 'criado_por_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
    ...
    models = {
        ...
        u'financeiro.lancamentofinanceiroreceber': {
            ...
            'antecipado_por': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'lancamento_antecipado_set'", 'null': 'True', 'to': u"orm['rh.Funcionario']"}),
            'atualizado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
            'conciliado_por': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'lancamento_conciliado_set'", 'null': 'True', 'to': u"orm['rh.Funcionario']"}),
            ...
            'recebido_por': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'lancamento_recebido_set'", 'null': 'True', 'to': u"orm['rh.Funcionario']"}),
        ...
        u'financeiro.observacaolancamento': {
            ...
            'atualizado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'criado_por': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'observacaolancamento_criado_set'", 'to': u"orm['rh.Funcionario']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'financeiro.processoantecipacao': {
            ...
            'antecipado_por': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'processoantecipacao_criado_set'", 'to': u"orm['rh.Funcionario']"}),
            'atualizado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
