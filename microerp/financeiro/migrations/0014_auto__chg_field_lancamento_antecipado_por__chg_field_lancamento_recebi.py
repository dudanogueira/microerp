...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Lancamento.antecipado_por'
        db.alter_column(u'financeiro_lancamento', 'antecipado_por_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Lancamento.recebido_por'
        db.alter_column(u'financeiro_lancamento', 'recebido_por_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Lancamento.conciliado_por'
        db.alter_column(u'financeiro_lancamento', 'conciliado_por_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'Lancamento.antecipado_por'
        db.alter_column(u'financeiro_lancamento', 'antecipado_por_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']))

        # Changing field 'Lancamento.recebido_por'
        db.alter_column(u'financeiro_lancamento', 'recebido_por_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']))

        # Changing field 'Lancamento.conciliado_por'
        db.alter_column(u'financeiro_lancamento', 'conciliado_por_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']))
