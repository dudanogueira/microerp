...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lancamento.modo_recebido'
        db.add_column(u'financeiro_lancamento', 'modo_recebido',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Lancamento.modo_recebido'
        db.delete_column(u'financeiro_lancamento', 'modo_recebido')
    ...
    models = {
        ...
        u'financeiro.lancamento': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modo_recebido': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
