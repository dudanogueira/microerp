...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Lancamento.modo_recebido'
        db.alter_column(u'financeiro_lancamento', 'modo_recebido', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Lancamento.modo_recebido'
        db.alter_column(u'financeiro_lancamento', 'modo_recebido', self.gf('django.db.models.fields.CharField')(default='', max_length=100))
