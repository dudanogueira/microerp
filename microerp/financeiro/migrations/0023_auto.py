...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing M2M table for field lancamentos on 'ProcessoAntecipacao'
        db.delete_table('financeiro_processoantecipacao_lancamentos')

        # Adding M2M table for field lancamentos_receber on 'ProcessoAntecipacao'
        db.create_table(u'financeiro_processoantecipacao_lancamentos_receber', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('processoantecipacao', models.ForeignKey(orm[u'financeiro.processoantecipacao'], null=False)),
            ('lancamentofinanceiroreceber', models.ForeignKey(orm[u'financeiro.lancamentofinanceiroreceber'], null=False))
        ))
        db.create_unique(u'financeiro_processoantecipacao_lancamentos_receber', ['processoantecipacao_id', 'lancamentofinanceiroreceber_id'])


    def backwards(self, orm):
        # Adding M2M table for field lancamentos on 'ProcessoAntecipacao'
        db.create_table(u'financeiro_processoantecipacao_lancamentos', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('processoantecipacao', models.ForeignKey(orm[u'financeiro.processoantecipacao'], null=False)),
            ('lancamentofinanceiroreceber', models.ForeignKey(orm[u'financeiro.lancamentofinanceiroreceber'], null=False))
        ))
        db.create_unique(u'financeiro_processoantecipacao_lancamentos', ['processoantecipacao_id', 'lancamentofinanceiroreceber_id'])

        # Removing M2M table for field lancamentos_receber on 'ProcessoAntecipacao'
        db.delete_table('financeiro_processoantecipacao_lancamentos_receber')
    ...
    models = {
        ...
        u'comercial.contratofechado': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio_cobranca': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 20, 0, 0)'}),
        ...
        u'financeiro.lancamentofinanceiroreceber': {
            ...
            'data_cobranca': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 20, 0, 0)'}),
        ...
        u'financeiro.processoantecipacao': {
            ...
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lancamentos_receber': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['financeiro.LancamentoFinanceiroReceber']", 'symmetrical': 'False'}),
        ...
        u'rh.funcionario': {
            ...
            'escolaridade_conclusao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 20, 0, 0)', 'null': 'True', 'blank': 'True'}),
            ...
            'ultima_checagem_endereco': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 20, 0, 0)'}),
        ...
        u'rh.periodotrabalhado': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 20, 0, 0)'})
        },
        u'rh.procedimento': {
