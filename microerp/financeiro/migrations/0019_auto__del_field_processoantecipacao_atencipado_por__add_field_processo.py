...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProcessoAntecipacao.atencipado_por'
        db.delete_column(u'financeiro_processoantecipacao', 'atencipado_por_id')

        # Adding field 'ProcessoAntecipacao.antecipado_por'
        db.add_column(u'financeiro_processoantecipacao', 'antecipado_por',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ProcessoAntecipacao.atencipado_por'
        db.add_column(u'financeiro_processoantecipacao', 'atencipado_por',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)

        # Deleting field 'ProcessoAntecipacao.antecipado_por'
        db.delete_column(u'financeiro_processoantecipacao', 'antecipado_por_id')
