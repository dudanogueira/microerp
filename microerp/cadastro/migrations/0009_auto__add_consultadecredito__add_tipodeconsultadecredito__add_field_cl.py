...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cadastro_consultadecredito', (
        ...
        db.send_create_signal('cadastro', ['ConsultaDeCredito'])

        # Adding model 'TipoDeConsultaDeCredito'
        db.create_table('cadastro_tipodeconsultadecredito', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('cadastro', ['TipoDeConsultaDeCredito'])

        # Adding field 'Cliente.solicitar_consulta_credito'
        db.add_column('cadastro_cliente', 'solicitar_consulta_credito',
    ...
    def backwards(self, orm):
        ...
        db.delete_table('cadastro_consultadecredito')

        # Deleting model 'TipoDeConsultaDeCredito'
        db.delete_table('cadastro_tipodeconsultadecredito')

        # Deleting field 'Cliente.solicitar_consulta_credito'
        db.delete_column('cadastro_cliente', 'solicitar_consulta_credito')
