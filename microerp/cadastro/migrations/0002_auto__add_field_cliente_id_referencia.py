...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cliente.id_referencia'
        db.add_column('cadastro_cliente', 'id_referencia',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cliente.id_referencia'
        db.delete_column('cadastro_cliente', 'id_referencia')
