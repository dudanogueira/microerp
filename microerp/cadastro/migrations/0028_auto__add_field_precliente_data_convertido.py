...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PreCliente.data_convertido'
        db.add_column(u'cadastro_precliente', 'data_convertido',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PreCliente.data_convertido'
        db.delete_column(u'cadastro_precliente', 'data_convertido')
