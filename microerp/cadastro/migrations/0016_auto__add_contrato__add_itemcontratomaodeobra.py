...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'cadastro_contrato', (
            ...
            ('validade', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 5, 30, 0, 0), blank=True)),
            ...
            ('vendedor', self.gf('django.db.models.fields.related.ForeignKey')(related_name='vendedor_contrato_set', to=orm['rh.Funcionario'])),
            ('criado_por', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['account.User'])),
        ...
        db.send_create_signal(u'cadastro', ['Contrato'])

        # Adding model 'ItemContratoMaoDeObra'
        db.create_table(u'cadastro_itemcontratomaodeobra', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('contrato', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cadastro.Contrato'])),
        ...
        db.send_create_signal(u'cadastro', ['ItemContratoMaoDeObra'])


    def backwards(self, orm):
        # Deleting model 'Contrato'
        db.delete_table(u'cadastro_contrato')

        # Deleting model 'ItemContratoMaoDeObra'
        db.delete_table(u'cadastro_itemcontratomaodeobra')
    ...
    models = {
        ...
        u'cadastro.contrato': {
            ...
            'cliente': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cadastro.Cliente']"}),
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'criado_por': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['account.User']"}),
            'descricao': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'status': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'validade': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 30, 0, 0)', 'blank': 'True'}),
        ...
        u'rh.funcionario': {
            ...
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
            'escolaridade_conclusao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 5, 23, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        u'rh.periodotrabalhado': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 5, 23, 0, 0)'})
        },
