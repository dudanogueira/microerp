...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Cliente.funcionario_responsavel'
        db.alter_column('cadastro_cliente', 'funcionario_responsavel_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rh.Funcionario'], null=True))

    def backwards(self, orm):

        # Changing field 'Cliente.funcionario_responsavel'
        db.alter_column('cadastro_cliente', 'funcionario_responsavel_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['rh.Funcionario']))
