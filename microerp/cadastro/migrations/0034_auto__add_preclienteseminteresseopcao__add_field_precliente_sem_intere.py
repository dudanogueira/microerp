...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PreClienteSemInteresseOpcao'
        db.create_table(u'cadastro_preclienteseminteresseopcao', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nome', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
        ))
        db.send_create_signal(u'cadastro', ['PreClienteSemInteresseOpcao'])

        # Adding field 'PreCliente.sem_interesse_opcao'
        db.add_column(u'cadastro_precliente', 'sem_interesse_opcao',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cadastro.PreClienteSemInteresseOpcao'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'PreClienteSemInteresseOpcao'
        db.delete_table(u'cadastro_preclienteseminteresseopcao')

        # Deleting field 'PreCliente.sem_interesse_opcao'
        db.delete_column(u'cadastro_precliente', 'sem_interesse_opcao_id')
    ...
    models = {
        ...
        u'cadastro.enderecocliente': {
            ...
            'principal': ('django.db.models.fields.NullBooleanField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
        ...
        u'cadastro.recado': {
            ...
            'adicionado_por': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'recado_criado_set'", 'to': u"orm['rh.Funcionario']"}),
            'atualizado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'rh.funcionario': {
            ...
            'escolaridade_conclusao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 24, 0, 0)', 'null': 'True', 'blank': 'True'}),
            ...
            'ultima_checagem_endereco': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 24, 0, 0)'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['auth.User']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'max_length': '36', 'blank': 'True'}),
        ...
        u'rh.periodotrabalhado': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 24, 0, 0)'})
        },
        u'rh.procedimento': {
