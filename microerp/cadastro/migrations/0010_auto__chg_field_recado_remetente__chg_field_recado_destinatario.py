...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Recado.remetente'
        db.alter_column(u'cadastro_recado', 'remetente_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rh.Funcionario']))

        # Changing field 'Recado.destinatario'
        db.alter_column(u'cadastro_recado', 'destinatario_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rh.Funcionario']))

    def backwards(self, orm):

        # Changing field 'Recado.remetente'
        db.alter_column(u'cadastro_recado', 'remetente_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['account.User']))

        # Changing field 'Recado.destinatario'
        db.alter_column(u'cadastro_recado', 'destinatario_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['account.User']))
