...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'EnderecoCliente', fields ['cliente', 'principal']
        db.create_unique(u'cadastro_enderecocliente', ['cliente_id', 'principal'])


    def backwards(self, orm):
        # Removing unique constraint on 'EnderecoCliente', fields ['cliente', 'principal']
        db.delete_unique(u'cadastro_enderecocliente', ['cliente_id', 'principal'])
    ...
    models = {
        ...
        u'cadastro.enderecocliente': {
            'Meta': {'unique_together': "(('principal', 'cliente'),)", 'object_name': 'EnderecoCliente'},
            'atualizado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
