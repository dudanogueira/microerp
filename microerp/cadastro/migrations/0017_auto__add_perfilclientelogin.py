...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PerfilClienteLogin'
        db.create_table(u'cadastro_perfilclientelogin', (
        ...
        db.send_create_signal(u'cadastro', ['PerfilClienteLogin'])


    def backwards(self, orm):
        # Deleting model 'PerfilClienteLogin'
        db.delete_table(u'cadastro_perfilclientelogin')
