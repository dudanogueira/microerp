...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('cadastro_cliente', 'cnpj', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Cliente.cpf'
        db.alter_column('cadastro_cliente', 'cpf', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Cliente.cnpj'
        db.alter_column('cadastro_cliente', 'cnpj', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Cliente.cpf'
        db.alter_column('cadastro_cliente', 'cpf', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
