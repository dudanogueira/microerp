...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Recado.lido_em'
        db.add_column(u'cadastro_recado', 'lido_em',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 4, 24, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Recado.lido_em'
        db.delete_column(u'cadastro_recado', 'lido_em')
    ...
    models = {
        ...
        u'cadastro.recado': {
            ...
            'lido_em': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
        ...
        u'rh.funcionario': {
            ...
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
            'escolaridade_conclusao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 4, 24, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        u'rh.periodotrabalhado': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 4, 24, 0, 0)'})
        },
