...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PreCliente.convertido_por'
        db.alter_column(u'cadastro_precliente', 'convertido_por_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rh.Funcionario']))

        # Changing field 'PreCliente.adicionado_por'
        db.alter_column(u'cadastro_precliente', 'adicionado_por_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rh.Funcionario']))

        # Changing field 'Recado.adicionado_por'
        db.alter_column(u'cadastro_recado', 'adicionado_por_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rh.Funcionario']))

    def backwards(self, orm):

        # Changing field 'PreCliente.convertido_por'
        db.alter_column(u'cadastro_precliente', 'convertido_por_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))
