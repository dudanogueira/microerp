...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Recado.lido_em'
        db.alter_column(u'cadastro_recado', 'lido_em', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Recado.lido_em'
        db.alter_column(u'cadastro_recado', 'lido_em', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 4, 24, 0, 0)))
