...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Cliente.origem'
        db.alter_column('cadastro_cliente', 'origem_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cadastro.ClienteOrigem'], null=True))

        # Changing field 'Cliente.ramo'
        db.alter_column('cadastro_cliente', 'ramo_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cadastro.Ramo'], null=True))

    def backwards(self, orm):

        # Changing field 'Cliente.origem'
        db.alter_column('cadastro_cliente', 'origem_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['cadastro.ClienteOrigem']))

        # Changing field 'Cliente.ramo'
        db.alter_column('cadastro_cliente', 'ramo_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['cadastro.Ramo']))
    ...
    models = {
        ...
        'rh.funcionario': {
            ...
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
            'escolaridade_conclusao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 1, 2, 0, 0)'}),
