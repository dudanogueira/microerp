...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PerfilClienteLogin.cliente'
        db.add_column(u'cadastro_perfilclientelogin', 'cliente',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cadastro.Cliente'], unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PerfilClienteLogin.cliente'
        db.delete_column(u'cadastro_perfilclientelogin', 'cliente_id')
    ...
    models = {
        ...
        u'cadastro.contrato': {
            ...
            'validade': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 13, 0, 0)', 'blank': 'True'}),
