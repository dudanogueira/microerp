...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PreCliente.cliente_convertido'
        db.alter_column(u'cadastro_precliente', 'cliente_convertido_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cadastro.Cliente'], unique=True, null=True))
        # Adding unique constraint on 'PreCliente', fields ['cliente_convertido']
        db.create_unique(u'cadastro_precliente', ['cliente_convertido_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'PreCliente', fields ['cliente_convertido']
        db.delete_unique(u'cadastro_precliente', ['cliente_convertido_id'])


        # Changing field 'PreCliente.cliente_convertido'
        db.alter_column(u'cadastro_precliente', 'cliente_convertido_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cadastro.Cliente'], null=True))
    ...
    models = {
        ...
        u'rh.funcionario': {
            ...
            'escolaridade_conclusao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 25, 0, 0)', 'null': 'True', 'blank': 'True'}),
            ...
            'ultima_checagem_endereco': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 25, 0, 0)'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['auth.User']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'max_length': '36', 'blank': 'True'}),
        ...
        u'rh.periodotrabalhado': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 25, 0, 0)'})
        },
        u'rh.procedimento': {
