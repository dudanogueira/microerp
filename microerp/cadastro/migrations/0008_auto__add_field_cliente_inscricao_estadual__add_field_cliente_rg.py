...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cliente.inscricao_estadual'
        db.add_column('cadastro_cliente', 'inscricao_estadual',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Cliente.rg'
        db.add_column('cadastro_cliente', 'rg',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cliente.inscricao_estadual'
        db.delete_column('cadastro_cliente', 'inscricao_estadual')

        # Deleting field 'Cliente.rg'
        db.delete_column('cadastro_cliente', 'rg')
