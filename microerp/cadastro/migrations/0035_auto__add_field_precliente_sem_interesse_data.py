...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PreCliente.sem_interesse_data'
        db.add_column(u'cadastro_precliente', 'sem_interesse_data',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PreCliente.sem_interesse_data'
        db.delete_column(u'cadastro_precliente', 'sem_interesse_data')
