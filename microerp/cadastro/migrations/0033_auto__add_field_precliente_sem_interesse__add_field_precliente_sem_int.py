...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PreCliente.sem_interesse'
        db.add_column(u'cadastro_precliente', 'sem_interesse',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PreCliente.sem_interesse_motivo'
        db.add_column(u'cadastro_precliente', 'sem_interesse_motivo',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PreCliente.sem_interesse'
        db.delete_column(u'cadastro_precliente', 'sem_interesse')

        # Deleting field 'PreCliente.sem_interesse_motivo'
        db.delete_column(u'cadastro_precliente', 'sem_interesse_motivo')
