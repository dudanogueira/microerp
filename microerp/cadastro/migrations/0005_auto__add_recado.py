...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Recado'
        db.create_table(u'cadastro_recado', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('remetente', self.gf('django.db.models.fields.related.ForeignKey')(related_name='recado_enviado_set', to=orm['account.User'])),
            ('destinatario', self.gf('django.db.models.fields.related.ForeignKey')(related_name='recado_recebido_set', to=orm['account.User'])),
            ...
            ('encaminhado', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('encaminhado_data', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ...
        db.send_create_signal(u'cadastro', ['Recado'])


    def backwards(self, orm):
        # Deleting model 'Recado'
        db.delete_table(u'cadastro_recado')
