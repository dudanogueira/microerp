...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PerfilClienteLogin.user'
        db.alter_column(u'cadastro_perfilclientelogin', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, null=True))

        # Changing field 'Recado.adicionado_por'
        db.alter_column(u'cadastro_recado', 'adicionado_por_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'Contrato.criado_por'
        db.alter_column(u'cadastro_contrato', 'criado_por_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'PerfilAcessoRecepcao.user'
        db.alter_column(u'cadastro_perfilacessorecepcao', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))

        # Changing field 'PreCliente.adicionado_por'
        db.alter_column(u'cadastro_precliente', 'adicionado_por_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'PerfilClienteLogin.user'
        db.alter_column(u'cadastro_perfilclientelogin', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['account.User'], unique=True, null=True))

        # Changing field 'Recado.adicionado_por'
        db.alter_column(u'cadastro_recado', 'adicionado_por_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['account.User']))

        # Changing field 'Contrato.criado_por'
        db.alter_column(u'cadastro_contrato', 'criado_por_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['account.User']))

        # Changing field 'PerfilAcessoRecepcao.user'
        db.alter_column(u'cadastro_perfilacessorecepcao', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['account.User'], unique=True))

        # Changing field 'PreCliente.adicionado_por'
        db.alter_column(u'cadastro_precliente', 'adicionado_por_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['account.User']))
    ...
    models = {
        ...
        u'cadastro.contrato': {
            ...
            'validade': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 19, 0, 0)', 'blank': 'True'}),
            ...
            'vendedor': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'vendedor_contrato_set'", 'to': u"orm['rh.Funcionario']"})
        },
        ...
        u'cadastro.itemcontratomaodeobra': {
            'Meta': {'object_name': 'ItemContratoMaoDeObra'},
            'cargo': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['rh.Cargo']"}),
            'contrato': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cadastro.Contrato']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'rh.funcionario': {
            ...
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
            'escolaridade_conclusao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 7, 12, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        u'rh.periodotrabalhado': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 7, 12, 0, 0)'})
        },
