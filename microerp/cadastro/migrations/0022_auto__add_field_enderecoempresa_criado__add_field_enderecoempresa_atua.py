...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EnderecoEmpresa.criado'
        db.add_column(u'cadastro_enderecoempresa', 'criado',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'EnderecoEmpresa.atualizado'
        db.add_column(u'cadastro_enderecoempresa', 'atualizado',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EnderecoEmpresa.criado'
        db.delete_column(u'cadastro_enderecoempresa', 'criado')

        # Deleting field 'EnderecoEmpresa.atualizado'
        db.delete_column(u'cadastro_enderecoempresa', 'atualizado')
