...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PreCliente'
        db.create_table(u'cadastro_precliente', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cliente_convertido', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cadastro.Cliente'])),
            ...
            ('dados', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal(u'cadastro', ['PreCliente'])


    def backwards(self, orm):
        # Deleting model 'PreCliente'
        db.delete_table(u'cadastro_precliente')
    ...
    models = {
        ...
        u'cadastro.precliente': {
            ...
            'cliente_convertido': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cadastro.Cliente']"}),
