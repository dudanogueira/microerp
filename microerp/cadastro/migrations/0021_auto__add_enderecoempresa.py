...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EnderecoEmpresa'
        db.create_table(u'cadastro_enderecoempresa', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cnpj_vinculado', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('nome', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'cadastro', ['EnderecoEmpresa'])


    def backwards(self, orm):
        # Deleting model 'EnderecoEmpresa'
        db.delete_table(u'cadastro_enderecoempresa')
