...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('cadastro_cliente', 'telefone_fixo', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Cliente.telefone_celular'
        db.alter_column('cadastro_cliente', 'telefone_celular', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Cliente.telefone_fixo'
        db.alter_column('cadastro_cliente', 'telefone_fixo', self.gf('django.db.models.fields.CharField')(default=-2211, max_length=100))

        # Changing field 'Cliente.telefone_celular'
        db.alter_column('cadastro_cliente', 'telefone_celular', self.gf('django.db.models.fields.CharField')(default='', max_length=100))
    ...
    models = {
        ...
        'cadastro.consultadecredito': {
            ...
            'funcionario_executor': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'realizacoes_consulta_credito_set'", 'to': "orm['rh.Funcionario']"}),
            'funcionario_solicitante': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'solicitacoes_consulta_credito_set'", 'to': "orm['rh.Funcionario']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'tipo': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cadastro.TipoDeConsultaDeCredito']"})
        },
        'cadastro.ramo': {
        ...
        'cadastro.tipodeconsultadecredito': {
