...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PerfilAcessoRecepcao'
        db.create_table(u'cadastro_perfilacessorecepcao', (
        ...
        db.send_create_signal(u'cadastro', ['PerfilAcessoRecepcao'])


    def backwards(self, orm):
        # Deleting model 'PerfilAcessoRecepcao'
        db.delete_table(u'cadastro_perfilacessorecepcao')
