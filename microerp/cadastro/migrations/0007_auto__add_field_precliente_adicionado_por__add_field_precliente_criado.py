...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PreCliente.adicionado_por'
        db.add_column(u'cadastro_precliente', 'adicionado_por',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='precliente_lancado_set', to=orm['account.User']),
                      keep_default=False)

        # Adding field 'PreCliente.criado'
        db.add_column(u'cadastro_precliente', 'criado',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'PreCliente.atualizado'
        db.add_column(u'cadastro_precliente', 'atualizado',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PreCliente.adicionado_por'
        db.delete_column(u'cadastro_precliente', 'adicionado_por_id')

        # Deleting field 'PreCliente.criado'
        db.delete_column(u'cadastro_precliente', 'criado')

        # Deleting field 'PreCliente.atualizado'
        db.delete_column(u'cadastro_precliente', 'atualizado')
