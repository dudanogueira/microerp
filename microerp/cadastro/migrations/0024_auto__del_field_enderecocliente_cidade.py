...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EnderecoCliente.cidade'
        db.delete_column(u'cadastro_enderecocliente', 'cidade_id')


    def backwards(self, orm):
        # Adding field 'EnderecoCliente.cidade'
        db.add_column(u'cadastro_enderecocliente', 'cidade',
