...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Recado.lida'
        db.delete_column(u'cadastro_recado', 'lida')

        # Adding field 'Recado.lido'
        db.add_column(u'cadastro_recado', 'lido',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Recado.lida'
        db.add_column(u'cadastro_recado', 'lida',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Recado.lido'
        db.delete_column(u'cadastro_recado', 'lido')
