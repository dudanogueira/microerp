...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Recado.tipo'
        db.add_column(u'cadastro_recado', 'tipo',
                      self.gf('django.db.models.fields.CharField')(default='comercial', max_length=100),
                      keep_default=False)

        # Adding field 'Recado.tipo_outros'
        db.add_column(u'cadastro_recado', 'tipo_outros',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Recado.tipo'
        db.delete_column(u'cadastro_recado', 'tipo')

        # Deleting field 'Recado.tipo_outros'
        db.delete_column(u'cadastro_recado', 'tipo_outros')
    ...
    models = {
        ...
        u'rh.funcionario': {
            ...
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
            'escolaridade_conclusao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 4, 29, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        u'rh.periodotrabalhado': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 4, 29, 0, 0)'})
        },
