...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Cliente.comercial_responsavel'
        db.delete_column('cadastro_cliente', 'comercial_responsavel_id')

        # Adding field 'Cliente.funcionario_responsavel'
        db.add_column('cadastro_cliente', 'funcionario_responsavel',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['rh.Funcionario']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Cliente.comercial_responsavel'
        db.add_column('cadastro_cliente', 'comercial_responsavel',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['rh.Funcionario']),
                      keep_default=False)

        # Deleting field 'Cliente.funcionario_responsavel'
        db.delete_column('cadastro_cliente', 'funcionario_responsavel_id')
    ...
    models = {
        ...
        'rh.funcionario': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nascimento': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 11, 11, 0, 0)'}),
