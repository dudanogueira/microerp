...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Recado.email_enviado'
        db.add_column(u'cadastro_recado', 'email_enviado',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Recado.email_enviado'
        db.delete_column(u'cadastro_recado', 'email_enviado')
