...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PreCliente.convertido_por'
        db.add_column(u'cadastro_precliente', 'convertido_por',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='precliente_convertido_set', to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PreCliente.convertido_por'
        db.delete_column(u'cadastro_precliente', 'convertido_por_id')
    ...
    models = {
        ...
        u'cadastro.precliente': {
            ...
            'convertido_por': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'precliente_convertido_set'", 'to': u"orm['auth.User']"}),
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
