...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EnderecoCliente.criado'
        db.add_column(u'cadastro_enderecocliente', 'criado',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'EnderecoCliente.atualizado'
        db.add_column(u'cadastro_enderecocliente', 'atualizado',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EnderecoCliente.criado'
        db.delete_column(u'cadastro_enderecocliente', 'criado')

        # Deleting field 'EnderecoCliente.atualizado'
        db.delete_column(u'cadastro_enderecocliente', 'atualizado')
