...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Produto.fator'
        db.alter_column(u'estoque_produto', 'fator', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

    def backwards(self, orm):

        # Changing field 'Produto.fator'
        db.alter_column(u'estoque_produto', 'fator', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        u'estoque.produto': {
            ...
            'fator': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
