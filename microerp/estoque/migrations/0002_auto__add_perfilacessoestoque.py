...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PerfilAcessoEstoque'
        db.create_table(u'estoque_perfilacessoestoque', (
        ...
        db.send_create_signal(u'estoque', ['PerfilAcessoEstoque'])


    def backwards(self, orm):
        # Deleting model 'PerfilAcessoEstoque'
        db.delete_table(u'estoque_perfilacessoestoque')
