...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Produto.preco_consumo'
        db.add_column(u'estoque_produto', 'preco_consumo',
                      self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=10, decimal_places=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Produto.preco_consumo'
        db.delete_column(u'estoque_produto', 'preco_consumo')
