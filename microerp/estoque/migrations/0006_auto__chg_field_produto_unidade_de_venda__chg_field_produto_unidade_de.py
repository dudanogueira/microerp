...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Produto.unidade_de_venda'
        db.alter_column(u'estoque_produto', 'unidade_de_venda', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Produto.unidade_de_compra'
        db.alter_column(u'estoque_produto', 'unidade_de_compra', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Produto.unidade_de_venda'
        db.alter_column(u'estoque_produto', 'unidade_de_venda', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

        # Changing field 'Produto.unidade_de_compra'
        db.alter_column(u'estoque_produto', 'unidade_de_compra', self.gf('django.db.models.fields.CharField')(default='', max_length=100))
    ...
    models = {
        ...
        u'estoque.produto': {
            ...
            'unidade_de_compra': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'unidade_de_venda': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'})
        },
