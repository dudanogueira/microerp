...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CodigoDeBarra'
        db.create_table(u'estoque_codigodebarra', (
        ...
        db.send_create_signal(u'estoque', ['CodigoDeBarra'])

        # Deleting field 'Produto.padrao_codigo_de_barras'
        db.delete_column(u'estoque_produto', 'padrao_codigo_de_barras')

        # Deleting field 'Produto.codigo_barras'
        db.delete_column(u'estoque_produto', 'codigo_barras')


    def backwards(self, orm):
        # Deleting model 'CodigoDeBarra'
        db.delete_table(u'estoque_codigodebarra')

        # Adding field 'Produto.padrao_codigo_de_barras'
        db.add_column(u'estoque_produto', 'padrao_codigo_de_barras',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Produto.codigo_barras'
        db.add_column(u'estoque_produto', 'codigo_barras',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)
