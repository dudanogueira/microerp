...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Produto.grupo_indicador'
        db.add_column(u'estoque_produto', 'grupo_indicador',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['comercial.GrupoIndicadorDeProdutoVendido'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Produto.grupo_indicador'
        db.delete_column(u'estoque_produto', 'grupo_indicador_id')
