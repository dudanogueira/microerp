...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ocorrencia.despachado_por'
        db.add_column(u'ocorrencia_ocorrencia', 'despachado_por',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='ocorrencia_despachado_set', null=True, to=orm['account.User']),
                      keep_default=False)

        # Adding field 'Ocorrencia.despachado_data'
        db.add_column(u'ocorrencia_ocorrencia', 'despachado_data',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ocorrencia.despachado_por'
        db.delete_column(u'ocorrencia_ocorrencia', 'despachado_por_id')

        # Deleting field 'Ocorrencia.despachado_data'
        db.delete_column(u'ocorrencia_ocorrencia', 'despachado_data')
