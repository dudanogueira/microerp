...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ocorrencia.responsavel_correcao'
        db.alter_column(u'ocorrencia_ocorrencia', 'responsavel_correcao_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rh.Funcionario']))

    def backwards(self, orm):

        # Changing field 'Ocorrencia.responsavel_correcao'
        db.alter_column(u'ocorrencia_ocorrencia', 'responsavel_correcao_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['rh.Funcionario']))
