...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ocorrencia.descricao'
        db.alter_column(u'ocorrencia_ocorrencia', 'descricao', self.gf('django.db.models.fields.TextField')(default=1))

    def backwards(self, orm):

        # Changing field 'Ocorrencia.descricao'
        db.alter_column(u'ocorrencia_ocorrencia', 'descricao', self.gf('django.db.models.fields.TextField')(null=True))
