...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ocorrencia.resolucao_final_data'
        db.alter_column(u'ocorrencia_ocorrencia', 'resolucao_final_data', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Ocorrencia.resolucao_final_data'
        db.alter_column(u'ocorrencia_ocorrencia', 'resolucao_final_data', self.gf('django.db.models.fields.DateTimeField')())
