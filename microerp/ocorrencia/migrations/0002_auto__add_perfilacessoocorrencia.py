...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PerfilAcessoOcorrencia'
        db.create_table(u'ocorrencia_perfilacessoocorrencia', (
        ...
        db.send_create_signal(u'ocorrencia', ['PerfilAcessoOcorrencia'])


    def backwards(self, orm):
        # Deleting model 'PerfilAcessoOcorrencia'
        db.delete_table(u'ocorrencia_perfilacessoocorrencia')
