...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ocorrencia.prioridade'
        db.add_column(u'ocorrencia_ocorrencia', 'prioridade',
                      self.gf('django.db.models.fields.IntegerField')(default=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ocorrencia.prioridade'
        db.delete_column(u'ocorrencia_ocorrencia', 'prioridade')
