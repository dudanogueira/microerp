...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ocorrencia.correcao_iniciada'
        db.add_column(u'ocorrencia_ocorrencia', 'correcao_iniciada',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ocorrencia.correcao_iniciada'
        db.delete_column(u'ocorrencia_ocorrencia', 'correcao_iniciada')
