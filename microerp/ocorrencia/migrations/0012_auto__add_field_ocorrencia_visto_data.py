...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ocorrencia.visto_data'
        db.add_column(u'ocorrencia_ocorrencia', 'visto_data',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ocorrencia.visto_data'
        db.delete_column(u'ocorrencia_ocorrencia', 'visto_data')
