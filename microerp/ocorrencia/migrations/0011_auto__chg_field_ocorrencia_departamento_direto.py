...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ocorrencia.departamento_direto'
        db.alter_column(u'ocorrencia_ocorrencia', 'departamento_direto_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rh.Departamento']))

    def backwards(self, orm):

        # Changing field 'Ocorrencia.departamento_direto'
        db.alter_column(u'ocorrencia_ocorrencia', 'departamento_direto_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['rh.Departamento']))
    ...
    models = {
        ...
        u'ocorrencia.ocorrencia': {
            ...
            'contato_iniciado': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
