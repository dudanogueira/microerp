...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ocorrencia.adicionado_por'
        db.alter_column(u'ocorrencia_ocorrencia', 'adicionado_por_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['account.User']))

    def backwards(self, orm):

        # Changing field 'Ocorrencia.adicionado_por'
        db.alter_column(u'ocorrencia_ocorrencia', 'adicionado_por_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['account.User']))
