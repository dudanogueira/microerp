...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'LinhaSubProdutoAlternativo'
        db.delete_table(u'producao_linhasubprodutoalternativo')

        # Adding model 'OpcaoLinhaSubProduto'
        db.create_table(u'producao_opcaolinhasubproduto', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('linha', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['producao.LinhaSubProduto'])),
            ('componente', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['producao.Componente'])),
            ('quantidade', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2)),
            ('padrao', self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True)),
        ))
        db.send_create_signal(u'producao', ['OpcaoLinhaSubProduto'])

        # Deleting field 'LinhaSubProduto.componente_padrao'
        db.delete_column(u'producao_linhasubproduto', 'componente_padrao_id')

        # Deleting field 'LinhaSubProduto.quantidade'
        db.delete_column(u'producao_linhasubproduto', 'quantidade')

        # Adding field 'LinhaSubProduto.peso'
        db.add_column(u'producao_linhasubproduto', 'peso',
                      self.gf('django.db.models.fields.IntegerField')(unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding model 'LinhaSubProdutoAlternativo'
        db.create_table(u'producao_linhasubprodutoalternativo', (
            ('quantidade', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('componente_alternativo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['producao.Componente'])),
            ('linha', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['producao.LinhaSubProduto'])),
        ))
        db.send_create_signal(u'producao', ['LinhaSubProdutoAlternativo'])

        # Deleting model 'OpcaoLinhaSubProduto'
        db.delete_table(u'producao_opcaolinhasubproduto')

        # Adding field 'LinhaSubProduto.componente_padrao'
        db.add_column(u'producao_linhasubproduto', 'componente_padrao',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='subproduto_padrao_set', on_delete=models.PROTECT, to=orm['producao.Componente']),
                      keep_default=False)

        # Adding field 'LinhaSubProduto.quantidade'
        db.add_column(u'producao_linhasubproduto', 'quantidade',
                      self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=10, decimal_places=2),
                      keep_default=False)

        # Deleting field 'LinhaSubProduto.peso'
        db.delete_column(u'producao_linhasubproduto', 'peso')
    ...
    models = {
        ...
        u'producao.linhasubproduto': {
            ...
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'peso': ('django.db.models.fields.IntegerField', [], {'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'subproduto': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['producao.SubProduto']"}),
            'tag': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'})
        },
        ...
        u'producao.opcaolinhasubproduto': {
            'Meta': {'object_name': 'OpcaoLinhaSubProduto'},
            'componente': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['producao.Componente']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
