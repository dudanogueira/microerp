...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubProduto.imagem'
        db.add_column(u'producao_subproduto', 'imagem',
                      self.gf('django.db.models.fields.files.ImageField')(default=1, max_length=100),
                      keep_default=False)


        # Changing field 'LinhaSubProduto.componente_padrao'
        db.alter_column(u'producao_linhasubproduto', 'componente_padrao_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['producao.Componente']))

    def backwards(self, orm):
        # Deleting field 'SubProduto.imagem'
        db.delete_column(u'producao_subproduto', 'imagem')


        # Changing field 'LinhaSubProduto.componente_padrao'
        db.alter_column(u'producao_linhasubproduto', 'componente_padrao_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['producao.Componente']))
