...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'FalhaDeTeste', fields ['codigo']
        db.delete_unique(u'producao_falhadeteste', ['codigo'])

        # Adding field 'SubProduto.valor_total_de_custo'
        db.add_column(u'producao_subproduto', 'valor_total_de_custo',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2),
                      keep_default=False)

        # Adding field 'SubProduto.notacao_de_producao'
        db.add_column(u'producao_subproduto', 'notacao_de_producao',
                      self.gf('django.db.models.fields.TextField')(default='{}', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubProduto.valor_total_de_custo'
        db.delete_column(u'producao_subproduto', 'valor_total_de_custo')

        # Deleting field 'SubProduto.notacao_de_producao'
        db.delete_column(u'producao_subproduto', 'notacao_de_producao')

        # Adding unique constraint on 'FalhaDeTeste', fields ['codigo']
        db.create_unique(u'producao_falhadeteste', ['codigo'])
    ...
    models = {
        ...
        u'producao.componentesdaordemdecompra': {
            'Meta': {'ordering': "['-criado']", 'object_name': 'ComponentesDaOrdemDeCompra'},
            'atualizado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'producao.falhadeteste': {
            'Meta': {'ordering': "['-criado']", 'object_name': 'FalhaDeTeste'},
            'atualizado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'producao.lancamentodefalhadeteste': {
            ...
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'criado_por': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'data_lancamento': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 19, 0, 0)'}),
        ...
        u'producao.lancamentoprodproduto': {
            ...
            'data_montagem': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 19, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'data_vendido': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'fim_teste': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 19, 0, 0)', 'null': 'True', 'blank': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio_teste': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 19, 0, 0)', 'null': 'True', 'blank': 'True'}),
            ...
            'produto': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['producao.ProdutoFinal']"}),
            'realizacao_procedimento_de_teste': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 19, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        u'producao.notafiscallancamentosproducao': {
            ...
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'criado_por': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'data_saida': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 19, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'producao.ordemproducaosubproduto': {
            ...
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'criado_por': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'data_producao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 19, 0, 0)'}),
        ...
        u'producao.requisicaodecompra': {
            ...
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'criticidade': ('django.db.models.fields.IntegerField', [], {'default': '0', 'max_length': '1'}),
            'data_solicitado': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 19, 0, 0)'}),
            'descricao': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'rh.funcionario': {
            ...
            'escolaridade_conclusao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 19, 0, 0)', 'null': 'True', 'blank': 'True'}),
            ...
            'ultima_checagem_endereco': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 19, 0, 0)'}),
        ...
        u'rh.periodotrabalhado': {
            ...
            'funcionario': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['rh.Funcionario']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 19, 0, 0)'})
        },
        u'rh.procedimento': {
