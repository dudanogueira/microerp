...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PosicaoEstoque.nota_referecia'
        db.delete_column(u'producao_posicaoestoque', 'nota_referecia_id')

        # Adding field 'PosicaoEstoque.nota_referencia'
        db.add_column(u'producao_posicaoestoque', 'nota_referencia',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['producao.NotaFiscal'], null=True, on_delete=models.PROTECT, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PosicaoEstoque.nota_referecia'
        db.add_column(u'producao_posicaoestoque', 'nota_referecia',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['producao.NotaFiscal'], null=True, on_delete=models.PROTECT, blank=True),
                      keep_default=False)

        # Deleting field 'PosicaoEstoque.nota_referencia'
        db.delete_column(u'producao_posicaoestoque', 'nota_referencia_id')
