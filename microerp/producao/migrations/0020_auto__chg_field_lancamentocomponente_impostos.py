...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LancamentoComponente.impostos'
        db.alter_column(u'producao_lancamentocomponente', 'impostos', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'LancamentoComponente.impostos'
        db.alter_column(u'producao_lancamentocomponente', 'impostos', self.gf('django.db.models.fields.IntegerField')(null=True))
