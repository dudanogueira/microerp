...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SubProduto.tipo_de_teste'
        db.alter_column(u'producao_subproduto', 'tipo_de_teste', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'SubProduto.tipo_de_teste'
        db.alter_column(u'producao_subproduto', 'tipo_de_teste', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
    ...
    models = {
        ...
        u'producao.subproduto': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'tipo_de_teste': ('django.db.models.fields.CharField', [], {'default': '0', 'max_length': '100'}),
