...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SubProduto.imagem'
        db.alter_column(u'producao_subproduto', 'imagem', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'SubProduto.imagem'
        db.alter_column(u'producao_subproduto', 'imagem', self.gf('django.db.models.fields.files.ImageField')(default=1, max_length=100))
