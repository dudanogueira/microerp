...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LinhaTesteLancamentoProdProduto.funcionario_que_testou'
        db.alter_column(u'producao_linhatestelancamentoprodproduto', 'funcionario_que_testou_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rh.Funcionario']))

        # Changing field 'LinhaTesteLancamentoProdProduto.funcionario_que_montou'
        db.alter_column(u'producao_linhatestelancamentoprodproduto', 'funcionario_que_montou_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rh.Funcionario']))

    def backwards(self, orm):

        # Changing field 'LinhaTesteLancamentoProdProduto.funcionario_que_testou'
        db.alter_column(u'producao_linhatestelancamentoprodproduto', 'funcionario_que_testou_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['rh.Funcionario']))

        # Changing field 'LinhaTesteLancamentoProdProduto.funcionario_que_montou'
        db.alter_column(u'producao_linhatestelancamentoprodproduto', 'funcionario_que_montou_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['rh.Funcionario']))
