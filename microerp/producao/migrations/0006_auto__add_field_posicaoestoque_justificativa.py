...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PosicaoEstoque.justificativa'
        db.add_column(u'producao_posicaoestoque', 'justificativa',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PosicaoEstoque.justificativa'
        db.delete_column(u'producao_posicaoestoque', 'justificativa')
