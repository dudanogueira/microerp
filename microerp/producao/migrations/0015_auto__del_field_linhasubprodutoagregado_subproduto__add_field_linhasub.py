...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'LinhaSubProdutoAgregado.subproduto'
        db.delete_column(u'producao_linhasubprodutoagregado', 'subproduto_id')

        # Adding field 'LinhaSubProdutoAgregado.subproduto_principal'
        db.add_column(u'producao_linhasubprodutoagregado', 'subproduto_principal',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='subproduto_relacionado', to=orm['producao.SubProduto']),
                      keep_default=False)

        # Adding field 'LinhaSubProdutoAgregado.subproduto_agregado'
        db.add_column(u'producao_linhasubprodutoagregado', 'subproduto_agregado',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='subproutos_escolhidos', to=orm['producao.SubProduto']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'LinhaSubProdutoAgregado.subproduto'
        db.add_column(u'producao_linhasubprodutoagregado', 'subproduto',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['producao.SubProduto']),
                      keep_default=False)

        # Deleting field 'LinhaSubProdutoAgregado.subproduto_principal'
        db.delete_column(u'producao_linhasubprodutoagregado', 'subproduto_principal_id')

        # Deleting field 'LinhaSubProdutoAgregado.subproduto_agregado'
        db.delete_column(u'producao_linhasubprodutoagregado', 'subproduto_agregado_id')
    ...
    models = {
        ...
        u'producao.linhasubprodutoagregado': {
            ...
            'subproduto_agregado': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'subproutos_escolhidos'", 'to': u"orm['producao.SubProduto']"}),
            'subproduto_principal': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'subproduto_relacionado'", 'to': u"orm['producao.SubProduto']"})
        },
