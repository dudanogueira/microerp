...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AtividadDeCompra'
        db.create_table(u'producao_atividaddecompra', (
        ...
        db.send_create_signal(u'producao', ['AtividadDeCompra'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'AtividadDeCompra'
        db.delete_table(u'producao_atividaddecompra')
    ...
    models = {
        ...
        u'producao.atividaddecompra': {
            'Meta': {'ordering': "('data',)", 'object_name': 'AtividadDeCompra'},
            'atualizado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
