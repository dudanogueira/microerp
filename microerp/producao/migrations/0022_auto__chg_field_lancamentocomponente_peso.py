...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LancamentoComponente.peso'
        db.alter_column(u'producao_lancamentocomponente', 'peso', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'LancamentoComponente.peso'
        db.alter_column(u'producao_lancamentocomponente', 'peso', self.gf('django.db.models.fields.IntegerField')(default=1))
