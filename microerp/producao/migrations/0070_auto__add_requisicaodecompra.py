...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RequisicaoDeCompra'
        db.create_table(u'producao_requisicaodecompra', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('atendido', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('solicitante', self.gf('django.db.models.fields.related.ForeignKey')(related_name='requisicao_de_compra_solicitada', to=orm['rh.Funcionario'])),
            ('solicitado', self.gf('django.db.models.fields.related.ForeignKey')(related_name='requisicao_de_compra_requerida', to=orm['rh.Funcionario'])),
            ('data_solicitado', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 9, 9, 0, 0))),
        ...
        db.send_create_signal(u'producao', ['RequisicaoDeCompra'])


    def backwards(self, orm):
        # Deleting model 'RequisicaoDeCompra'
        db.delete_table(u'producao_requisicaodecompra')
    ...
    models = {
        ...
        u'producao.requisicaodecompra': {
            'Meta': {'object_name': 'RequisicaoDeCompra'},
            'atendido': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'atualizado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'data_solicitado': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 9, 0, 0)'}),
