...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OrdemDeCompra.data_fechado'
        db.alter_column(u'producao_ordemdecompra', 'data_fechado', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'OrdemDeCompra.data_aberto'
        db.alter_column(u'producao_ordemdecompra', 'data_aberto', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'OrdemDeCompra.data_fechado'
        db.alter_column(u'producao_ordemdecompra', 'data_fechado', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'OrdemDeCompra.data_aberto'
        db.alter_column(u'producao_ordemdecompra', 'data_aberto', self.gf('django.db.models.fields.DateTimeField')())
