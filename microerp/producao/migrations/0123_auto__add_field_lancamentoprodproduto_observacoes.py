...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LancamentoProdProduto.observacoes'
        db.add_column(u'producao_lancamentoprodproduto', 'observacoes',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LancamentoProdProduto.observacoes'
        db.delete_column(u'producao_lancamentoprodproduto', 'observacoes')
