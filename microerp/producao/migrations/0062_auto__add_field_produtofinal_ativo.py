...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProdutoFinal.ativo'
        db.add_column(u'producao_produtofinal', 'ativo',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProdutoFinal.ativo'
        db.delete_column(u'producao_produtofinal', 'ativo')
