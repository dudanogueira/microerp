...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProdutoFinal.quantidade_estimada_producao_semanal'
        db.add_column(u'producao_produtofinal', 'quantidade_estimada_producao_semanal',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProdutoFinal.quantidade_estimada_producao_semanal'
        db.delete_column(u'producao_produtofinal', 'quantidade_estimada_producao_semanal')
    ...
    models = {
        ...
        u'producao.produtofinal': {
            ...
            'imagem': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'nome': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'quantidade_estimada_producao_semanal': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'rh.funcionario': {
            ...
            'escolaridade_conclusao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 30, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        u'rh.periodotrabalhado': {
            ...
            'funcionario': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['rh.Funcionario']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 30, 0, 0)'})
        },
