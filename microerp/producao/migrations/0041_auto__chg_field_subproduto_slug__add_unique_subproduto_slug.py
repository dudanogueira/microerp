...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SubProduto.slug'
        db.alter_column(u'producao_subproduto', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True, null=True))
        # Adding unique constraint on 'SubProduto', fields ['slug']
        db.create_unique(u'producao_subproduto', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'SubProduto', fields ['slug']
        db.delete_unique(u'producao_subproduto', ['slug'])


        # Changing field 'SubProduto.slug'
        db.alter_column(u'producao_subproduto', 'slug', self.gf('django.db.models.fields.SlugField')(default=1, max_length=50))
    ...
    models = {
        ...
        u'producao.arquivoanexocomponente': {
            'Meta': {'object_name': 'ArquivoAnexoComponente'},
