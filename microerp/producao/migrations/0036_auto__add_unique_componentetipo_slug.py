...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ComponenteTipo', fields ['slug']
        db.create_unique(u'producao_componentetipo', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'ComponenteTipo', fields ['slug']
        db.delete_unique(u'producao_componentetipo', ['slug'])
