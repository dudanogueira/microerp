...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PerfilAcessoProducao'
        db.create_table(u'producao_perfilacessoproducao', (
        ...
        db.send_create_signal(u'producao', ['PerfilAcessoProducao'])


    def backwards(self, orm):
        # Deleting model 'PerfilAcessoProducao'
        db.delete_table(u'producao_perfilacessoproducao')
