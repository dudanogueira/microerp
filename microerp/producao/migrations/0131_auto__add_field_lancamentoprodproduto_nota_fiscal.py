...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LancamentoProdProduto.nota_fiscal'
        db.add_column(u'producao_lancamentoprodproduto', 'nota_fiscal',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['producao.NotaFiscalLancamentosProducao']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LancamentoProdProduto.nota_fiscal'
        db.delete_column(u'producao_lancamentoprodproduto', 'nota_fiscal_id')
    ...
    models = {
        ...
        u'producao.lancamentoprodproduto': {
            ...
            'nota_fiscal': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['producao.NotaFiscalLancamentosProducao']"}),
