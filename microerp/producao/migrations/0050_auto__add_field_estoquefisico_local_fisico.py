...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EstoqueFisico.local_fisico'
        db.add_column(u'producao_estoquefisico', 'local_fisico',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EstoqueFisico.local_fisico'
        db.delete_column(u'producao_estoquefisico', 'local_fisico')
    ...
    models = {
        ...
        u'producao.subproduto': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'tipo_de_teste': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '100', 'null': 'True', 'blank': 'True'}),
