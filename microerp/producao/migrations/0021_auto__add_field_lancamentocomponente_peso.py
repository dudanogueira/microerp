...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LancamentoComponente.peso'
        db.add_column(u'producao_lancamentocomponente', 'peso',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LancamentoComponente.peso'
        db.delete_column(u'producao_lancamentocomponente', 'peso')
