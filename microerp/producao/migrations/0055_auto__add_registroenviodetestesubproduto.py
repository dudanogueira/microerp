...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RegistroEnvioDeTesteSubProduto'
        db.create_table(u'producao_registroenviodetestesubproduto', (
        ...
        db.send_create_signal(u'producao', ['RegistroEnvioDeTesteSubProduto'])


    def backwards(self, orm):
        # Deleting model 'RegistroEnvioDeTesteSubProduto'
        db.delete_table(u'producao_registroenviodetestesubproduto')
