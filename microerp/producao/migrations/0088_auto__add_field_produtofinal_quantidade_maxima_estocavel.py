...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProdutoFinal.quantidade_maxima_estocavel'
        db.add_column(u'producao_produtofinal', 'quantidade_maxima_estocavel',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProdutoFinal.quantidade_maxima_estocavel'
        db.delete_column(u'producao_produtofinal', 'quantidade_maxima_estocavel')
