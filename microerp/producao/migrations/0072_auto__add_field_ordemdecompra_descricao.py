...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrdemDeCompra.descricao'
        db.add_column(u'producao_ordemdecompra', 'descricao',
                      self.gf('django.db.models.fields.TextField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OrdemDeCompra.descricao'
        db.delete_column(u'producao_ordemdecompra', 'descricao')
