...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PerfilAcessoProducao.user'
        db.alter_column(u'producao_perfilacessoproducao', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))

        # Changing field 'PosicaoEstoque.criado_por'
        db.alter_column(u'producao_posicaoestoque', 'criado_por_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

    def backwards(self, orm):

        # Changing field 'PerfilAcessoProducao.user'
        db.alter_column(u'producao_perfilacessoproducao', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['account.User'], unique=True))

        # Changing field 'PosicaoEstoque.criado_por'
        db.alter_column(u'producao_posicaoestoque', 'criado_por_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['account.User'], null=True))
