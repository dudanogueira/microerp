...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MovimentoEstoqueSubProduto'
        db.create_table(u'producao_movimentoestoquesubproduto', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('subproduto', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['producao.SubProduto'])),
            ('operacao', self.gf('django.db.models.fields.CharField')(default='adiciona', max_length=100, blank=True)),
            ('quantidade_movimentada', self.gf('django.db.models.fields.IntegerField')()),
            ('quantidade_anterior', self.gf('django.db.models.fields.IntegerField')()),
            ('quantidade_nova', self.gf('django.db.models.fields.IntegerField')()),
            ('justificativa', self.gf('django.db.models.fields.TextField')(blank=True)),
        ...
        db.send_create_signal(u'producao', ['MovimentoEstoqueSubProduto'])

        # Adding model 'NotaFiscalLancamentosProducao'
        db.create_table(u'producao_notafiscallancamentosproducao', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('notafiscal', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('cliente_associado', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'producao', ['NotaFiscalLancamentosProducao'])

        # Adding M2M table for field lancamentos_de_producao on 'NotaFiscalLancamentosProducao'
        db.create_table(u'producao_notafiscallancamentosproducao_lancamentos_de_producao', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('notafiscallancamentosproducao', models.ForeignKey(orm[u'producao.notafiscallancamentosproducao'], null=False)),
            ('lancamentoprodproduto', models.ForeignKey(orm[u'producao.lancamentoprodproduto'], null=False))
        ))
        db.create_unique(u'producao_notafiscallancamentosproducao_lancamentos_de_producao', ['notafiscallancamentosproducao_id', 'lancamentoprodproduto_id'])

        # Adding model 'MovimentoEstoqueProduto'
        db.create_table(u'producao_movimentoestoqueproduto', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('produto', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['producao.ProdutoFinal'])),
            ('operacao', self.gf('django.db.models.fields.CharField')(default='adiciona', max_length=100, blank=True)),
            ('quantidade_movimentada', self.gf('django.db.models.fields.IntegerField')()),
            ('quantidade_anterior', self.gf('django.db.models.fields.IntegerField')()),
            ('quantidade_nova', self.gf('django.db.models.fields.IntegerField')()),
        ...
        db.send_create_signal(u'producao', ['MovimentoEstoqueProduto'])


    def backwards(self, orm):
        # Deleting model 'MovimentoEstoqueSubProduto'
        db.delete_table(u'producao_movimentoestoquesubproduto')

        # Deleting model 'NotaFiscalLancamentosProducao'
        db.delete_table(u'producao_notafiscallancamentosproducao')

        # Removing M2M table for field lancamentos_de_producao on 'NotaFiscalLancamentosProducao'
        db.delete_table('producao_notafiscallancamentosproducao_lancamentos_de_producao')

        # Deleting model 'MovimentoEstoqueProduto'
        db.delete_table(u'producao_movimentoestoqueproduto')
