...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ComponentesDaOrdemDeCompra.valor'
        db.add_column(u'producao_componentesdaordemdecompra', 'valor',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ComponentesDaOrdemDeCompra.valor'
        db.delete_column(u'producao_componentesdaordemdecompra', 'valor')
