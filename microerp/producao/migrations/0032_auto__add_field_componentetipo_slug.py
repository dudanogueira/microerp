...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ComponenteTipo.slug'
        db.add_column(u'producao_componentetipo', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default=1, max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ComponenteTipo.slug'
        db.delete_column(u'producao_componentetipo', 'slug')
