...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PosicaoEstoque.quantidade'
        db.alter_column(u'producao_posicaoestoque', 'quantidade', self.gf('django.db.models.fields.DecimalField')(max_digits=15, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'PosicaoEstoque.quantidade'
        db.alter_column(u'producao_posicaoestoque', 'quantidade', self.gf('django.db.models.fields.CharField')(max_length=100))
