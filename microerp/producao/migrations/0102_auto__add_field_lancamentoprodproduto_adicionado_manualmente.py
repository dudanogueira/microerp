...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LancamentoProdProduto.adicionado_manualmente'
        db.add_column(u'producao_lancamentoprodproduto', 'adicionado_manualmente',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LancamentoProdProduto.adicionado_manualmente'
        db.delete_column(u'producao_lancamentoprodproduto', 'adicionado_manualmente')
