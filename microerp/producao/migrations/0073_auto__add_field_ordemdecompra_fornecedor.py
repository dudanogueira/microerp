...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrdemDeCompra.fornecedor'
        db.add_column(u'producao_ordemdecompra', 'fornecedor',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['producao.FabricanteFornecedor']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OrdemDeCompra.fornecedor'
        db.delete_column(u'producao_ordemdecompra', 'fornecedor_id')
