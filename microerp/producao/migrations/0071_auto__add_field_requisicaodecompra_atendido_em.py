...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RequisicaoDeCompra.atendido_em'
        db.add_column(u'producao_requisicaodecompra', 'atendido_em',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RequisicaoDeCompra.atendido_em'
        db.delete_column(u'producao_requisicaodecompra', 'atendido_em')
