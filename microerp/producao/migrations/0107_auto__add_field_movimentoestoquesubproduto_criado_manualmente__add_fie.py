...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MovimentoEstoqueSubProduto.criado_manualmente'
        db.add_column(u'producao_movimentoestoquesubproduto', 'criado_manualmente',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'MovimentoEstoqueProduto.criado_manualmente'
        db.add_column(u'producao_movimentoestoqueproduto', 'criado_manualmente',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MovimentoEstoqueSubProduto.criado_manualmente'
        db.delete_column(u'producao_movimentoestoquesubproduto', 'criado_manualmente')

        # Deleting field 'MovimentoEstoqueProduto.criado_manualmente'
        db.delete_column(u'producao_movimentoestoqueproduto', 'criado_manualmente')
