...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Componente.importado'
        db.delete_column(u'producao_componente', 'importado')

        # Adding field 'Componente.nacionalidade'
        db.add_column(u'producao_componente', 'nacionalidade',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Componente.importado'
        db.add_column(u'producao_componente', 'importado',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Componente.nacionalidade'
        db.delete_column(u'producao_componente', 'nacionalidade')
    ...
    models = {
        ...
        u'producao.componentetipo': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '3'})
        },
