...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LancamentoProdProduto.realizacao_procedimento_de_teste'
        db.add_column(u'producao_lancamentoprodproduto', 'realizacao_procedimento_de_teste',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 11, 1, 0, 0), null=True, blank=True),
                      keep_default=False)

        # Adding field 'LancamentoProdProduto.funcionario_finalizou_teste'
        db.add_column(u'producao_lancamentoprodproduto', 'funcionario_finalizou_teste',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='lancamento_de_producao_produto_teste_finalizado_set', null=True, to=orm['rh.Funcionario']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LancamentoProdProduto.realizacao_procedimento_de_teste'
        db.delete_column(u'producao_lancamentoprodproduto', 'realizacao_procedimento_de_teste')

        # Deleting field 'LancamentoProdProduto.funcionario_finalizou_teste'
        db.delete_column(u'producao_lancamentoprodproduto', 'funcionario_finalizou_teste_id')
