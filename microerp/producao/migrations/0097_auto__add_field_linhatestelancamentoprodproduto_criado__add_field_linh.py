...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LinhaTesteLancamentoProdProduto.criado'
        db.add_column(u'producao_linhatestelancamentoprodproduto', 'criado',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'LinhaTesteLancamentoProdProduto.atualizado'
        db.add_column(u'producao_linhatestelancamentoprodproduto', 'atualizado',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LinhaTesteLancamentoProdProduto.criado'
        db.delete_column(u'producao_linhatestelancamentoprodproduto', 'criado')

        # Deleting field 'LinhaTesteLancamentoProdProduto.atualizado'
        db.delete_column(u'producao_linhatestelancamentoprodproduto', 'atualizado')
