...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MovimentoEstoqueProduto.registro_de_nota_fiscal'
        db.alter_column(u'producao_movimentoestoqueproduto', 'registro_de_nota_fiscal_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['producao.NotaFiscalLancamentosProducao'], null=True))

    def backwards(self, orm):

        # Changing field 'MovimentoEstoqueProduto.registro_de_nota_fiscal'
        db.alter_column(u'producao_movimentoestoqueproduto', 'registro_de_nota_fiscal_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['producao.NotaFiscalLancamentosProducao']))
