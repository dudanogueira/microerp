...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RegistroValorEstoque'
        db.create_table(u'producao_registrovalorestoque', (
        ...
        db.send_create_signal(u'producao', ['RegistroValorEstoque'])


    def backwards(self, orm):
        # Deleting model 'RegistroValorEstoque'
        db.delete_table(u'producao_registrovalorestoque')
