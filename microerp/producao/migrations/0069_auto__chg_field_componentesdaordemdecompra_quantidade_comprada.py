...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ComponentesDaOrdemDeCompra.quantidade_comprada'
        db.alter_column(u'producao_componentesdaordemdecompra', 'quantidade_comprada', self.gf('django.db.models.fields.DecimalField')(max_digits=15, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'ComponentesDaOrdemDeCompra.quantidade_comprada'
        db.alter_column(u'producao_componentesdaordemdecompra', 'quantidade_comprada', self.gf('django.db.models.fields.IntegerField')())
