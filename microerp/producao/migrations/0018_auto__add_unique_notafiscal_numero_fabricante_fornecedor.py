...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'NotaFiscal', fields ['numero', 'fabricante_fornecedor']
        db.create_unique(u'producao_notafiscal', ['numero', 'fabricante_fornecedor_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'NotaFiscal', fields ['numero', 'fabricante_fornecedor']
        db.delete_unique(u'producao_notafiscal', ['numero', 'fabricante_fornecedor_id'])
