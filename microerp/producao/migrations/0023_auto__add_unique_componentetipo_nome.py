...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ComponenteTipo', fields ['nome']
        db.create_unique(u'producao_componentetipo', ['nome'])


    def backwards(self, orm):
        # Removing unique constraint on 'ComponenteTipo', fields ['nome']
        db.delete_unique(u'producao_componentetipo', ['nome'])
    ...
    models = {
        ...
        u'producao.componentetipo': {
            ...
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nome': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '100', 'blank': 'True'})
        },
