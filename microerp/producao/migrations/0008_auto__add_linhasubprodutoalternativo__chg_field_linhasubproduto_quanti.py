...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LinhaSubProduto.quantidade'
        db.alter_column(u'producao_linhasubproduto', 'quantidade', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2))

        # Changing field 'LinhaProdutoAvulso.quantidade'
        db.alter_column(u'producao_linhaprodutoavulso', 'quantidade', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'LinhaSubProduto.quantidade'
        db.alter_column(u'producao_linhasubproduto', 'quantidade', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'LinhaProdutoAvulso.quantidade'
        db.alter_column(u'producao_linhaprodutoavulso', 'quantidade', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'producao.linhasubprodutoalternativo': {
            'Meta': {'object_name': 'LinhaSubProdutoAlternativo'},
            'componente_alternativo': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['producao.Componente']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
