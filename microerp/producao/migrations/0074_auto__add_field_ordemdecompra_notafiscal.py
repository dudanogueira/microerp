...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrdemDeCompra.notafiscal'
        db.add_column(u'producao_ordemdecompra', 'notafiscal',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OrdemDeCompra.notafiscal'
        db.delete_column(u'producao_ordemdecompra', 'notafiscal')
