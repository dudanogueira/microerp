...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'LancamentoDeFalhaDeTeste.quantidade_reparada'
        db.delete_column(u'producao_lancamentodefalhadeteste', 'quantidade_reparada')

        # Adding field 'LancamentoDeFalhaDeTeste.quantidade_a_reparar'
        db.add_column(u'producao_lancamentodefalhadeteste', 'quantidade_a_reparar',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'LancamentoDeFalhaDeTeste.quantidade_reparada'
        db.add_column(u'producao_lancamentodefalhadeteste', 'quantidade_reparada',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Deleting field 'LancamentoDeFalhaDeTeste.quantidade_a_reparar'
        db.delete_column(u'producao_lancamentodefalhadeteste', 'quantidade_a_reparar')
    ...
    models = {
        ...
        u'producao.lancamentodefalhadeteste': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'quantidade_a_reparar': ('django.db.models.fields.IntegerField', [], {}),
