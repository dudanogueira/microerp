...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AtividadeDeOrdemDeCompra.ordem_de_compra'
        db.add_column(u'producao_atividadedeordemdecompra', 'ordem_de_compra',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['producao.OrdemDeCompra']),
                      keep_default=False)

        # Adding field 'AtividadeDeOrdemDeCompra.criado'
        db.add_column(u'producao_atividadedeordemdecompra', 'criado',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'AtividadeDeOrdemDeCompra.atualizado'
        db.add_column(u'producao_atividadedeordemdecompra', 'atualizado',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True),
                      keep_default=False)


        # Changing field 'AtividadeDeOrdemDeCompra.data'
        db.alter_column(u'producao_atividadedeordemdecompra', 'data', self.gf('django.db.models.fields.DateField')())
        # Adding field 'ComponentesDaOrdemDeCompra.criado'
        db.add_column(u'producao_componentesdaordemdecompra', 'criado',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'ComponentesDaOrdemDeCompra.atualizado'
        db.add_column(u'producao_componentesdaordemdecompra', 'atualizado',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AtividadeDeOrdemDeCompra.ordem_de_compra'
        db.delete_column(u'producao_atividadedeordemdecompra', 'ordem_de_compra_id')

        # Deleting field 'AtividadeDeOrdemDeCompra.criado'
        db.delete_column(u'producao_atividadedeordemdecompra', 'criado')

        # Deleting field 'AtividadeDeOrdemDeCompra.atualizado'
        db.delete_column(u'producao_atividadedeordemdecompra', 'atualizado')


        # Changing field 'AtividadeDeOrdemDeCompra.data'
        db.alter_column(u'producao_atividadedeordemdecompra', 'data', self.gf('django.db.models.fields.DateTimeField')())
        # Deleting field 'ComponentesDaOrdemDeCompra.criado'
        db.delete_column(u'producao_componentesdaordemdecompra', 'criado')

        # Deleting field 'ComponentesDaOrdemDeCompra.atualizado'
        db.delete_column(u'producao_componentesdaordemdecompra', 'atualizado')
    ...
    models = {
        ...
        u'producao.atividadedeordemdecompra': {
            'Meta': {'object_name': 'AtividadeDeOrdemDeCompra'},
            'atualizado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'data': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 9, 0, 0)'}),
        ...
        u'producao.componentesdaordemdecompra': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ordem_de_compra': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['producao.OrdemDeCompra']"}),
            'quantidade_comprada': ('django.db.models.fields.IntegerField', [], {})
        },
        ...
        u'producao.ordemdecompra': {
            'Meta': {'object_name': 'OrdemDeCompra'},
            'atualizado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'producao.ordemproducaosubproduto': {
            'Meta': {'object_name': 'OrdemProducaoSubProduto'},
            'atualizado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'criado_por': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'producao.registroenviodetestesubproduto': {
            'Meta': {'object_name': 'RegistroEnvioDeTesteSubProduto'},
            'atualizado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'criado_por': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'funcionario': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['rh.Funcionario']"}),
        ...
        u'producao.registrosaidadetestesubproduto': {
            'Meta': {'object_name': 'RegistroSaidaDeTesteSubProduto'},
            'atualizado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'criado_por': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'funcionario': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['rh.Funcionario']"}),
        ...
        u'rh.funcionario': {
            ...
            'escolaridade_conclusao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 9, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        u'rh.periodotrabalhado': {
            ...
            'funcionario': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['rh.Funcionario']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 9, 0, 0)'})
        },
