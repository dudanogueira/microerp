...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RegistroValorEstoque.criado'
        db.add_column(u'producao_registrovalorestoque', 'criado',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'RegistroValorEstoque.atualizado'
        db.add_column(u'producao_registrovalorestoque', 'atualizado',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RegistroValorEstoque.criado'
        db.delete_column(u'producao_registrovalorestoque', 'criado')

        # Deleting field 'RegistroValorEstoque.atualizado'
        db.delete_column(u'producao_registrovalorestoque', 'atualizado')
    ...
    models = {
        ...
        u'rh.funcionario': {
            ...
            'escolaridade_conclusao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 7, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        u'rh.periodotrabalhado': {
            ...
            'funcionario': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['rh.Funcionario']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 7, 0, 0)'})
        },
