...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ArquivoAnexoComponente.nome'
        db.add_column(u'producao_arquivoanexocomponente', 'nome',
                      self.gf('django.db.models.fields.TextField')(default='Nome do Arquivo'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ArquivoAnexoComponente.nome'
        db.delete_column(u'producao_arquivoanexocomponente', 'nome')
