...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubProduto.part_number'
        db.add_column(u'producao_subproduto', 'part_number',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubProduto.part_number'
        db.delete_column(u'producao_subproduto', 'part_number')
