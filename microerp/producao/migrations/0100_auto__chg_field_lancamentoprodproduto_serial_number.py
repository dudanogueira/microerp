...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LancamentoProdProduto.serial_number'
        db.alter_column(u'producao_lancamentoprodproduto', 'serial_number', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'LancamentoProdProduto.serial_number'
        db.alter_column(u'producao_lancamentoprodproduto', 'serial_number', self.gf('django.db.models.fields.CharField')(default='', max_length=100))
    ...
    models = {
        ...
        u'producao.lancamentoprodproduto': {
            ...
            'serial_number': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
