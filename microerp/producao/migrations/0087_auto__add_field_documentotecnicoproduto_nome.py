...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DocumentoTecnicoProduto.nome'
        db.add_column(u'producao_documentotecnicoproduto', 'nome',
                      self.gf('django.db.models.fields.CharField')(default='Documento Tecnico do Produto', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DocumentoTecnicoProduto.nome'
        db.delete_column(u'producao_documentotecnicoproduto', 'nome')
