...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FabricanteFornecedor.cnpj'
        db.add_column(u'producao_fabricantefornecedor', 'cnpj',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=400, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FabricanteFornecedor.cnpj'
        db.delete_column(u'producao_fabricantefornecedor', 'cnpj')
