...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OrdemDeCompra.criticidade'
        db.alter_column(u'producao_ordemdecompra', 'criticidade', self.gf('django.db.models.fields.IntegerField')(max_length=1))

    def backwards(self, orm):

        # Changing field 'OrdemDeCompra.criticidade'
        db.alter_column(u'producao_ordemdecompra', 'criticidade', self.gf('django.db.models.fields.CharField')(max_length=1))
    ...
    models = {
        ...
        u'producao.ordemdecompra': {
            ...
            'atualizado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'criticidade': ('django.db.models.fields.IntegerField', [], {'default': '0', 'max_length': '1', 'blank': 'True'}),
