...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'LinhaSubProdutodoProduto', fields ['subproduto', 'produto']
        db.create_unique(u'producao_linhasubprodutodoproduto', ['subproduto_id', 'produto_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'LinhaSubProdutodoProduto', fields ['subproduto', 'produto']
        db.delete_unique(u'producao_linhasubprodutodoproduto', ['subproduto_id', 'produto_id'])
