...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'FollowUpRequisicao'
        db.delete_table(u'producao_followuprequisicao')

        # Adding model 'FollowUpRequisicaoCompra'
        db.create_table(u'producao_followuprequisicaocompra', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('requisicao', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['producao.RequisicaoDeCompra'])),
            ('texto', self.gf('django.db.models.fields.TextField')()),
            ('criado_por', self.gf('django.db.models.fields.related.ForeignKey')(related_name='followup_requisicao_adicionado_set', to=orm['rh.Funcionario'])),
        ...
        db.send_create_signal(u'producao', ['FollowUpRequisicaoCompra'])


    def backwards(self, orm):
        # Adding model 'FollowUpRequisicao'
        db.create_table(u'producao_followuprequisicao', (
            ('texto', self.gf('django.db.models.fields.TextField')()),
            ('criado_por', self.gf('django.db.models.fields.related.ForeignKey')(related_name='followup_requisicao_adicionado_set', to=orm['rh.Funcionario'])),
            ('requisicao', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['producao.RequisicaoDeCompra'])),
            ('atualizado', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True)),
        ...
        db.send_create_signal(u'producao', ['FollowUpRequisicao'])

        # Deleting model 'FollowUpRequisicaoCompra'
        db.delete_table(u'producao_followuprequisicaocompra')
    ...
    models = {
        ...
        u'producao.atividadedecompra': {
            'Meta': {'ordering': "('data',)", 'object_name': 'AtividadeDeCompra'},
            'atualizado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'producao.controledecompra': {
            ...
            'data_aberto': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 27, 0, 0)', 'blank': 'True'}),
        ...
        u'producao.fabricantefornecedor': {
            'Meta': {'ordering': "['nome']", 'object_name': 'FabricanteFornecedor'},
            'ativo': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'atualizado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'producao.followuprequisicaocompra': {
            'Meta': {'ordering': "['-criado']", 'object_name': 'FollowUpRequisicaoCompra'},
            'atualizado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'criado_por': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'followup_requisicao_adicionado_set'", 'to': u"orm['rh.Funcionario']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'requisicao': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['producao.RequisicaoDeCompra']"}),
        ...
        u'producao.lancamentodefalhadeteste': {
            ...
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'criado_por': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'data_lancamento': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 27, 0, 0)'}),
        ...
        u'producao.lancamentoprodproduto': {
            ...
            'data_montagem': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 27, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'data_vendido': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'fim_teste': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 27, 0, 0)', 'null': 'True', 'blank': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio_teste': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 27, 0, 0)', 'null': 'True', 'blank': 'True'}),
            ...
            'produto': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['producao.ProdutoFinal']"}),
            'realizacao_procedimento_de_teste': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 27, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        u'producao.notafiscal': {
            ...
            'serie': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
        ...
        u'producao.notafiscallancamentosproducao': {
            ...
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'criado_por': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'data_saida': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 27, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'producao.ordemproducaosubproduto': {
            ...
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'criado_por': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'data_producao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 27, 0, 0)'}),
        ...
        u'producao.requisicaodecompra': {
            ...
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'criticidade': ('django.db.models.fields.IntegerField', [], {'default': '0', 'max_length': '1'}),
            'data_solicitado': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 27, 0, 0)'}),
            'descricao': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'rh.funcionario': {
            ...
            'escolaridade_conclusao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 27, 0, 0)', 'null': 'True', 'blank': 'True'}),
            ...
            'ultima_checagem_endereco': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 27, 0, 0)'}),
        ...
        u'rh.periodotrabalhado': {
            ...
            'funcionario': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['rh.Funcionario']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 27, 0, 0)'})
        },
        u'rh.procedimento': {
