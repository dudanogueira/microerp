...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubProduto.total_montado'
        db.add_column(u'producao_subproduto', 'total_montado',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'SubProduto.total_testando'
        db.add_column(u'producao_subproduto', 'total_testando',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'SubProduto.total_funcional'
        db.add_column(u'producao_subproduto', 'total_funcional',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubProduto.total_montado'
        db.delete_column(u'producao_subproduto', 'total_montado')

        # Deleting field 'SubProduto.total_testando'
        db.delete_column(u'producao_subproduto', 'total_testando')

        # Deleting field 'SubProduto.total_funcional'
        db.delete_column(u'producao_subproduto', 'total_funcional')
