...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LinhaSubProduto.valor_custo_da_linha'
        db.add_column(u'producao_linhasubproduto', 'valor_custo_da_linha',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LinhaSubProduto.valor_custo_da_linha'
        db.delete_column(u'producao_linhasubproduto', 'valor_custo_da_linha')
    ...
    models = {
        ...
        u'producao.linhasubproduto': {
            ...
            'valor_custo_da_linha': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '2'})
        },
