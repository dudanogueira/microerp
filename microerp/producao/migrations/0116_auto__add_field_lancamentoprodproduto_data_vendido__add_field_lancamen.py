...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LancamentoProdProduto.data_vendido'
        db.add_column(u'producao_lancamentoprodproduto', 'data_vendido',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'LancamentoProdProduto.funcionario_vendeu'
        db.add_column(u'producao_lancamentoprodproduto', 'funcionario_vendeu',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='lancamento_de_producao_produto_vendido_set', null=True, to=orm['rh.Funcionario']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LancamentoProdProduto.data_vendido'
        db.delete_column(u'producao_lancamentoprodproduto', 'data_vendido')

        # Deleting field 'LancamentoProdProduto.funcionario_vendeu'
        db.delete_column(u'producao_lancamentoprodproduto', 'funcionario_vendeu_id')
    ...
    models = {
        ...
        u'producao.lancamentoprodproduto': {
            ...
            'produto': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['producao.ProdutoFinal']"}),
            'serial_number': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '100', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
