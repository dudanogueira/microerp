...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ArquivoAnexoComponente'
        db.create_table(u'producao_arquivoanexocomponente', (
        ...
        db.send_create_signal(u'producao', ['ArquivoAnexoComponente'])

        # Adding field 'Componente.imagem'
        db.add_column(u'producao_componente', 'imagem',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ArquivoAnexoComponente'
        db.delete_table(u'producao_arquivoanexocomponente')

        # Deleting field 'Componente.imagem'
        db.delete_column(u'producao_componente', 'imagem')
