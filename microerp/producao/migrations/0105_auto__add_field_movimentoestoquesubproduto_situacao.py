...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MovimentoEstoqueSubProduto.situacao'
        db.add_column(u'producao_movimentoestoquesubproduto', 'situacao',
                      self.gf('django.db.models.fields.IntegerField')(default='0'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MovimentoEstoqueSubProduto.situacao'
        db.delete_column(u'producao_movimentoestoquesubproduto', 'situacao')
    ...
    models = {
        ...
        u'producao.movimentoestoqueproduto': {
            ...
            'operacao': ('django.db.models.fields.CharField', [], {'default': "'0'", 'max_length': '100', 'blank': 'True'}),
            'produto': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['producao.ProdutoFinal']"}),
        ...
        u'producao.movimentoestoquesubproduto': {
            ...
            'quantidade_movimentada': ('django.db.models.fields.IntegerField', [], {}),
            'quantidade_nova': ('django.db.models.fields.IntegerField', [], {}),
            'situacao': ('django.db.models.fields.IntegerField', [], {'default': "'0'"}),
            'subproduto': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['producao.SubProduto']"})
        },
