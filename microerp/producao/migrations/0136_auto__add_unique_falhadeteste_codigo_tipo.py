...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'FalhaDeTeste', fields ['codigo', 'tipo']
        db.create_unique(u'producao_falhadeteste', ['codigo', 'tipo'])


    def backwards(self, orm):
        # Removing unique constraint on 'FalhaDeTeste', fields ['codigo', 'tipo']
        db.delete_unique(u'producao_falhadeteste', ['codigo', 'tipo'])
