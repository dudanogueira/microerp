...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LancamentoProdProduto.funcionario_que_montou'
        db.alter_column(u'producao_lancamentoprodproduto', 'funcionario_que_montou_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rh.Funcionario']))

        # Changing field 'LancamentoProdProduto.cliente_associado'
        db.alter_column(u'producao_lancamentoprodproduto', 'cliente_associado', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'LancamentoProdProduto.data_montagem'
        db.alter_column(u'producao_lancamentoprodproduto', 'data_montagem', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'LancamentoProdProduto.inicio_teste'
        db.alter_column(u'producao_lancamentoprodproduto', 'inicio_teste', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'LancamentoProdProduto.funcionario_que_montou'
        db.alter_column(u'producao_lancamentoprodproduto', 'funcionario_que_montou_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['rh.Funcionario']))

        # Changing field 'LancamentoProdProduto.cliente_associado'
        db.alter_column(u'producao_lancamentoprodproduto', 'cliente_associado', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

        # Changing field 'LancamentoProdProduto.data_montagem'
        db.alter_column(u'producao_lancamentoprodproduto', 'data_montagem', self.gf('django.db.models.fields.DateField')())

        # Changing field 'LancamentoProdProduto.inicio_teste'
        db.alter_column(u'producao_lancamentoprodproduto', 'inicio_teste', self.gf('django.db.models.fields.DateField')())
    ...
    models = {
        ...
        u'producao.lancamentoprodproduto': {
            ...
            'data_montagem': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 25, 0, 0)', 'null': 'True', 'blank': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio_teste': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 25, 0, 0)', 'null': 'True', 'blank': 'True'}),
