...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NotaFiscalLancamentosProducao.criado'
        db.add_column(u'producao_notafiscallancamentosproducao', 'criado',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'NotaFiscalLancamentosProducao.atualizado'
        db.add_column(u'producao_notafiscallancamentosproducao', 'atualizado',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NotaFiscalLancamentosProducao.criado'
        db.delete_column(u'producao_notafiscallancamentosproducao', 'criado')

        # Deleting field 'NotaFiscalLancamentosProducao.atualizado'
        db.delete_column(u'producao_notafiscallancamentosproducao', 'atualizado')
