...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'ComponentesDaOrdemDeCompra'
        db.delete_table(u'producao_componentesdaordemdecompra')

        # Deleting model 'AtividadeDeOrdemDeCompra'
        db.delete_table(u'producao_atividadedeordemdecompra')

        # Deleting model 'OrdemDeCompra'
        db.delete_table(u'producao_ordemdecompra')

        # Adding model 'AtividadeDeControleDeCompra'
        db.create_table(u'producao_atividadedecontroledecompra', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('controle_de_compra', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['producao.ControleDeCompra'])),
            ...
            ('data_fechado', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('fechado_por', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
        ...
        db.send_create_signal(u'producao', ['AtividadeDeControleDeCompra'])

        # Adding model 'ControleDeCompra'
        db.create_table(u'producao_controledecompra', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('data_aberto', self.gf('django.db.models.fields.DateField')(default=datetime.datetime.now, blank=True)),
            ('data_fechado', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('descricao', self.gf('django.db.models.fields.TextField')()),
            ('fornecedor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['producao.FabricanteFornecedor'], null=True, blank=True)),
            ('criticidade', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1)),
            ('criado', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True)),
            ('atualizado', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'producao', ['ControleDeCompra'])


    def backwards(self, orm):
        # Adding model 'ComponentesDaOrdemDeCompra'
        db.create_table(u'producao_componentesdaordemdecompra', (
            ('atualizado', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True)),
            ('criado', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True)),
            ('valor', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2)),
            ('quantidade_comprada', self.gf('django.db.models.fields.DecimalField')(max_digits=15, decimal_places=2)),
            ('ordem_de_compra', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['producao.OrdemDeCompra'])),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('componente_comprado', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['producao.Componente'])),
        ))
        db.send_create_signal(u'producao', ['ComponentesDaOrdemDeCompra'])

        # Adding model 'AtividadeDeOrdemDeCompra'
        db.create_table(u'producao_atividadedeordemdecompra', (
            ('data_fechado', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('atualizado', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True)),
            ('criado', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True)),
            ('fechado_por', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
        ...
        db.send_create_signal(u'producao', ['AtividadeDeOrdemDeCompra'])

        # Adding model 'OrdemDeCompra'
        db.create_table(u'producao_ordemdecompra', (
            ('data_fechado', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ...
            ('data_aberto', self.gf('django.db.models.fields.DateField')(default=datetime.datetime.now, blank=True)),
            ('atualizado', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True)),
            ('fornecedor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['producao.FabricanteFornecedor'])),
            ('criticidade', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1)),
            ('valor', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2)),
            ('notafiscal', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('descricao', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'producao', ['OrdemDeCompra'])

        # Deleting model 'AtividadeDeControleDeCompra'
        db.delete_table(u'producao_atividadedecontroledecompra')

        # Deleting model 'ControleDeCompra'
        db.delete_table(u'producao_controledecompra')
    ...
    models = {
        ...
        u'producao.atividadedecontroledecompra': {
            'Meta': {'ordering': "('data',)", 'object_name': 'AtividadeDeControleDeCompra'},
            'atualizado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
            'controle_de_compra': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['producao.ControleDeCompra']"}),
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'producao.componente': {
            'Meta': {'ordering': "('part_number',)", 'unique_together': "(('identificador', 'tipo'),)", 'object_name': 'Componente'},
        ...
        u'producao.controledecompra': {
            'Meta': {'ordering': "['-criado']", 'object_name': 'ControleDeCompra'},
            'atualizado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'descricao': ('django.db.models.fields.TextField', [], {}),
            'fornecedor': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['producao.FabricanteFornecedor']", 'null': 'True', 'blank': 'True'}),
        ...
        u'producao.falhadeteste': {
            'Meta': {'ordering': "['-criado']", 'unique_together': "(('tipo', 'codigo'),)", 'object_name': 'FalhaDeTeste'},
            'atualizado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
            ...
            'descricao': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tipo': ('django.db.models.fields.CharField', [], {'default': "'perda'", 'max_length': '100'})
        },
        ...
        u'producao.lancamentodefalhadeteste': {
            'Meta': {'ordering': "['-criado']", 'object_name': 'LancamentoDeFalhaDeTeste'},
            'atualizado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'criado_por': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'data_lancamento': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 25, 0, 0)'}),
            'funcionario_testador': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['rh.Funcionario']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'quantidade_funcional': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'quantidade_funcional_direta': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'quantidade_perdida': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'quantidade_reparada_funcional': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'quantidade_total_testada': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'subproduto': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['producao.SubProduto']"})
        },
        u'producao.lancamentoprodproduto': {
            ...
            'data_montagem': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 25, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'data_vendido': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'fim_teste': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 25, 0, 0)', 'null': 'True', 'blank': 'True'}),
            ...
            'funcionario_finalizou_teste': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'lancamento_de_producao_produto_teste_finalizado_set'", 'null': 'True', 'to': u"orm['rh.Funcionario']"}),
            ...
            'funcionario_relalizou_teste': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'lancamento_de_producao_produto_teste_realizado_set'", 'null': 'True', 'to': u"orm['rh.Funcionario']"}),
            'funcionario_vendeu': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'lancamento_de_producao_produto_vendido_set'", 'null': 'True', 'to': u"orm['rh.Funcionario']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio_teste': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 25, 0, 0)', 'null': 'True', 'blank': 'True'}),
            ...
            'nota_fiscal': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['producao.NotaFiscalLancamentosProducao']", 'null': 'True', 'blank': 'True'}),
            ...
            'produto': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['producao.ProdutoFinal']"}),
            'realizacao_procedimento_de_teste': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 25, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'serial_number': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '100', 'null': 'True'}),
        ...
        u'producao.linhalancamentofalhadeteste': {
            'Meta': {'object_name': 'LinhaLancamentoFalhaDeTeste'},
            'atualizado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'falha': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['producao.FalhaDeTeste']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lancamento_teste': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['producao.LancamentoDeFalhaDeTeste']"}),
        ...
        u'producao.linhasubproduto': {
            ...
            'valor_custo_da_linha': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '10', 'decimal_places': '2'})
        },
        u'producao.linhasubprodutoagregado': {
            ...
            'subproduto_agregado': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'linhasubprodutos_escolhidos'", 'to': u"orm['producao.SubProduto']"}),
        ...
        u'producao.linhatestelancamentoprodproduto': {
            ...
            'atualizado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'funcionario_que_montou': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'linha_de_montagem_de_lancamento_de_produto_set'", 'null': 'True', 'to': u"orm['rh.Funcionario']"}),
            'funcionario_que_testou': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'linha_de_teste_de_lancamento_de_produto_set'", 'null': 'True', 'to': u"orm['rh.Funcionario']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'producao.movimentoestoqueproduto': {
            'Meta': {'ordering': "['-criado']", 'object_name': 'MovimentoEstoqueProduto'},
            'atualizado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'registro_de_nota_fiscal': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['producao.NotaFiscalLancamentosProducao']", 'null': 'True', 'blank': 'True'})
        },
        u'producao.movimentoestoquesubproduto': {
            'Meta': {'ordering': "['-criado']", 'object_name': 'MovimentoEstoqueSubProduto'},
            'atualizado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'criado_manualmente': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'criado_por': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
        ...
        u'producao.notafiscal': {
            ...
            'serie': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
        ...
        u'producao.notafiscallancamentosproducao': {
            'Meta': {'ordering': "['-criado']", 'object_name': 'NotaFiscalLancamentosProducao'},
            'atualizado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
            'cliente_associado': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'criado_por': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'data_saida': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 25, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'producao.ordemproducaosubproduto': {
            ...
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'criado_por': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'data_producao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 25, 0, 0)'}),
        ...
        u'producao.posicaoestoque': {
            ...
            'quantidade': ('django.db.models.fields.DecimalField', [], {'max_digits': '15', 'decimal_places': '2'}),
            'quantidade_alterada': ('django.db.models.fields.TextField', [], {'blank': 'True'})
        },
        u'producao.produtofinal': {
            'Meta': {'ordering': "('part_number',)", 'object_name': 'ProdutoFinal'},
            'ativo': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'atualizado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'descricao': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
        ...
        u'producao.registrovalorestoque': {
            'Meta': {'ordering': "('data',)", 'object_name': 'RegistroValorEstoque'},
            'atualizado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'producao.requisicaodecompra': {
            ...
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'criticidade': ('django.db.models.fields.IntegerField', [], {'default': '0', 'max_length': '1'}),
            'data_solicitado': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 25, 0, 0)'}),
            'descricao': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'producao.subproduto': {
            'Meta': {'ordering': "('part_number',)", 'object_name': 'SubProduto'},
            'ativo': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'atualizado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'descricao': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            ...
            'imagem': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'nome': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'notacao_de_producao': ('django.db.models.fields.TextField', [], {'default': "'{}'", 'blank': 'True'}),
            'part_number': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            ...
            'valor_custo_total_dos_sub_produtos_agregados': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '2'}),
            'valor_custo_total_linhas': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '2'}),
            'valor_total_de_custo': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '2'})
        },
        u'rh.cargo': {
        ...
        u'rh.funcionario': {
            ...
            'escolaridade_conclusao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 25, 0, 0)', 'null': 'True', 'blank': 'True'}),
            ...
            'ultima_checagem_endereco': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 25, 0, 0)'}),
        ...
        u'rh.periodotrabalhado': {
            ...
            'funcionario': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['rh.Funcionario']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 25, 0, 0)'})
        },
        u'rh.procedimento': {
