...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FabricanteFornecedor.contatos'
        db.add_column(u'producao_fabricantefornecedor', 'contatos',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FabricanteFornecedor.contatos'
        db.delete_column(u'producao_fabricantefornecedor', 'contatos')
