...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LancamentoProdProduto.funcionario_inicio_teste'
        db.alter_column(u'producao_lancamentoprodproduto', 'funcionario_inicio_teste_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rh.Funcionario']))

        # Changing field 'LancamentoProdProduto.funcionario_apagou'
        db.alter_column(u'producao_lancamentoprodproduto', 'funcionario_apagou_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rh.Funcionario']))

        # Changing field 'LancamentoProdProduto.data_apagado'
        db.alter_column(u'producao_lancamentoprodproduto', 'data_apagado', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'LancamentoProdProduto.funcionario_inicio_teste'
        db.alter_column(u'producao_lancamentoprodproduto', 'funcionario_inicio_teste_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['rh.Funcionario']))

        # Changing field 'LancamentoProdProduto.funcionario_apagou'
        db.alter_column(u'producao_lancamentoprodproduto', 'funcionario_apagou_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['rh.Funcionario']))

        # Changing field 'LancamentoProdProduto.data_apagado'
        db.alter_column(u'producao_lancamentoprodproduto', 'data_apagado', self.gf('django.db.models.fields.DateField')(default=1))
    ...
    models = {
        ...
        u'producao.lancamentoprodproduto': {
            ...
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'data_apagado': ('django.db.models.fields.DateField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
