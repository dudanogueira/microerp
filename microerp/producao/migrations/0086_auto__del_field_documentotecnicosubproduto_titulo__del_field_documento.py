...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DocumentoTecnicoSubProduto.titulo'
        db.delete_column(u'producao_documentotecnicosubproduto', 'titulo')

        # Deleting field 'DocumentoTecnicoSubProduto.descricao'
        db.delete_column(u'producao_documentotecnicosubproduto', 'descricao')

        # Adding field 'DocumentoTecnicoSubProduto.nome'
        db.add_column(u'producao_documentotecnicosubproduto', 'nome',
                      self.gf('django.db.models.fields.CharField')(default='Documento Tecnico Sub Produto', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'DocumentoTecnicoSubProduto.titulo'
        db.add_column(u'producao_documentotecnicosubproduto', 'titulo',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'DocumentoTecnicoSubProduto.descricao'
        db.add_column(u'producao_documentotecnicosubproduto', 'descricao',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Deleting field 'DocumentoTecnicoSubProduto.nome'
        db.delete_column(u'producao_documentotecnicosubproduto', 'nome')
    ...
    models = {
        ...
        u'producao.requisicaodecompra': {
            ...
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'criticidade': ('django.db.models.fields.IntegerField', [], {'default': '0', 'max_length': '1'}),
            'data_solicitado': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 20, 0, 0)'}),
            'descricao': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'rh.funcionario': {
            ...
            'escolaridade_conclusao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 20, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        u'rh.periodotrabalhado': {
            ...
            'funcionario': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['rh.Funcionario']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 20, 0, 0)'})
        },
