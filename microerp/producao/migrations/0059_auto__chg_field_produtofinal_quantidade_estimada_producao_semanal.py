...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProdutoFinal.quantidade_estimada_producao_semanal'
        db.alter_column(u'producao_produtofinal', 'quantidade_estimada_producao_semanal', self.gf('django.db.models.fields.IntegerField')(default=1))

    def backwards(self, orm):

        # Changing field 'ProdutoFinal.quantidade_estimada_producao_semanal'
        db.alter_column(u'producao_produtofinal', 'quantidade_estimada_producao_semanal', self.gf('django.db.models.fields.IntegerField')(null=True))
