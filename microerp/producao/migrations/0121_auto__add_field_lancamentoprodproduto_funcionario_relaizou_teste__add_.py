...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LancamentoProdProduto.fim_teste'
        db.add_column(u'producao_lancamentoprodproduto', 'fim_teste',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 11, 1, 0, 0), null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'LancamentoProdProduto.fim_teste'
        db.delete_column(u'producao_lancamentoprodproduto', 'fim_teste')
    ...
    models = {
        ...
        u'producao.lancamentoprodproduto': {
            ...
            'funcionario_relaizou_teste': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'lancamento_de_producao_produto_teste_realizado_set'", 'null': 'True', 'to': u"orm['rh.Funcionario']"}),
