...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubProduto.tipo_de_teste'
        db.add_column(u'producao_subproduto', 'tipo_de_teste',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubProduto.tipo_de_teste'
        db.delete_column(u'producao_subproduto', 'tipo_de_teste')
    ...
    models = {
        ...
        u'producao.subproduto': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'tipo_de_teste': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '100', 'null': 'True'}),
