...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MovimentoEstoqueSubProduto.ordem_de_producao'
        db.add_column(u'producao_movimentoestoquesubproduto', 'ordem_de_producao',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['producao.OrdemProducaoSubProduto'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'MovimentoEstoqueProduto.ordem_de_producao'
        db.add_column(u'producao_movimentoestoqueproduto', 'ordem_de_producao',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['producao.OrdemProducaoProduto'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MovimentoEstoqueSubProduto.ordem_de_producao'
        db.delete_column(u'producao_movimentoestoquesubproduto', 'ordem_de_producao_id')

        # Deleting field 'MovimentoEstoqueProduto.ordem_de_producao'
        db.delete_column(u'producao_movimentoestoqueproduto', 'ordem_de_producao_id')
