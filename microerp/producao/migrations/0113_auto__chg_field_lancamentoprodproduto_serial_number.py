...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'producao_lancamentoprodproduto', 'serial_number', self.gf('django.db.models.fields.CharField')(max_length=100, unique=True, null=True))

    def backwards(self, orm):

        # Changing field 'LancamentoProdProduto.serial_number'
        db.alter_column(u'producao_lancamentoprodproduto', 'serial_number', self.gf('django.db.models.fields.CharField')(default=1, max_length=100, unique=True))
