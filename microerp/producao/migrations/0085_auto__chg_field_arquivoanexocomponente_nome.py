...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ArquivoAnexoComponente.nome'
        db.alter_column(u'producao_arquivoanexocomponente', 'nome', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'ArquivoAnexoComponente.nome'
        db.alter_column(u'producao_arquivoanexocomponente', 'nome', self.gf('django.db.models.fields.TextField')())
