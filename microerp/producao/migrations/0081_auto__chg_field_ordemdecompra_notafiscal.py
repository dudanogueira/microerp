...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OrdemDeCompra.notafiscal'
        db.alter_column(u'producao_ordemdecompra', 'notafiscal', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'OrdemDeCompra.notafiscal'
        db.alter_column(u'producao_ordemdecompra', 'notafiscal', self.gf('django.db.models.fields.CharField')(default=1, max_length=100))
