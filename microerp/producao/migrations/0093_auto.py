...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field subprodutos_testaveis on 'ProdutoFinal'
        db.create_table(u'producao_produtofinal_subprodutos_testaveis', (
        ...
        db.create_unique(u'producao_produtofinal_subprodutos_testaveis', ['produtofinal_id', 'subproduto_id'])


    def backwards(self, orm):
        # Removing M2M table for field subprodutos_testaveis on 'ProdutoFinal'
        db.delete_table('producao_produtofinal_subprodutos_testaveis')
