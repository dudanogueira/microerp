...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ProdutoFinal'
        db.create_table(u'producao_produtofinal', (
        ...
        db.send_create_signal(u'producao', ['ProdutoFinal'])

        # Adding M2M table for field subprodutos on 'ProdutoFinal'
        db.create_table(u'producao_produtofinal_subprodutos', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('produtofinal', models.ForeignKey(orm[u'producao.produtofinal'], null=False)),
            ('subproduto', models.ForeignKey(orm[u'producao.subproduto'], null=False))
        ))
        db.create_unique(u'producao_produtofinal_subprodutos', ['produtofinal_id', 'subproduto_id'])


        # Changing field 'DocumentoTecnicoProduto.produto'
        db.alter_column(u'producao_documentotecnicoproduto', 'produto_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['producao.ProdutoFinal']))

        # Changing field 'LinhaProdutoAvulso.produto'
        db.alter_column(u'producao_linhaprodutoavulso', 'produto_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['producao.ProdutoFinal']))
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'ProdutoFinal'
        db.delete_table(u'producao_produtofinal')

        # Removing M2M table for field subprodutos on 'ProdutoFinal'
        db.delete_table('producao_produtofinal_subprodutos')


        # Changing field 'DocumentoTecnicoProduto.produto'
        db.alter_column(u'producao_documentotecnicoproduto', 'produto_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['producao.Produto']))

        # Changing field 'LinhaProdutoAvulso.produto'
        db.alter_column(u'producao_linhaprodutoavulso', 'produto_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['producao.Produto']))
