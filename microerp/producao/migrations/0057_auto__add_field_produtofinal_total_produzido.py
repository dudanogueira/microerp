...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProdutoFinal.total_produzido'
        db.add_column(u'producao_produtofinal', 'total_produzido',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProdutoFinal.total_produzido'
        db.delete_column(u'producao_produtofinal', 'total_produzido')
