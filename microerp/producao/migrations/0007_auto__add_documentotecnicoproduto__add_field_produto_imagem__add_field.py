...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DocumentoTecnicoProduto'
        db.create_table(u'producao_documentotecnicoproduto', (
        ...
        db.send_create_signal(u'producao', ['DocumentoTecnicoProduto'])

        # Adding field 'Produto.imagem'
        db.add_column(u'producao_produto', 'imagem',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Produto.descricao'
        db.add_column(u'producao_produto', 'descricao',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'DocumentoTecnicoProduto'
        db.delete_table(u'producao_documentotecnicoproduto')

        # Deleting field 'Produto.imagem'
        db.delete_column(u'producao_produto', 'imagem')

        # Deleting field 'Produto.descricao'
        db.delete_column(u'producao_produto', 'descricao')
