...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OrdemProducaoProduto'
        db.create_table(u'producao_ordemproducaoproduto', (
        ...
        db.send_create_signal(u'producao', ['OrdemProducaoProduto'])


    def backwards(self, orm):
        # Deleting model 'OrdemProducaoProduto'
        db.delete_table(u'producao_ordemproducaoproduto')
    ...
    models = {
        ...
        u'rh.funcionario': {
            ...
            'escolaridade_conclusao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 6, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        u'rh.periodotrabalhado': {
            ...
            'funcionario': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['rh.Funcionario']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 6, 0, 0)'})
        },
