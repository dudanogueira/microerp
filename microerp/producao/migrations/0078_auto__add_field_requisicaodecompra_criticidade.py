...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RequisicaoDeCompra.criticidade'
        db.add_column(u'producao_requisicaodecompra', 'criticidade',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=1, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RequisicaoDeCompra.criticidade'
        db.delete_column(u'producao_requisicaodecompra', 'criticidade')
