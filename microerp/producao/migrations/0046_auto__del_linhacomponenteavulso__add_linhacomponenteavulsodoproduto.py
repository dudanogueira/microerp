...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'LinhaComponenteAvulso'
        db.delete_table(u'producao_linhacomponenteavulso')

        # Adding model 'LinhaComponenteAvulsodoProduto'
        db.create_table(u'producao_linhacomponenteavulsodoproduto', (
        ...
        db.send_create_signal(u'producao', ['LinhaComponenteAvulsodoProduto'])


    def backwards(self, orm):
        # Adding model 'LinhaComponenteAvulso'
        db.create_table(u'producao_linhacomponenteavulso', (
            ('componente', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['producao.Componente'])),
            ('quantidade', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2)),
            ('produto', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['producao.ProdutoFinal'])),
            ('atualizado', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True)),
        ...
        db.send_create_signal(u'producao', ['LinhaComponenteAvulso'])

        # Deleting model 'LinhaComponenteAvulsodoProduto'
        db.delete_table(u'producao_linhacomponenteavulsodoproduto')
