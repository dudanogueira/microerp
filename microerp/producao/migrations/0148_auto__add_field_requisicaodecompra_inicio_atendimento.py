...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RequisicaoDeCompra.inicio_atendimento'
        db.add_column(u'producao_requisicaodecompra', 'inicio_atendimento',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RequisicaoDeCompra.inicio_atendimento'
        db.delete_column(u'producao_requisicaodecompra', 'inicio_atendimento')
