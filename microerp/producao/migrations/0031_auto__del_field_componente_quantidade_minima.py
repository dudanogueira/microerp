...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Componente.quantidade_minima'
        db.delete_column(u'producao_componente', 'quantidade_minima')


    def backwards(self, orm):
        # Adding field 'Componente.quantidade_minima'
        db.add_column(u'producao_componente', 'quantidade_minima',
