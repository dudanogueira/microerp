...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LancamentoProdProduto.funcionario_adicionou'
        db.add_column(u'producao_lancamentoprodproduto', 'funcionario_adicionou',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='lancamento_de_producao_produto_adicionado_set', null=True, to=orm['rh.Funcionario']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LancamentoProdProduto.funcionario_adicionou'
        db.delete_column(u'producao_lancamentoprodproduto', 'funcionario_adicionou_id')
