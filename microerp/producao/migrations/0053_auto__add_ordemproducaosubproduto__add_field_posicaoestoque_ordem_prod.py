...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OrdemProducaoSubProduto'
        db.create_table(u'producao_ordemproducaosubproduto', (
        ...
        db.send_create_signal(u'producao', ['OrdemProducaoSubProduto'])

        # Adding field 'PosicaoEstoque.ordem_producao_subproduto_referencia'
        db.add_column(u'producao_posicaoestoque', 'ordem_producao_subproduto_referencia',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['producao.OrdemProducaoSubProduto']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'OrdemProducaoSubProduto'
        db.delete_table(u'producao_ordemproducaosubproduto')

        # Deleting field 'PosicaoEstoque.ordem_producao_subproduto_referencia'
        db.delete_column(u'producao_posicaoestoque', 'ordem_producao_subproduto_referencia_id')
    ...
    models = {
        ...
        u'producao.posicaoestoque': {
            ...
            'ordem_producao_subproduto_referencia': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['producao.OrdemProducaoSubProduto']"}),
            'quantidade': ('django.db.models.fields.DecimalField', [], {'max_digits': '15', 'decimal_places': '2'}),
