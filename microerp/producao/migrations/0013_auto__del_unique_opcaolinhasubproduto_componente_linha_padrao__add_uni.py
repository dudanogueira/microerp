...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'OpcaoLinhaSubProduto', fields ['componente', 'linha', 'padrao']
        db.delete_unique(u'producao_opcaolinhasubproduto', ['componente_id', 'linha_id', 'padrao'])

        # Adding unique constraint on 'OpcaoLinhaSubProduto', fields ['linha', 'padrao']
        db.create_unique(u'producao_opcaolinhasubproduto', ['linha_id', 'padrao'])


    def backwards(self, orm):
        # Removing unique constraint on 'OpcaoLinhaSubProduto', fields ['linha', 'padrao']
        db.delete_unique(u'producao_opcaolinhasubproduto', ['linha_id', 'padrao'])

        # Adding unique constraint on 'OpcaoLinhaSubProduto', fields ['componente', 'linha', 'padrao']
        db.create_unique(u'producao_opcaolinhasubproduto', ['componente_id', 'linha_id', 'padrao'])
