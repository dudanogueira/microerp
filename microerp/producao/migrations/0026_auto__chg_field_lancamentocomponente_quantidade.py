...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LancamentoComponente.quantidade'
        db.alter_column(u'producao_lancamentocomponente', 'quantidade', self.gf('django.db.models.fields.DecimalField')(max_digits=40, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'LancamentoComponente.quantidade'
        db.alter_column(u'producao_lancamentocomponente', 'quantidade', self.gf('django.db.models.fields.DecimalField')(max_digits=15, decimal_places=2))
    ...
    models = {
        ...
        u'producao.lancamentocomponente': {
            ...
            'quantidade': ('django.db.models.fields.DecimalField', [], {'max_digits': '40', 'decimal_places': '2'}),
