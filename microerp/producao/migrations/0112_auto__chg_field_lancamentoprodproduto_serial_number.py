...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'producao_lancamentoprodproduto', 'serial_number', self.gf('django.db.models.fields.CharField')(default=1, unique=True, max_length=100))

    def backwards(self, orm):

        # Changing field 'LancamentoProdProduto.serial_number'
        db.alter_column(u'producao_lancamentoprodproduto', 'serial_number', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100, null=True))
    ...
    models = {
        ...
        u'producao.lancamentoprodproduto': {
            ...
            'produto': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['producao.ProdutoFinal']"}),
            'serial_number': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '100'}),
