...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DocumentoTecnicoProduto.titulo'
        db.delete_column(u'producao_documentotecnicoproduto', 'titulo')

        # Deleting field 'DocumentoTecnicoProduto.descricao'
        db.delete_column(u'producao_documentotecnicoproduto', 'descricao')


    def backwards(self, orm):
        # Adding field 'DocumentoTecnicoProduto.titulo'
        db.add_column(u'producao_documentotecnicoproduto', 'titulo',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'DocumentoTecnicoProduto.descricao'
        db.add_column(u'producao_documentotecnicoproduto', 'descricao',
