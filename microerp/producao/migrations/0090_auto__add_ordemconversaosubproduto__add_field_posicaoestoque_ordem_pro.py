...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OrdemConversaoSubProduto'
        db.create_table(u'producao_ordemconversaosubproduto', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('subproduto_original', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ordem_conversao_subproduto_original_set', to=orm['producao.SubProduto'])),
            ('subproduto_destino', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ordem_conversao_subproduto_destino_set', to=orm['producao.SubProduto'])),
            ('quantidade', self.gf('django.db.models.fields.IntegerField')()),
            ('string_producao', self.gf('django.db.models.fields.TextField')()),
        ...
        db.send_create_signal(u'producao', ['OrdemConversaoSubProduto'])

        # Adding field 'PosicaoEstoque.ordem_producao_conversao_subproduto_referencia'
        db.add_column(u'producao_posicaoestoque', 'ordem_producao_conversao_subproduto_referencia',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['producao.OrdemConversaoSubProduto'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'OrdemConversaoSubProduto'
        db.delete_table(u'producao_ordemconversaosubproduto')

        # Deleting field 'PosicaoEstoque.ordem_producao_conversao_subproduto_referencia'
        db.delete_column(u'producao_posicaoestoque', 'ordem_producao_conversao_subproduto_referencia_id')
    ...
    models = {
        ...
        u'producao.requisicaodecompra': {
            ...
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'criticidade': ('django.db.models.fields.IntegerField', [], {'default': '0', 'max_length': '1'}),
            'data_solicitado': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 30, 0, 0)'}),
            'descricao': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'rh.funcionario': {
            ...
            'escolaridade_conclusao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 30, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        u'rh.periodotrabalhado': {
            ...
            'funcionario': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['rh.Funcionario']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 30, 0, 0)'})
        },
