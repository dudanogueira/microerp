...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PosicaoEstoque.ordem_producao_produto_referencia'
        db.add_column(u'producao_posicaoestoque', 'ordem_producao_produto_referencia',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['producao.OrdemProducaoProduto'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PosicaoEstoque.ordem_producao_produto_referencia'
        db.delete_column(u'producao_posicaoestoque', 'ordem_producao_produto_referencia_id')
