...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'LinhaTesteLancamentoDeProducaoProduto'
        db.delete_table(u'producao_linhatestelancamentodeproducaoproduto')

        # Deleting model 'LancamentoDeProducaoDeProduto'
        db.delete_table(u'producao_lancamentodeproducaodeproduto')

        # Adding model 'LinhaTesteLancamentoProdProduto'
        db.create_table(u'producao_linhatestelancamentoprodproduto', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('lancamento_de_producao', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['producao.LancamentoProdProduto'])),
            ('subproduto_testavel', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['producao.SubProduto'])),
            ('funcionario_que_testou', self.gf('django.db.models.fields.related.ForeignKey')(related_name='linha_de_teste_de_lancamento_de_produto_set', to=orm['rh.Funcionario'])),
            ('funcionario_que_montou', self.gf('django.db.models.fields.related.ForeignKey')(related_name='linha_de_montagem_de_lancamento_de_produto_set', to=orm['rh.Funcionario'])),
            ('versao_firmware', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
        ))
        db.send_create_signal(u'producao', ['LinhaTesteLancamentoProdProduto'])

        # Adding model 'LancamentoProdProduto'
        db.create_table(u'producao_lancamentoprodproduto', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('serial_number', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('vendido', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('funcionario_que_montou', self.gf('django.db.models.fields.related.ForeignKey')(related_name='lancamento_de_producao_produto_montado_set', blank=True, to=orm['rh.Funcionario'])),
            ('data_montagem', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 10, 25, 0, 0), blank=True)),
            ('inicio_teste', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 10, 25, 0, 0), blank=True)),
            ('funcionario_inicio_teste', self.gf('django.db.models.fields.related.ForeignKey')(related_name='lancamento_de_producao_produto_teste_iniciado_set', blank=True, to=orm['rh.Funcionario'])),
            ('cliente_associado', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('ordem_de_producao', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['producao.OrdemProducaoProduto'])),
            ('apagado', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('justificativa_apagado', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('funcionario_apagou', self.gf('django.db.models.fields.related.ForeignKey')(related_name='lancamento_de_producao_produto_apagado_set', blank=True, to=orm['rh.Funcionario'])),
            ('data_apagado', self.gf('django.db.models.fields.DateField')(default=None, blank=True)),
        ...
        db.send_create_signal(u'producao', ['LancamentoProdProduto'])


    def backwards(self, orm):
        # Adding model 'LinhaTesteLancamentoDeProducaoProduto'
        db.create_table(u'producao_linhatestelancamentodeproducaoproduto', (
            ('funcionario_que_testou', self.gf('django.db.models.fields.related.ForeignKey')(related_name='linha_de_teste_de_lancamento_de_produto_set', to=orm['rh.Funcionario'])),
            ('versao_firmware', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('funcionario_que_montou', self.gf('django.db.models.fields.related.ForeignKey')(related_name='linha_de_montagem_de_lancamento_de_produto_set', to=orm['rh.Funcionario'])),
            ('subproduto_testavel', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['producao.SubProduto'])),
            ('lancamento_de_producao', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['producao.LancamentoDeProducaoDeProduto'])),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'producao', ['LinhaTesteLancamentoDeProducaoProduto'])

        # Adding model 'LancamentoDeProducaoDeProduto'
        db.create_table(u'producao_lancamentodeproducaodeproduto', (
            ('serial_number', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('apagado', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('ordem_de_producao', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['producao.OrdemProducaoProduto'])),
            ('funcionario_que_montou', self.gf('django.db.models.fields.related.ForeignKey')(related_name='lancamento_de_producao_produto_montado_set', to=orm['rh.Funcionario'], blank=True)),
            ('cliente_associado', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('atualizado', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True)),
            ('criado', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True)),
            ...
            ('data_montagem', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 10, 25, 0, 0), blank=True)),
            ('inicio_teste', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 10, 25, 0, 0), blank=True)),
            ('funcionario_inicio_teste', self.gf('django.db.models.fields.related.ForeignKey')(related_name='lancamento_de_producao_produto_teste_iniciado_set', to=orm['rh.Funcionario'], blank=True)),
            ('vendido', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('funcionario_apagou', self.gf('django.db.models.fields.related.ForeignKey')(related_name='lancamento_de_producao_produto_apagado_set', to=orm['rh.Funcionario'], blank=True)),
            ('data_apagado', self.gf('django.db.models.fields.DateField')(default=None, blank=True)),
        ))
        db.send_create_signal(u'producao', ['LancamentoDeProducaoDeProduto'])

        # Deleting model 'LinhaTesteLancamentoProdProduto'
        db.delete_table(u'producao_linhatestelancamentoprodproduto')

        # Deleting model 'LancamentoProdProduto'
        db.delete_table(u'producao_lancamentoprodproduto')
    ...
    models = {
        ...
        u'producao.lancamentoprodproduto': {
            'Meta': {'object_name': 'LancamentoProdProduto'},
            'apagado': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'atualizado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
            'cliente_associado': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'data_apagado': ('django.db.models.fields.DateField', [], {'default': 'None', 'blank': 'True'}),
            'data_montagem': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 25, 0, 0)', 'blank': 'True'}),
            'funcionario_apagou': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'lancamento_de_producao_produto_apagado_set'", 'blank': 'True', 'to': u"orm['rh.Funcionario']"}),
            'funcionario_inicio_teste': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'lancamento_de_producao_produto_teste_iniciado_set'", 'blank': 'True', 'to': u"orm['rh.Funcionario']"}),
            'funcionario_que_montou': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'lancamento_de_producao_produto_montado_set'", 'blank': 'True', 'to': u"orm['rh.Funcionario']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio_teste': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 25, 0, 0)', 'blank': 'True'}),
        ...
        u'producao.linhatestelancamentoprodproduto': {
            'Meta': {'object_name': 'LinhaTesteLancamentoProdProduto'},
            'funcionario_que_montou': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'linha_de_montagem_de_lancamento_de_produto_set'", 'to': u"orm['rh.Funcionario']"}),
            'funcionario_que_testou': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'linha_de_teste_de_lancamento_de_produto_set'", 'to': u"orm['rh.Funcionario']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'producao.ordemproducaosubproduto': {
            ...
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'criado_por': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'data_producao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 25, 0, 0)'}),
        ...
        u'producao.requisicaodecompra': {
            ...
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'criticidade': ('django.db.models.fields.IntegerField', [], {'default': '0', 'max_length': '1'}),
            'data_solicitado': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 25, 0, 0)'}),
            'descricao': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'rh.funcionario': {
            ...
            'escolaridade_conclusao': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 25, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        u'rh.periodotrabalhado': {
            ...
            'funcionario': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['rh.Funcionario']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 25, 0, 0)'})
        },
