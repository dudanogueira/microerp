...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'producao_lancamentodeproducaodeproduto', (
            ...
            ('vendido', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('funcionario_que_montou', self.gf('django.db.models.fields.related.ForeignKey')(related_name='lancamento_de_producao_produto_montado_set', to=orm['rh.Funcionario'])),
            ('data_montagem', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 10, 25, 0, 0))),
            ('inicio_teste', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 10, 25, 0, 0))),
            ('funcionario_inicio_teste', self.gf('django.db.models.fields.related.ForeignKey')(related_name='lancamento_de_producao_produto_teste_iniciado_set', to=orm['rh.Funcionario'])),
        ...
        # Adding model 'LinhaDeTesteDoLancamentoDeProducaoDeProduto'
        db.create_table(u'producao_linhadetestedolancamentodeproducaodeproduto', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'producao', ['LinhaDeTesteDoLancamentoDeProducaoDeProduto'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'LinhaDeTesteDoLancamentoDeProducaoDeProduto'
        db.delete_table(u'producao_linhadetestedolancamentodeproducaodeproduto')
    ...
    models = {
        ...
        u'producao.lancamentodeproducaodeproduto': {
            'Meta': {'object_name': 'LancamentoDeProducaoDeProduto'},
            ...
            'data_montagem': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 25, 0, 0)'}),
            ...
            'funcionario_inicio_teste': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'lancamento_de_producao_produto_teste_iniciado_set'", 'to': u"orm['rh.Funcionario']"}),
            'funcionario_que_montou': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'lancamento_de_producao_produto_montado_set'", 'to': u"orm['rh.Funcionario']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio_teste': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 25, 0, 0)'}),
            ...
            'vendido': ('django.db.models.fields.BooleanField', [], {'default': 'True'})
        },
        ...
        u'producao.linhadetestedolancamentodeproducaodeproduto': {
            'Meta': {'object_name': 'LinhaDeTesteDoLancamentoDeProducaoDeProduto'},
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lancamento_de_producao': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['producao.LancamentoDeProducaoDeProduto']"}),
