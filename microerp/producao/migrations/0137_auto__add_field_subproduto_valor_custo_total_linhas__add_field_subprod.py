...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubProduto.valor_custo_total_linhas'
        db.add_column(u'producao_subproduto', 'valor_custo_total_linhas',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2),
                      keep_default=False)

        # Adding field 'SubProduto.valor_custo_total_dos_sub_produtos_agregados'
        db.add_column(u'producao_subproduto', 'valor_custo_total_dos_sub_produtos_agregados',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubProduto.valor_custo_total_linhas'
        db.delete_column(u'producao_subproduto', 'valor_custo_total_linhas')

        # Deleting field 'SubProduto.valor_custo_total_dos_sub_produtos_agregados'
        db.delete_column(u'producao_subproduto', 'valor_custo_total_dos_sub_produtos_agregados')
