...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PosicaoEstoque.ordem_producao_subproduto_referencia'
        db.alter_column(u'producao_posicaoestoque', 'ordem_producao_subproduto_referencia_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['producao.OrdemProducaoSubProduto'], null=True))

    def backwards(self, orm):

        # Changing field 'PosicaoEstoque.ordem_producao_subproduto_referencia'
        db.alter_column(u'producao_posicaoestoque', 'ordem_producao_subproduto_referencia_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['producao.OrdemProducaoSubProduto']))
