...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrdemDeCompra.criticidade'
        db.add_column(u'producao_ordemdecompra', 'criticidade',
                      self.gf('django.db.models.fields.TextField')(default=0, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OrdemDeCompra.criticidade'
        db.delete_column(u'producao_ordemdecompra', 'criticidade')
    ...
    models = {
        ...
        u'producao.ordemdecompra': {
            ...
            'atualizado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
            'criado': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'criticidade': ('django.db.models.fields.TextField', [], {'default': '0', 'blank': 'True'}),
