...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'LancamentoProdProduto', fields ['serial_number']
        db.delete_unique(u'producao_lancamentoprodproduto', ['serial_number'])


    def backwards(self, orm):
        # Adding unique constraint on 'LancamentoProdProduto', fields ['serial_number']
        db.create_unique(u'producao_lancamentoprodproduto', ['serial_number'])
    ...
    models = {
        ...
        u'producao.lancamentoprodproduto': {
            ...
            'produto': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['producao.ProdutoFinal']"}),
            'serial_number': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '100', 'null': 'True', 'blank': 'True'}),
