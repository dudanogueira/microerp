...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MovimentoEstoqueProduto.registro_de_nota_fiscal'
        db.add_column(u'producao_movimentoestoqueproduto', 'registro_de_nota_fiscal',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['producao.NotaFiscalLancamentosProducao']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MovimentoEstoqueProduto.registro_de_nota_fiscal'
        db.delete_column(u'producao_movimentoestoqueproduto', 'registro_de_nota_fiscal_id')
    ...
    models = {
        ...
        u'producao.movimentoestoqueproduto': {
            ...
            'registro_de_nota_fiscal': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['producao.NotaFiscalLancamentosProducao']"})
        },
