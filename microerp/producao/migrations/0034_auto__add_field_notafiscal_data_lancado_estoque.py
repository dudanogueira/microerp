...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NotaFiscal.data_lancado_estoque'
        db.add_column(u'producao_notafiscal', 'data_lancado_estoque',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NotaFiscal.data_lancado_estoque'
        db.delete_column(u'producao_notafiscal', 'data_lancado_estoque')
