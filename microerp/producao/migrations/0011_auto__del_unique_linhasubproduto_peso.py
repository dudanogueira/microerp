...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'LinhaSubProduto', fields ['peso']
        db.delete_unique(u'producao_linhasubproduto', ['peso'])


    def backwards(self, orm):
        # Adding unique constraint on 'LinhaSubProduto', fields ['peso']
        db.create_unique(u'producao_linhasubproduto', ['peso'])
