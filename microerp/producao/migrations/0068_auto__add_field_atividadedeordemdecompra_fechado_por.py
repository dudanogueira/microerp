...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AtividadeDeOrdemDeCompra.fechado_por'
        db.add_column(u'producao_atividadedeordemdecompra', 'fechado_por',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AtividadeDeOrdemDeCompra.fechado_por'
        db.delete_column(u'producao_atividadedeordemdecompra', 'fechado_por_id')
