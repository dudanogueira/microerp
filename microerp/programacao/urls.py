...
urlpatterns = patterns('',
    ...
    url(r'^contrato/(?P<contrato_id>[0-9]+)/editar/adicionar-tarefa/$', 'programacao.views.editar_programacao_contrato_adicionar_tarefa', name='editar_programacao_contrato_adicionar_tarefa'),
