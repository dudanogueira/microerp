...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FollowUpDeContrato'
        db.create_table(u'programacao_followupdecontrato', (
            ...
            ('porcentagem_execucao', self.gf('django.db.models.fields.DecimalField')(max_digits=3, decimal_places=0)),
            ('criado_por', self.gf('django.db.models.fields.related.ForeignKey')(related_name='followup_contrato_adicionado_set', to=orm['rh.Funcionario'])),
        ...
        db.send_create_signal(u'programacao', ['FollowUpDeContrato'])


    def backwards(self, orm):
        # Deleting model 'FollowUpDeContrato'
        db.delete_table(u'programacao_followupdecontrato')
