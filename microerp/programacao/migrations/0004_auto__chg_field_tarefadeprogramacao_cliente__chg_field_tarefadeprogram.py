...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TarefaDeProgramacao.cliente'
        db.alter_column(u'programacao_tarefadeprogramacao', 'cliente_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cadastro.Cliente'], null=True))

        # Changing field 'TarefaDeProgramacao.contrato'
        db.alter_column(u'programacao_tarefadeprogramacao', 'contrato_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['comercial.ContratoFechado'], null=True))

    def backwards(self, orm):

        # Changing field 'TarefaDeProgramacao.cliente'
        db.alter_column(u'programacao_tarefadeprogramacao', 'cliente_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['cadastro.Cliente']))

        # Changing field 'TarefaDeProgramacao.contrato'
        db.alter_column(u'programacao_tarefadeprogramacao', 'contrato_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['comercial.ContratoFechado']))
