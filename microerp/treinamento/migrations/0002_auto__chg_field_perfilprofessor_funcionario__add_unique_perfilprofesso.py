...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PerfilProfessor.funcionario'
        db.alter_column(u'treinamento_perfilprofessor', 'funcionario_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['rh.Funcionario'], unique=True))
        # Adding unique constraint on 'PerfilProfessor', fields ['funcionario']
        db.create_unique(u'treinamento_perfilprofessor', ['funcionario_id'])

        # Adding field 'PerfilAluno.nome'
        db.add_column(u'treinamento_perfilaluno', 'nome',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'PerfilProfessor', fields ['funcionario']
        db.delete_unique(u'treinamento_perfilprofessor', ['funcionario_id'])


        # Changing field 'PerfilProfessor.funcionario'
        db.alter_column(u'treinamento_perfilprofessor', 'funcionario_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rh.Funcionario']))
        # Deleting field 'PerfilAluno.nome'
        db.delete_column(u'treinamento_perfilaluno', 'nome')
    ...
    models = {
        ...
        u'treinamento.perfilprofessor': {
            ...
            'funcionario': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['rh.Funcionario']", 'unique': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
